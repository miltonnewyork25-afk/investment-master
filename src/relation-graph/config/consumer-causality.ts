...
export const CATEGORY_TO_STOCKS: Record<ConsumerCategory, string[]> = {
  ...
  'home_improvement': ['HD', 'LOW', 'SHW', 'TREX', 'MAS', 'FBHS'],
  ...
  'smartphones': ['AAPL', 'SSNLF', 'GOOG'],
  'wearables': ['AAPL', 'GRMN', 'FBIT'],
