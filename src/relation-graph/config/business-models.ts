...
// ========== 70 NEW STOCKS: Chinese ADR / Airlines / SaaS / BDC / Mining / Lidar / EV ==========
  ...
  'BWW': { assetModel: 'asset_heavy', revenueModels: ['product_sales'], deliveryModel: 'hybrid', customerModel: 'B2C', industrySegment: 'Casual Dining', tags: ['restaurant', 'wings', 'sports_bar', 'casual_dining', 'franchise'] },
  'LE': { assetModel: 'hybrid', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Apparel Retail', tags: ['apparel', 'catalog', 'ecommerce', 'casual_wear', 'DTC'] },
  'LZB': { assetModel: 'asset_heavy', revenueModels: ['product_sales'], deliveryModel: 'hybrid', customerModel: 'B2C', industrySegment: 'Furniture', tags: ['furniture', 'recliner', 'home_furnishing', 'retail', 'manufacturing'] },
  'NATH': { assetModel: 'asset_light', revenueModels: ['product_sales', 'licensing'], deliveryModel: 'franchise', customerModel: 'B2C', industrySegment: 'Quick Service Restaurant', tags: ['hot_dogs', 'franchise', 'QSR', 'branded_food', 'licensing'] },
  'NWL': { assetModel: 'hybrid', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Consumer Products', tags: ['household', 'writing', 'outdoor', 'baby', 'brands'] },
  'ONL': { assetModel: 'asset_heavy', revenueModels: ['rental'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Office REIT', tags: ['REIT', 'office', 'net_lease', 'single_tenant', 'suburban'] },
  'ORG': { assetModel: 'hybrid', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Pharma', tags: ['women_health', 'biosimilars', 'fertility', 'pharma', 'established_brands'] },
  'OVEN': { assetModel: 'asset_heavy', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Fast Casual Restaurant', tags: ['restaurant', 'pizza', 'fast_casual', 'food_service', 'ovens'] },
  'PBPB': { assetModel: 'asset_heavy', revenueModels: ['product_sales'], deliveryModel: 'hybrid', customerModel: 'B2C', industrySegment: 'Fast Casual Restaurant', tags: ['sandwich', 'fast_casual', 'restaurant', 'franchise', 'urban'] },
  'REAL': { assetModel: 'platform', revenueModels: ['transaction_fee'], deliveryModel: 'marketplace', customerModel: 'B2C', industrySegment: 'Luxury Consignment', tags: ['resale', 'luxury', 'marketplace', 'consignment', 'ecommerce'] },
  'SWIM': { assetModel: 'asset_heavy', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Pool Products', tags: ['swimming_pool', 'fiberglass', 'outdoor_living', 'installation', 'backyard'] },
  'TCS': { assetModel: 'asset_heavy', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Specialty Retail', tags: ['storage', 'organization', 'home', 'retail', 'custom_closets'] },

  // --- Batch: Industrials/Materials/Construction (Jan 2026 - Set F) ---
  'CFX': { assetModel: 'asset_heavy', revenueModels: ['product_sales', 'aftermarket'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Specialty Industrial', tags: ['welding', 'cutting', 'fabrication', 'industrial_equipment', 'ESAB'] },
  'ECVT': { assetModel: 'asset_heavy', revenueModels: ['product_sales', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Specialty Chemicals', tags: ['catalysts', 'silica', 'refining', 'emissions_control', 'zeolites'] },
  'FNKO': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Collectibles & Toys', tags: ['pop_culture', 'vinyl_figures', 'collectibles', 'licensed_products', 'entertainment'] },
  'GCP': { assetModel: 'asset_heavy', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Construction Chemicals', tags: ['concrete_admixtures', 'waterproofing', 'cement_additives', 'specialty_construction', 'infrastructure'] },
  'HNI': { assetModel: 'asset_heavy', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Office Furniture', tags: ['office_furniture', 'hearth_products', 'workplace', 'fireplaces', 'commercial_interiors'] },
  'KOP': { assetModel: 'asset_heavy', revenueModels: ['product_sales', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Carbon Compounds & Chemicals', tags: ['carbon_compounds', 'railroad_ties', 'utility_poles', 'wood_preservation', 'infrastructure'] },
  'NVT': { assetModel: 'asset_heavy', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Electrical Solutions', tags: ['electrical_connections', 'enclosures', 'thermal_management', 'data_infrastructure', 'industrial_electrification'] },
  'RXN': { assetModel: 'asset_heavy', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Water Management', tags: ['water_solutions', 'plumbing', 'drinking_water', 'drainage', 'specification_products'] },

  // --- Batch: Energy/Utilities/Mining/REITs (Jan 2026 - Set G) ---
  'BCEI': { assetModel: 'asset_heavy', revenueModels: ['commodity_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Oil & Gas E&P', tags: ['oil_gas', 'upstream', 'DJ_Basin', 'shale', 'colorado'] },
  'BEP': { assetModel: 'asset_heavy', revenueModels: ['regulated_utility', 'product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Renewable Energy', tags: ['renewable', 'hydro', 'wind', 'solar', 'brookfield'] },
  'CQP': { assetModel: 'asset_heavy', revenueModels: ['throughput_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'LNG Export', tags: ['lng', 'export', 'pipeline', 'cheniere', 'sabine_pass'] },
  'DKL': { assetModel: 'asset_heavy', revenueModels: ['throughput_fee', 'gathering'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Midstream Pipeline', tags: ['logistics', 'pipeline', 'delek', 'crude', 'refined_products'] },
  'ETRN': { assetModel: 'asset_heavy', revenueModels: ['gathering', 'throughput_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Midstream Pipeline', tags: ['gathering', 'appalachian', 'natural_gas', 'water_services', 'MVP'] },
  'HE': { assetModel: 'asset_heavy', revenueModels: ['regulated_utility'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Regulated Utility', tags: ['regulated', 'electric', 'hawaii', 'island', 'renewable_transition'] },
  'IDA': { assetModel: 'asset_heavy', revenueModels: ['regulated_utility'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Regulated Utility', tags: ['regulated', 'electric', 'idaho', 'hydro', 'low_cost'] },
  'KRP': { assetModel: 'asset_light', revenueModels: ['commodity_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Oil & Gas Royalties', tags: ['mineral_rights', 'royalties', 'permian', 'midcontinent', 'passive'] },
  'LAND': { assetModel: 'asset_heavy', revenueModels: ['rental'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Farmland REIT', tags: ['REIT', 'farmland', 'agriculture', 'net_lease', 'gladstone'] },
  'NGM': { assetModel: 'asset_light', revenueModels: ['licensing', 'premium_service'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Biotechnology', tags: ['biotech', 'NASH', 'metabolic', 'oncology', 'clinical_stage'] },
  'NS': { assetModel: 'asset_heavy', revenueModels: ['throughput_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Midstream Pipeline', tags: ['pipeline', 'crude', 'refined_products', 'storage', 'gulf_coast'] },
  'PAGP': { assetModel: 'asset_heavy', revenueModels: ['throughput_fee', 'gathering'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Midstream Pipeline', tags: ['crude', 'ngl', 'permian', 'pipeline', 'storage'] },
  'PBA': { assetModel: 'asset_heavy', revenueModels: ['throughput_fee', 'gathering'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Midstream Pipeline', tags: ['canadian', 'ngl', 'natural_gas', 'crude', 'pembina'] },
  'QEP': { assetModel: 'asset_heavy', revenueModels: ['commodity_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Oil & Gas E&P', tags: ['oil_gas', 'upstream', 'permian', 'williston', 'shale'] },
  'SLCA': { assetModel: 'asset_heavy', revenueModels: ['commodity_sales', 'product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Industrial Minerals', tags: ['frac_sand', 'silica', 'proppant', 'industrial', 'mining'] },
  'SRC': { assetModel: 'asset_heavy', revenueModels: ['rental'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Net Lease REIT', tags: ['REIT', 'net_lease', 'single_tenant', 'diversified', 'triple_net'] },
  'TPVG': { assetModel: 'asset_light', revenueModels: ['interest_income'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Venture Lending BDC', tags: ['BDC', 'venture_lending', 'technology', 'growth_stage', 'silicon_valley'] },
  'XEC': { assetModel: 'asset_heavy', revenueModels: ['commodity_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Oil & Gas E&P', tags: ['oil_gas', 'upstream', 'permian', 'midcontinent', 'shale'] },

  // --- Batch: Additional Sectors (Jan 2026 - Set H) ---
  'TXMD': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B2C', industrySegment: 'Womens Health Pharma', tags: ['pharma', 'womens_health', 'hormone_therapy', 'bio_identical', 'specialty'] },
  'CSOD': { assetModel: 'asset_light', revenueModels: ['subscription'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'HCM SaaS', tags: ['SaaS', 'talent_management', 'LMS', 'learning', 'HR_tech'] },

  // ========== Batch: 79 Confirmed-Missing US Stocks (Jan 2026) ==========
  // --- Community Banks / Small Financials ---
  'ARTNA': { assetModel: 'asset_heavy', revenueModels: ['regulated_utility'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Water Utility', tags: ['water', 'utility', 'regulated', 'delaware', 'artesian'] },
  'BKSC': { assetModel: 'asset_heavy', revenueModels: ['interest_income', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['bank', 'community', 'west_virginia', 'deposits', 'loans'] },
  'BPFH': { assetModel: 'asset_heavy', revenueModels: ['interest_income', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['bank', 'community', 'boston', 'private_banking', 'wealth'] },
  'BSRR': { assetModel: 'asset_heavy', revenueModels: ['interest_income', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['bank', 'community', 'california', 'sierra', 'deposits'] },
  'CHMG': { assetModel: 'asset_heavy', revenueModels: ['interest_income', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['bank', 'community', 'new_york', 'chemung', 'trust'] },
  'CIVB': { assetModel: 'asset_heavy', revenueModels: ['interest_income', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['bank', 'community', 'west_virginia', 'civista', 'deposits'] },
  'CLBK': { assetModel: 'asset_heavy', revenueModels: ['interest_income', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['bank', 'community', 'columbia', 'new_jersey', 'deposits'] },
  'ERFC': { assetModel: 'asset_heavy', revenueModels: ['interest_income', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['bank', 'community', 'michigan', 'elfc', 'deposits'] },
  'FCLF': { assetModel: 'asset_heavy', revenueModels: ['interest_income', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['bank', 'community', 'florida', 'first_clone', 'deposits'] },
  'FDBC': { assetModel: 'asset_heavy', revenueModels: ['interest_income', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['bank', 'community', 'fidelity', 'pennsylvania', 'deposits'] },
  'FFBW': { assetModel: 'asset_heavy', revenueModels: ['interest_income', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['bank', 'thrift', 'washington', 'savings', 'mortgage'] },
  'FGBI': { assetModel: 'asset_heavy', revenueModels: ['interest_income', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['bank', 'community', 'texas', 'first_guaranty', 'deposits'] },
  'FMBH': { assetModel: 'asset_heavy', revenueModels: ['interest_income', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['bank', 'community', 'indiana', 'first_mid', 'deposits'] },
  'FUNC': { assetModel: 'asset_heavy', revenueModels: ['interest_income', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['bank', 'community', 'virginia', 'first_community', 'deposits'] },
  'FVCB': { assetModel: 'asset_heavy', revenueModels: ['interest_income', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['bank', 'community', 'virginia', 'fvcb', 'deposits'] },
  'MOFG': { assetModel: 'asset_heavy', revenueModels: ['interest_income', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['bank', 'community', 'iowa', 'midwestone', 'deposits'] },
  'AMTB': { assetModel: 'asset_heavy', revenueModels: ['interest_income', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['bank', 'community', 'florida', 'amerant', 'international'] },
  'HTBI': { assetModel: 'asset_heavy', revenueModels: ['interest_income', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['bank', 'community', 'tennessee', 'hometown', 'deposits'] },
  'LBAI': { assetModel: 'asset_heavy', revenueModels: ['interest_income', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['bank', 'community', 'new_jersey', 'lakeland', 'deposits'] },
  'MSBI': { assetModel: 'asset_heavy', revenueModels: ['interest_income', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['bank', 'community', 'iowa', 'midland_states', 'deposits'] },
  'MBWM': { assetModel: 'asset_heavy', revenueModels: ['interest_income', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['bank', 'community', 'michigan', 'mercantile', 'deposits'] },
  // --- Investment Banking / Specialty Finance ---
  'COWN': { assetModel: 'asset_light', revenueModels: ['service_fee', 'transaction_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Investment Banking', tags: ['investment_bank', 'advisory', 'capital_markets', 'research', 'TD_cowen'] },
  'CPSS': { assetModel: 'asset_heavy', revenueModels: ['interest_income'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Subprime Auto Lending', tags: ['auto_lending', 'subprime', 'consumer_finance', 'securitization'] },
  'CRMT': { assetModel: 'asset_heavy', revenueModels: ['interest_income', 'product_sales'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Buy-Here-Pay-Here Auto', tags: ['used_cars', 'subprime', 'BHPH', 'auto_retail'] },
  'FINV': { assetModel: 'platform', revenueModels: ['transaction_fee', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Online Lending Platform', tags: ['fintech', 'china', 'P2P', 'consumer_lending', 'platform'] },
  'FCFS': { assetModel: 'asset_heavy', revenueModels: ['interest_income', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Pawn & Consumer Lending', tags: ['pawn', 'consumer_finance', 'retail', 'gold', 'Latin_America'] },
  'GCMG': { assetModel: 'asset_light', revenueModels: ['service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Alternative Asset Management', tags: ['alternatives', 'private_equity', 'real_estate', 'infrastructure', 'credit'] },
  'IGIC': { assetModel: 'asset_light', revenueModels: ['service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Alternative Asset Management', tags: ['infrastructure', 'private_equity', 'GP_stakes', 'alternatives'] },
  // --- Insurance ---
  'BRP': { assetModel: 'asset_light', revenueModels: ['service_fee', 'transaction_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Insurance Brokerage', tags: ['insurance', 'broker', 'middle_market', 'specialty', 'MGA'] },
  'ANAT': { assetModel: 'asset_heavy', revenueModels: ['premium_service', 'interest_income'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Specialty Insurance', tags: ['insurance', 'annuity', 'specialty', 'american_national'] },
  // --- Technology / Software ---
  'AVID': { assetModel: 'hybrid', revenueModels: ['subscription', 'product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Media Production Software', tags: ['media', 'video_editing', 'audio', 'ProTools', 'broadcast'] },
  'CLFD': { assetModel: 'asset_light', revenueModels: ['product_sales', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Telecom Equipment', tags: ['telecom', 'networking', 'fiber', 'optical', 'clearfield'] },
  'CSII': { assetModel: 'asset_light', revenueModels: ['subscription', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Banking Technology', tags: ['core_banking', 'fintech', 'community_bank', 'credit_union', 'SaaS'] },
  'CYBE': { assetModel: 'asset_light', revenueModels: ['subscription', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Cybersecurity', tags: ['cybersecurity', 'identity', 'access_management', 'cloud'] },
  'DMRC': { assetModel: 'asset_light', revenueModels: ['subscription', 'usage_based'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Location Intelligence', tags: ['geospatial', 'mapping', 'location', 'analytics', 'SaaS'] },
  'DZSI': { assetModel: 'asset_light', revenueModels: ['product_sales', 'subscription'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Network Access Equipment', tags: ['fiber', 'broadband', 'optical', 'DZS', 'edge'] },
  'EGAN': { assetModel: 'asset_light', revenueModels: ['subscription', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Video Delivery Software', tags: ['video', 'streaming', 'OTT', 'CDN', 'media'] },
  'EIDX': { assetModel: 'asset_light', revenueModels: ['subscription', 'transaction_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Healthcare IT', tags: ['healthcare', 'claims', 'EDI', 'revenue_cycle', 'SaaS'] },
  'GSOL': { assetModel: 'asset_light', revenueModels: ['subscription', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Workforce Analytics', tags: ['HR', 'workforce', 'analytics', 'SaaS', 'talent'] },
  'MDLA': { assetModel: 'asset_light', revenueModels: ['subscription', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Experience Management SaaS', tags: ['CX', 'experience', 'feedback', 'analytics', 'medallia'] },
  'MFNX': { assetModel: 'asset_light', revenueModels: ['subscription', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Digital Health Platform', tags: ['healthcare', 'engagement', 'SaaS', 'analytics'] },
  'LOGC': { assetModel: 'asset_light', revenueModels: ['subscription', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Cloud Data Management', tags: ['data', 'cloud', 'analytics', 'management', 'SaaS'] },
  'INOV': { assetModel: 'asset_light', revenueModels: ['subscription', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Healthcare IT', tags: ['healthcare', 'analytics', 'network', 'pharmacy', 'SaaS'] },
  'IBEX': { assetModel: 'asset_heavy', revenueModels: ['service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'BPO / Customer Experience', tags: ['BPO', 'call_center', 'CX', 'outsourcing', 'digital'] },
  // --- Biotech / Pharma / Gene Therapy ---
  'BYSI': { assetModel: 'asset_light', revenueModels: ['product_sales', 'licensing'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Oncology Biotech', tags: ['biotech', 'oncology', 'plinabulin', 'clinical_stage'] },
  'CAPR': { assetModel: 'asset_light', revenueModels: ['licensing'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Gene Therapy Biotech', tags: ['biotech', 'AAV', 'gene_therapy', 'liver', 'clinical_stage'] },
  'DRNA': { assetModel: 'asset_light', revenueModels: ['licensing', 'product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'RNAi Therapeutics', tags: ['RNAi', 'gene_silencing', 'liver', 'rare_disease', 'biotech'] },
  'GLMD': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Biotech', tags: ['biotech', 'NASH', 'liver', 'metabolic', 'clinical_stage'] },
  'GRFS': { assetModel: 'asset_heavy', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Plasma Therapeutics', tags: ['plasma', 'biologics', 'immunoglobulin', 'albumin', 'global'] },
  'JNCE': { assetModel: 'asset_light', revenueModels: ['licensing'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Immuno-Oncology Biotech', tags: ['biotech', 'immuno_oncology', 'checkpoint', 'clinical_stage'] },
  'KDNY': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Nephrology Biotech', tags: ['biotech', 'kidney', 'rare_disease', 'nephrology', 'clinical_stage'] },
  'MCRB': { assetModel: 'asset_light', revenueModels: ['product_sales', 'licensing'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Microbiome Therapeutics', tags: ['microbiome', 'CDI', 'gut', 'biologics', 'seres'] },
  'MGTX': { assetModel: 'asset_light', revenueModels: ['product_sales', 'licensing'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Gene Therapy Biotech', tags: ['gene_therapy', 'AAV', 'ophthalmology', 'rare_disease', 'meiragtx'] },
  'LSEA': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Clinical-Stage Biotech', tags: ['biotech', 'oncology', 'autoimmune', 'clinical_stage'] },
  'ATHN': { assetModel: 'asset_light', revenueModels: ['subscription', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Healthcare IT', tags: ['EHR', 'revenue_cycle', 'cloud', 'physician', 'athenahealth'] },
  'AXDX': { assetModel: 'asset_light', revenueModels: ['product_sales', 'consumables'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Diagnostics', tags: ['diagnostics', 'bloodstream', 'infection', 'rapid_ID', 'accelerate'] },
  // --- Industrial / Manufacturing ---
  'ATEX': { assetModel: 'asset_heavy', revenueModels: ['product_sales', 'aftermarket'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Industrial Equipment', tags: ['grain', 'explosion_protection', 'safety', 'industrial', 'venting'] },
  'HLIO': { assetModel: 'asset_heavy', revenueModels: ['product_sales', 'aftermarket'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Motion Control', tags: ['hydraulic', 'motion_control', 'industrial', 'mobile', 'helios'] },
  'LASR': { assetModel: 'asset_heavy', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Laser Technology', tags: ['laser', 'fiber_laser', 'industrial', 'defense', 'nLIGHT'] },
  'MXCT': { assetModel: 'asset_light', revenueModels: ['product_sales', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Digital Manufacturing', tags: ['3D_printing', 'digital', 'manufacturing', 'maxeon', 'additive'] },
  'MTLS': { assetModel: 'asset_light', revenueModels: ['product_sales', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Additive Manufacturing', tags: ['3D_printing', 'additive', 'prototyping', 'materialise'] },
  // --- Specialty / Other ---
  'AVDL': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Specialty Pharma', tags: ['pharma', 'pediatric', 'ADHD', 'rare_disease', 'avadel'] },
  'BRID': { assetModel: 'asset_heavy', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Bridal & Formal Wear', tags: ['bridal', 'wedding', 'retail', 'formal_wear', 'bridgepoint'] },
  'CCLP': { assetModel: 'asset_heavy', revenueModels: ['service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Oilfield Services', tags: ['well_services', 'completions', 'workover', 'pressure_pumping'] },
  'CTHR': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Niche Consumer Products', tags: ['consumer', 'direct_response', 'marketing', 'wellness'] },
  'CVGW': { assetModel: 'asset_heavy', revenueModels: ['product_sales', 'distribution'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Fresh Produce', tags: ['avocado', 'guacamole', 'fresh_produce', 'calavo', 'agriculture'] },
  'CSTM': { assetModel: 'asset_heavy', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Specialty Metals', tags: ['aluminum', 'alloys', 'aerospace', 'automotive', 'constellium'] },
  'DSSI': { assetModel: 'asset_heavy', revenueModels: ['service_fee', 'rental'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Shipping / Tankers', tags: ['tanker', 'shipping', 'crude', 'petroleum', 'maritime'] },
  'FYND': { assetModel: 'platform', revenueModels: ['transaction_fee', 'subscription'], deliveryModel: 'marketplace', customerModel: 'B2B2C', industrySegment: 'Luxury Resale Platform', tags: ['luxury', 'resale', 'consignment', 'marketplace', 'fashion'] },
  'GWRS': { assetModel: 'asset_heavy', revenueModels: ['regulated_utility', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Water Utility', tags: ['water', 'recycled_water', 'utility', 'california', 'global_water'] },
  'ISLE': { assetModel: 'asset_heavy', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Casino / Gaming', tags: ['casino', 'gaming', 'hotel', 'entertainment', 'isle'] },
  'LILA': { assetModel: 'asset_heavy', revenueModels: ['subscription', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Latin American Telecom', tags: ['telecom', 'cable', 'latin_america', 'broadband', 'liberty'] },
  'LTRPA': { assetModel: 'asset_heavy', revenueModels: ['subscription', 'advertising'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Media & Entertainment', tags: ['media', 'liberty', 'tracking', 'tripadvisor', 'travel'] },
  'MVST': { assetModel: 'asset_heavy', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'EV Battery Manufacturing', tags: ['EV', 'battery', 'lithium_ion', 'fast_charge', 'microvast'] },
  'DMLP': { assetModel: 'asset_heavy', revenueModels: ['commodity_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Oil & Gas Royalties', tags: ['natural_gas', 'royalties', 'mineral_rights', 'appalachian', 'dorchester'] },
  'IMKTA': { assetModel: 'asset_heavy', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Grocery Retail', tags: ['grocery', 'retail', 'ingles', 'southeast', 'supermarket'] },
  'HABT': { assetModel: 'asset_heavy', revenueModels: ['product_sales'], deliveryModel: 'hybrid', customerModel: 'B2C', industrySegment: 'Fast Casual Restaurants', tags: ['restaurant', 'burger', 'fast_casual', 'habit', 'franchise'] },
  'LNDC': { assetModel: 'asset_heavy', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Flexible Packaging', tags: ['packaging', 'flexible', 'film', 'printed', 'landec'] },
  'LIVE': { assetModel: 'asset_heavy', revenueModels: ['product_sales', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Live Entertainment', tags: ['entertainment', 'concerts', 'events', 'venues', 'live'] },

  // --- Batch: Confirmed Missing US Stocks (Jan 2026 - Set I) ---
  'AGTI': { assetModel: 'asset_heavy', revenueModels: ['rental', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Medical Equipment Services', tags: ['medical_devices', 'equipment_rental', 'hospital_services', 'repair', 'logistics'] },
  'ARNC': { assetModel: 'asset_heavy', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Aluminum Rolled Products', tags: ['aluminum', 'rolled_products', 'aerospace', 'automotive', 'packaging'] },
  'ASRT': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Specialty Pharmaceuticals', tags: ['specialty_pharma', 'pain_management', 'neurology', 'branded_generics'] },
  'ATNI': { assetModel: 'asset_heavy', revenueModels: ['subscription', 'usage_based'], deliveryModel: 'self_operated', customerModel: 'B2B2C', industrySegment: 'Telecom/Fiber', tags: ['telecom', 'fiber', 'caribbean', 'rural', 'broadband'] },
  'BDN': { assetModel: 'asset_heavy', revenueModels: ['rental'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Office REIT', tags: ['REIT', 'office', 'philadelphia', 'urban', 'mixed_use'] },
  'BIG': { assetModel: 'asset_heavy', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Discount Retail', tags: ['discount', 'closeout', 'furniture', 'seasonal', 'value'] },
  'BPMC': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Precision Therapy Biotech', tags: ['biotech', 'precision_medicine', 'kinase_inhibitors', 'rare_disease', 'oncology'] },
  'BRSP': { assetModel: 'asset_heavy', revenueModels: ['interest_income'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Commercial Mortgage REIT', tags: ['REIT', 'mortgage', 'commercial', 'real_estate_debt', 'credit'] },
  'CDLX': { assetModel: 'platform', revenueModels: ['transaction_fee', 'advertising'], deliveryModel: 'marketplace', customerModel: 'B2B2C', industrySegment: 'Card-Linked Marketing', tags: ['fintech', 'card_linked', 'cashback', 'advertising', 'purchase_data'] },
  'CGC': { assetModel: 'asset_heavy', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Cannabis', tags: ['cannabis', 'marijuana', 'recreational', 'medical', 'canadian'] },
  'CMP': { assetModel: 'asset_heavy', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Industrial Minerals', tags: ['ite', 'calcium_carbonate', 'specialty_minerals', 'paper', 'construction'] },
  'CNNE': { assetModel: 'asset_light', revenueModels: ['service_fee', 'project_based'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'IT Consulting', tags: ['IT_consulting', 'digital_transformation', 'healthcare_IT', 'staffing'] },
  'DCO': { assetModel: 'asset_heavy', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Aerospace Components', tags: ['aerospace', 'defense', 'structures', 'electronics', 'manufacturing'] },
  'DSP': { assetModel: 'asset_light', revenueModels: ['subscription', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Digital Media Solutions', tags: ['programmatic', 'CTV', 'digital_advertising', 'self_serve', 'data'] },
  'ETWO': { assetModel: 'asset_light', revenueModels: ['subscription'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Supply Chain SaaS', tags: ['supply_chain', 'planning', 'SaaS', 'enterprise', 'AI'] },
  'GME': { assetModel: 'asset_heavy', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Video Game Retail', tags: ['gaming', 'retail', 'used_games', 'collectibles', 'ecommerce'] },
  'JOE': { assetModel: 'asset_heavy', revenueModels: ['product_sales', 'rental'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Real Estate Development', tags: ['real_estate', 'florida', 'land', 'residential', 'hospitality'] },
  'MAC': { assetModel: 'asset_heavy', revenueModels: ['rental'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Mall REIT', tags: ['REIT', 'mall', 'regional', 'retail', 'mixed_use'] },
  'NCMI': { assetModel: 'asset_light', revenueModels: ['advertising'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Cinema Advertising', tags: ['cinema', 'advertising', 'in_theater', 'digital', 'entertainment'] },
  'VRTV': { assetModel: 'asset_light', revenueModels: ['distribution'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Packaging Distribution', tags: ['packaging', 'distribution', 'print', 'supply_chain', 'fulfillment'] },
  'AZZ': { assetModel: 'asset_heavy', revenueModels: ['service_fee', 'product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Metal Coating Services', tags: ['galvanizing', 'hot_dip', 'metal_coating', 'infrastructure', 'industrial'] },
  'BCOR': { assetModel: 'asset_light', revenueModels: ['subscription', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'HR Technology', tags: ['recruiting', 'talent_acquisition', 'SaaS', 'HR_tech', 'enterprise'] },
  'BHB': { assetModel: 'asset_heavy', revenueModels: ['interest_income'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['community_bank', 'new_hampshire', 'deposits', 'loans', 'wealth_management'] },
  'BUSE': { assetModel: 'asset_heavy', revenueModels: ['interest_income'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['community_bank', 'indiana', 'deposits', 'commercial_loans', 'mortgage'] },
  'BW': { assetModel: 'asset_heavy', revenueModels: ['project_based', 'aftermarket'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Industrial Equipment', tags: ['boilers', 'environmental', 'power_generation', 'aftermarket', 'engineering'] },
  'CAMP': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Outdoor Recreation Products', tags: ['camping', 'outdoor', 'recreation', 'consumer_products', 'fishing'] },
  'CARE': { assetModel: 'asset_light', revenueModels: ['service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Healthcare Compliance', tags: ['healthcare', 'compliance', 'ethics', 'training', 'consulting'] },
  'CCBG': { assetModel: 'asset_heavy', revenueModels: ['interest_income'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['community_bank', 'florida', 'deposits', 'commercial_loans', 'wealth_management'] },
  'CHCO': { assetModel: 'asset_heavy', revenueModels: ['interest_income'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['community_bank', 'west_virginia', 'deposits', 'loans', 'trust'] },
  'CPSI': { assetModel: 'asset_light', revenueModels: ['subscription', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Healthcare IT', tags: ['healthcare_IT', 'EHR', 'community_hospitals', 'RCM', 'SaaS'] },
  'CSWC': { assetModel: 'asset_light', revenueModels: ['interest_income'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Business Development Company', tags: ['BDC', 'middle_market', 'private_credit', 'direct_lending', 'dallas'] },
  'CVGI': { assetModel: 'asset_heavy', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Commercial Vehicle Components', tags: ['truck', 'cab_systems', 'electrical', 'aftermarket', 'commercial_vehicle'] },
  'DFIN': { assetModel: 'asset_light', revenueModels: ['subscription', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Financial Compliance SaaS', tags: ['compliance', 'SEC_filing', 'SaaS', 'capital_markets', 'regulatory'] },
  'EHC': { assetModel: 'asset_heavy', revenueModels: ['service_fee'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Rehabilitation Hospitals', tags: ['rehab', 'inpatient', 'home_health', 'hospice', 'post_acute'] },
  'EFSC': { assetModel: 'asset_heavy', revenueModels: ['interest_income'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Community Banking', tags: ['community_bank', 'missouri', 'commercial_banking', 'SBA', 'deposits'] },
  'EQBK': { assetModel: 'asset_heavy', revenueModels: ['interest_income'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Community Banking', tags: ['community_bank', 'kansas', 'commercial_loans', 'deposits', 'digital_banking'] },
  'FBMS': { assetModel: 'asset_heavy', revenueModels: ['interest_income'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['community_bank', 'mississippi', 'deposits', 'mortgage', 'insurance'] },
  'FDUS': { assetModel: 'asset_light', revenueModels: ['interest_income'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Business Development Company', tags: ['BDC', 'lower_middle_market', 'private_credit', 'direct_lending', 'fidus'] },
  'FISI': { assetModel: 'asset_heavy', revenueModels: ['interest_income'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['community_bank', 'new_york', 'deposits', 'commercial_loans', 'wealth_management'] },
  'FMBI': { assetModel: 'asset_heavy', revenueModels: ['interest_income'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['community_bank', 'illinois', 'deposits', 'commercial_loans', 'mortgage'] },
  'FNLC': { assetModel: 'asset_heavy', revenueModels: ['interest_income'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['community_bank', 'maine', 'deposits', 'residential_loans', 'trust'] },
  'FRME': { assetModel: 'asset_heavy', revenueModels: ['interest_income'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['community_bank', 'indiana', 'deposits', 'commercial_loans', 'wealth_management'] },
  'FRPH': { assetModel: 'asset_heavy', revenueModels: ['rental', 'commodity_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Diversified Real Assets', tags: ['real_estate', 'mining', 'aggregates', 'land', 'development'] },
  'FSBC': { assetModel: 'asset_heavy', revenueModels: ['interest_income'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['community_bank', 'five_star', 'deposits', 'commercial_loans', 'mortgage'] },
  'GAIA': { assetModel: 'asset_light', revenueModels: ['subscription'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Streaming Media', tags: ['streaming', 'yoga', 'wellness', 'consciousness', 'niche_content'] },
  'GEOS': { assetModel: 'asset_light', revenueModels: ['product_sales', 'leasing'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Geophysical Equipment', tags: ['seismic', 'sensors', 'oil_gas', 'exploration', 'geophysical'] },
  'GP': { assetModel: 'asset_heavy', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Containerboard & Packaging', tags: ['containerboard', 'corrugated', 'packaging', 'paper', 'recycling'] },
  'GRC': { assetModel: 'asset_heavy', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Industrial Valves & Pumps', tags: ['valves', 'pumps', 'industrial', 'water', 'oil_gas'] },
  'GWB': { assetModel: 'asset_heavy', revenueModels: ['interest_income'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Community Banking', tags: ['community_bank', 'great_western', 'deposits', 'commercial_loans', 'ag_banking'] },
  'HASI': { assetModel: 'asset_heavy', revenueModels: ['interest_income', 'leasing'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Clean Energy REIT', tags: ['REIT', 'clean_energy', 'solar', 'wind', 'infrastructure_finance'] },
  'HIFS': { assetModel: 'asset_heavy', revenueModels: ['interest_income'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['community_bank', 'virginia', 'deposits', 'mortgage', 'trust'] },
  'HSII': { assetModel: 'asset_light', revenueModels: ['service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Executive Search', tags: ['executive_search', 'leadership', 'consulting', 'talent', 'C_suite'] },
  'IBCP': { assetModel: 'asset_heavy', revenueModels: ['interest_income'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['community_bank', 'michigan', 'deposits', 'commercial_loans', 'mortgage'] },
  'INBK': { assetModel: 'asset_heavy', revenueModels: ['interest_income'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['community_bank', 'indiana', 'digital_banking', 'deposits', 'mortgage'] },
  'KBAL': { assetModel: 'asset_heavy', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Office Furniture', tags: ['furniture', 'office', 'workplace', 'design', 'manufacturing'] },
  'LCUT': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Housewares & Tabletop', tags: ['housewares', 'tabletop', 'cutlery', 'kitchen', 'brands'] },
  'MBCN': { assetModel: 'asset_heavy', revenueModels: ['interest_income'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['community_bank', 'michigan', 'deposits', 'commercial_loans', 'wealth_management'] },
  'MBFI': { assetModel: 'asset_heavy', revenueModels: ['interest_income'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Community Banking', tags: ['community_bank', 'chicago', 'commercial_banking', 'leasing', 'treasury'] },
  'MBIN': { assetModel: 'asset_heavy', revenueModels: ['interest_income'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Community Banking', tags: ['community_bank', 'indiana', 'SBA_lending', 'healthcare_lending', 'specialty'] },
  'MEIP': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Specialty Pharmaceuticals', tags: ['oncology', 'rare_disease', 'specialty_pharma', 'pipeline', 'clinical'] },
  'MFIN': { assetModel: 'asset_light', revenueModels: ['interest_income', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Consumer Finance', tags: ['auto_finance', 'consumer_lending', 'subprime', 'securitization', 'servicing'] },
  'MNRL': { assetModel: 'asset_light', revenueModels: ['commodity_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Oil & Gas Royalties', tags: ['mineral_rights', 'royalties', 'permian', 'haynesville', 'passive'] },
  'MTRX': { assetModel: 'asset_light', revenueModels: ['project_based', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Industrial Services', tags: ['maintenance', 'turnaround', 'industrial', 'refinery', 'engineering'] },
  'ACBI': { assetModel: 'asset_heavy', revenueModels: ['interest_income'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['community_bank', 'virginia', 'deposits', 'commercial_loans', 'mortgage'] },
  'ACNB': { assetModel: 'asset_heavy', revenueModels: ['interest_income'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['community_bank', 'pennsylvania', 'deposits', 'insurance', 'trust'] },
  'AROW': { assetModel: 'asset_heavy', revenueModels: ['interest_income'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['community_bank', 'new_york', 'deposits', 'commercial_loans', 'trust'] },
  'HLLY': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Automotive Aftermarket', tags: ['performance_parts', 'automotive', 'aftermarket', 'exhaust', 'intake'] },
  'HNGE': { assetModel: 'asset_light', revenueModels: ['subscription'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Email Security SaaS', tags: ['email_security', 'cloud', 'saas', 'cybersecurity', 'phishing_protection'] },
  'HROW': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Ophthalmology Pharma', tags: ['ophthalmology', 'eye_care', 'specialty_pharma', 'compounding', 'optics'] },
  'HRTG': { assetModel: 'asset_heavy', revenueModels: ['product_sales', 'interest_income'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'P&C Insurance', tags: ['property_casualty', 'homeowners', 'florida', 'hurricane', 'insurance'] },
  'HYMC': { assetModel: 'asset_heavy', revenueModels: ['commodity_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Gold & Silver Mining', tags: ['gold', 'silver', 'mining', 'nevada', 'exploration'] },
  'IBIO': { assetModel: 'asset_heavy', revenueModels: ['service_fee', 'product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Biologics CDMO', tags: ['biologics', 'CDMO', 'plant_based', 'biopharmaceutical', 'manufacturing'] },
  'IFRX': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Rare Disease Pharma', tags: ['rare_disease', 'inflammation', 'immunology', 'specialty_pharma', 'clinical'] },
  'IMAB': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Oncology Biotech', tags: ['oncology', 'antibody', 'immuno_oncology', 'china', 'biotech'] },
  'IMGN': { assetModel: 'asset_light', revenueModels: ['product_sales', 'licensing'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Antibody-Drug Conjugates', tags: ['ADC', 'antibody_drug_conjugate', 'oncology', 'targeted_therapy', 'biotech'] },
  'IMMP': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Immuno-Oncology', tags: ['immunotherapy', 'peptide', 'oncology', 'HER2', 'clinical_stage'] },
  'INCR': { assetModel: 'asset_light', revenueModels: ['subscription', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'HR Tech SaaS', tags: ['workforce_management', 'HR', 'saas', 'payroll', 'human_capital'] },
  'INFA': { assetModel: 'asset_light', revenueModels: ['subscription', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Data Management', tags: ['data_integration', 'data_governance', 'cloud', 'ETL', 'enterprise'] },
  'INFI': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Oncology Biotech', tags: ['oncology', 'PI3K', 'hematology', 'biotech', 'clinical_stage'] },
  'INGN': { assetModel: 'asset_light', revenueModels: ['product_sales', 'rental'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Respiratory Devices', tags: ['oxygen_concentrator', 'portable', 'respiratory', 'medical_device', 'COPD'] },
  'ISPC': { assetModel: 'asset_light', revenueModels: ['subscription'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Cybersecurity SaaS', tags: ['cybersecurity', 'saas', 'threat_detection', 'cloud_security', 'AI'] },
  'IVAC': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Vaccine Biotech', tags: ['vaccine', 'biotech', 'infectious_disease', 'clinical_stage', 'immunology'] },
  'KGEI': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Oncology Biotech', tags: ['oncology', 'small_molecule', 'kinase_inhibitor', 'biotech', 'clinical'] },
  'KVHI': { assetModel: 'asset_light', revenueModels: ['subscription', 'product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Maritime Connectivity', tags: ['satellite', 'maritime', 'VSAT', 'connectivity', 'IoT'] },
  'LAKE': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Protective Clothing', tags: ['protective_clothing', 'PPE', 'safety', 'industrial', 'hazmat'] },
  'LANV': { assetModel: 'asset_light', revenueModels: ['subscription'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Cybersecurity SaaS', tags: ['network_security', 'microsegmentation', 'zero_trust', 'cybersecurity', 'cloud'] },
  'LBPH': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'CNS Pharma', tags: ['CNS', 'psychiatry', 'schizophrenia', 'specialty_pharma', 'clinical_stage'] },
  'LBTYA': { assetModel: 'asset_heavy', revenueModels: ['subscription', 'usage_based'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'European Telecom', tags: ['cable', 'broadband', 'europe', 'telecom', 'TV'] },
  'LHCG': { assetModel: 'asset_light', revenueModels: ['service_fee'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Home Health Services', tags: ['home_health', 'hospice', 'healthcare', 'nursing', 'post_acute'] },
  'LKCO': { assetModel: 'asset_light', revenueModels: ['product_sales', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Smart City IoT', tags: ['IoT', 'smart_city', 'parking', 'china', 'technology'] },
  'LMNX': { assetModel: 'asset_light', revenueModels: ['product_sales', 'consumables'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Life Science Instruments', tags: ['multiplexing', 'diagnostics', 'assays', 'life_science', 'instruments'] },
  'LOAR': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Aerospace Components', tags: ['aerospace', 'components', 'defense', 'aftermarket', 'OEM'] },
  'LOGM': { assetModel: 'asset_light', revenueModels: ['subscription'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Collaboration SaaS', tags: ['remote_access', 'video_conferencing', 'UCaaS', 'collaboration', 'cloud'] },
  'LOOP': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'EV Charging Tech', tags: ['EV_charging', 'power_electronics', 'wireless_charging', 'automotive', 'cleantech'] },
  'LPEN': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Oncology Diagnostics', tags: ['liquid_biopsy', 'diagnostics', 'oncology', 'genomics', 'clinical'] },
  'LTBR': { assetModel: 'asset_heavy', revenueModels: ['product_sales', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2G', industrySegment: 'Nuclear Technology', tags: ['nuclear', 'molten_salt', 'reactor', 'energy', 'advanced_nuclear'] },
  'LYRA': { assetModel: 'asset_light', revenueModels: ['subscription'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Mental Health Platform', tags: ['mental_health', 'EAP', 'telehealth', 'behavioral_health', 'enterprise'] },
  'MARN': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Oncology Biotech', tags: ['oncology', 'bone_marrow', 'CAR_T', 'cell_therapy', 'clinical_stage'] },
  'MAXY': { assetModel: 'asset_light', revenueModels: ['subscription', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Cloud Communications', tags: ['CPaaS', 'UCaaS', 'cloud_communications', 'VoIP', 'messaging'] },
  'MDAS': { assetModel: 'asset_heavy', revenueModels: ['project_based', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2G', industrySegment: 'Defense Electronics', tags: ['defense', 'electronics', 'radar', 'EW', 'government'] },
  'MDNA': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Gene Therapy Biotech', tags: ['gene_therapy', 'mRNA', 'rare_disease', 'biotech', 'clinical_stage'] },
  'MESA': { assetModel: 'asset_heavy', revenueModels: ['service_fee'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Regional Airlines', tags: ['regional_airline', 'CRJ', 'ERJ', 'contract_flying', 'aviation'] },
  'MODV': { assetModel: 'asset_heavy', revenueModels: ['rental', 'product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Modular Buildings', tags: ['modular', 'portable', 'construction', 'leasing', 'buildings'] },
  'MOGO': { assetModel: 'platform', revenueModels: ['subscription', 'transaction_fee'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Digital Finance', tags: ['fintech', 'digital_payments', 'crypto', 'lending', 'canada'] },

  // ========== Batch: 54 Confirmed-Missing US Stocks (Jan 2026 - Set J) ==========
  'ALTG': { assetModel: 'asset_heavy', revenueModels: ['leasing', 'service_fee', 'product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Equipment Dealer', tags: ['equipment', 'rental', 'construction', 'material_handling', 'dealer'] },
  'AMBP': { assetModel: 'asset_heavy', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Metal Packaging', tags: ['cans', 'beverage', 'metal_packaging', 'aluminum', 'sustainability'] },
  'APTS': { assetModel: 'asset_heavy', revenueModels: ['rental'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Multifamily REIT', tags: ['REIT', 'multifamily', 'apartments', 'southeast', 'preferred'] },
  'AQUA': { assetModel: 'asset_heavy', revenueModels: ['product_sales', 'service_fee', 'aftermarket'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Water Treatment', tags: ['water', 'treatment', 'filtration', 'purification', 'industrial_water'] },
  'ARCT': { assetModel: 'asset_light', revenueModels: ['licensing', 'product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'mRNA Biotech', tags: ['mRNA', 'therapeutics', 'vaccines', 'STARR', 'LUNAR'] },
  'ASAI': { assetModel: 'asset_heavy', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Grocery Retail', tags: ['grocery', 'cash_carry', 'Brazil', 'wholesale', 'food_retail'] },
  'ATHM': { assetModel: 'platform', revenueModels: ['advertising', 'transaction_fee', 'subscription'], deliveryModel: 'marketplace', customerModel: 'B2B2C', industrySegment: 'Auto Digital Platform', tags: ['auto', 'China', 'marketplace', 'advertising', 'leads'] },
  'ATRC': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Cardiac Surgery Devices', tags: ['cardiac', 'ablation', 'atrial_fibrillation', 'surgical', 'minimally_invasive'] },
  'AVDX': { assetModel: 'platform', revenueModels: ['subscription', 'transaction_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'AP Automation SaaS', tags: ['AP_automation', 'accounts_payable', 'fintech', 'SaaS', 'payments'] },
  'AVAL': { assetModel: 'asset_heavy', revenueModels: ['interest_income', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Latin American Banking', tags: ['bank', 'Colombia', 'Central_America', 'deposits', 'retail_banking'] },
  'AXGN': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Nerve Repair Biotech', tags: ['nerve_repair', 'regenerative', 'peripheral_nerve', 'surgical', 'tissue'] },
  'AY': { assetModel: 'asset_heavy', revenueModels: ['regulated_utility'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Renewable Energy Yieldco', tags: ['yieldco', 'solar', 'wind', 'renewable', 'contracted'] },
  'BGCP': { assetModel: 'platform', revenueModels: ['transaction_fee', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Interdealer Brokerage', tags: ['brokerage', 'fixed_income', 'institutional', 'voice', 'electronic'] },
  'BKEP': { assetModel: 'asset_heavy', revenueModels: ['throughput_fee', 'gathering'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Midstream MLP', tags: ['midstream', 'crude', 'storage', 'terminals', 'pipeline'] },
  'BRBS': { assetModel: 'asset_heavy', revenueModels: ['interest_income'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['community_bank', 'virginia', 'deposits', 'mortgage', 'commercial_loans'] },
  'CBNK': { assetModel: 'asset_heavy', revenueModels: ['interest_income', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['community_bank', 'maryland', 'deposits', 'commercial_loans', 'SBA'] },
  'CDAK': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Oncology Biotech', tags: ['oncology', 'T_cell', 'immunotherapy', 'clinical_stage', 'solid_tumors'] },
  'CENT': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Garden & Pet Products', tags: ['garden', 'pet', 'wild_bird', 'lawn', 'consumer_products'] },
  'CEQP': { assetModel: 'asset_heavy', revenueModels: ['gathering', 'throughput_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Midstream MLP', tags: ['midstream', 'gathering', 'processing', 'natural_gas', 'crude'] },
  'CFFN': { assetModel: 'asset_heavy', revenueModels: ['interest_income'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Thrift Banking', tags: ['thrift', 'savings_bank', 'mortgage', 'deposits', 'kansas'] },
  'CHCT': { assetModel: 'asset_heavy', revenueModels: ['rental'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Healthcare REIT', tags: ['REIT', 'healthcare', 'MOB', 'outpatient', 'net_lease'] },
  'CION': { assetModel: 'asset_light', revenueModels: ['interest_income'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Business Development Company', tags: ['BDC', 'middle_market', 'private_credit', 'direct_lending', 'leveraged'] },
  'CLVS': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Oncology Biotech', tags: ['oncology', 'PARP_inhibitor', 'Rubraca', 'ovarian', 'precision_medicine'] },
  'CMRX': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Anti-Infective Biotech', tags: ['antibiotics', 'antifungal', 'hospital', 'infectious_disease', 'IV'] },
  'CNXN': { assetModel: 'asset_light', revenueModels: ['product_sales', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'IT Solutions Provider', tags: ['IT_solutions', 'VAR', 'cloud', 'hardware', 'services'] },
  'CORS': { assetModel: 'asset_light', revenueModels: ['subscription', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Cybersecurity', tags: ['cybersecurity', 'threat_intelligence', 'network_security', 'DDoS', 'enterprise'] },
  'CRD': { assetModel: 'asset_light', revenueModels: ['service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Claims Management', tags: ['claims', 'insurance', 'TPA', 'adjusting', 'managed_repair'] },
  'CSGS': { assetModel: 'asset_light', revenueModels: ['subscription', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Telecom Billing SaaS', tags: ['billing', 'telecom', 'cable', 'revenue_management', 'SaaS'] },
  'CSTE': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Specialty Food & Beverage', tags: ['cheese', 'specialty_food', 'beverage', 'brands', 'natural'] },
  'CVAC': { assetModel: 'asset_light', revenueModels: ['product_sales', 'licensing'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'mRNA Biotech', tags: ['mRNA', 'vaccines', 'oncology', 'COVID', 'clinical_stage'] },
  'CVLT': { assetModel: 'asset_light', revenueModels: ['subscription'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Data Protection SaaS', tags: ['backup', 'data_protection', 'cloud', 'disaster_recovery', 'SaaS'] },
  'CXDO': { assetModel: 'asset_light', revenueModels: ['subscription', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Document Management SaaS', tags: ['document', 'content_management', 'ECM', 'workflow', 'SaaS'] },
  'CZFS': { assetModel: 'asset_heavy', revenueModels: ['interest_income'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['community_bank', 'ohio', 'deposits', 'mortgage', 'commercial_loans'] },
  'DCGO': { assetModel: 'asset_light', revenueModels: ['subscription', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Digital Health Platform', tags: ['digital_health', 'musculoskeletal', 'chronic_care', 'telehealth', 'employer'] },
  'DCP': { assetModel: 'asset_heavy', revenueModels: ['gathering', 'throughput_fee', 'commodity_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Natural Gas Midstream', tags: ['midstream', 'natural_gas', 'NGL', 'gathering', 'processing'] },
  'DXP': { assetModel: 'asset_light', revenueModels: ['distribution', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Industrial Distribution', tags: ['industrial', 'MRO', 'pumps', 'rotating_equipment', 'distribution'] },
  'DXPE': { assetModel: 'asset_light', revenueModels: ['distribution', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Industrial Distribution', tags: ['industrial', 'MRO', 'pumps', 'rotating_equipment', 'distribution'] },
  'ELVN': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Oncology Biotech', tags: ['oncology', 'precision_medicine', 'clinical_stage', 'targeted_therapy', 'biomarker'] },
  'EOLS': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Ophthalmology Pharma', tags: ['ophthalmology', 'dry_eye', 'eye_care', 'specialty_pharma', 'drops'] },
  'EOSE': { assetModel: 'asset_heavy', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Energy Storage', tags: ['zinc_battery', 'energy_storage', 'grid', 'long_duration', 'utility_scale'] },
  'EQRX': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Value-Based Pharma', tags: ['pharma', 'biosimilar', 'oncology', 'immunology', 'affordable'] },
  'ESTE': { assetModel: 'asset_heavy', revenueModels: ['commodity_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Shale E&P', tags: ['oil', 'gas', 'permian', 'shale', 'upstream'] },
  'EWCZ': { assetModel: 'asset_light', revenueModels: ['subscription', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Workforce Management SaaS', tags: ['workforce', 'scheduling', 'HR_tech', 'SaaS', 'enterprise'] },
  'FCPT': { assetModel: 'asset_heavy', revenueModels: ['rental'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Net Lease REIT', tags: ['REIT', 'net_lease', 'restaurant', 'retail', 'single_tenant'] },
  'FLUX': { assetModel: 'asset_light', revenueModels: ['product_sales', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'EV Charging Equipment', tags: ['EV', 'charging', 'infrastructure', 'DCFC', 'Level_2'] },
  'FNGR': { assetModel: 'platform', revenueModels: ['transaction_fee', 'subscription'], deliveryModel: 'self_operated', customerModel: 'B2B2C', industrySegment: 'Digital Payments Platform', tags: ['fintech', 'payments', 'emerging_markets', 'mobile', 'digital_wallet'] },
  'GATO': { assetModel: 'asset_heavy', revenueModels: ['commodity_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Gold Mining', tags: ['gold', 'silver', 'mining', 'Mexico', 'precious_metals'] },
  'GDS': { assetModel: 'asset_heavy', revenueModels: ['rental', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Data Center REIT', tags: ['data_center', 'China', 'colocation', 'cloud', 'hyperscale'] },
  'GNPX': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Biotech', tags: ['biotech', 'rare_disease', 'clinical_stage', 'precision_medicine', 'pipeline'] },
  'GYRE': { assetModel: 'asset_heavy', revenueModels: ['service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Environmental Services', tags: ['environmental', 'remediation', 'waste', 'industrial_services', 'clean_up'] },
  'HBT': { assetModel: 'asset_heavy', revenueModels: ['interest_income'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['community_bank', 'illinois', 'deposits', 'agriculture', 'commercial_loans'] },
  'HCKT': { assetModel: 'asset_light', revenueModels: ['service_fee', 'subscription'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'IT Consulting', tags: ['IT', 'consulting', 'benchmarking', 'digital_transformation', 'advisory'] },
  'HDSN': { assetModel: 'asset_light', revenueModels: ['distribution', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Refrigerant Distribution', tags: ['refrigerants', 'HVAC', 'distribution', 'reclamation', 'environmental'] },
  'HGBL': { assetModel: 'asset_light', revenueModels: ['service_fee', 'product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Asset Liquidation', tags: ['liquidation', 'auction', 'surplus', 'industrial', 'valuation'] },
  // ========== 51 NEW STOCKS ==========
  'TORC': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Robotics & Automation', tags: ['robotics', 'autonomous', 'industrial', 'automation', 'AI'] },
  'TPB': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Tobacco Alternatives', tags: ['tobacco', 'smokeless', 'nicotine', 'alternatives', 'consumer'] },
  'TPIC': { assetModel: 'asset_heavy', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Wind Turbine Components', tags: ['wind', 'turbine_blades', 'composites', 'renewable', 'clean_energy'] },
  'TRDA': { assetModel: 'asset_light', revenueModels: ['service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Trade Compliance', tags: ['trade', 'compliance', 'software', 'customs', 'logistics'] },
  'TRHC': { assetModel: 'asset_light', revenueModels: ['subscription', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Medication Management', tags: ['pharmacy', 'medication', 'healthcare_IT', 'clinical', 'risk_management'] },
  'TRMR': { assetModel: 'asset_light', revenueModels: ['advertising', 'service_fee'], deliveryModel: 'marketplace', customerModel: 'B2B', industrySegment: 'Digital Advertising', tags: ['adtech', 'programmatic', 'digital_media', 'video', 'CTV'] },
  'TRUE': { assetModel: 'asset_light', revenueModels: ['subscription', 'advertising'], deliveryModel: 'marketplace', customerModel: 'B2C', industrySegment: 'Automotive Marketplace', tags: ['automotive', 'marketplace', 'car_listings', 'digital', 'consumer'] },
  'TRVG': { assetModel: 'asset_light', revenueModels: ['advertising', 'service_fee'], deliveryModel: 'marketplace', customerModel: 'B2C', industrySegment: 'Travel Metasearch', tags: ['travel', 'hotel', 'metasearch', 'online', 'comparison'] },
  'TRVN': { assetModel: 'asset_light', revenueModels: ['product_sales', 'licensing'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Pain Management Biotech', tags: ['biotech', 'pain', 'opioid', 'pharmaceuticals', 'CNS'] },
  'TSAT': { assetModel: 'asset_heavy', revenueModels: ['service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Satellite Communications', tags: ['satellite', 'telecom', 'broadband', 'connectivity', 'space'] },
  'TSEM': { assetModel: 'asset_heavy', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Semiconductor Foundry', tags: ['semiconductor', 'foundry', 'wafer', 'fabrication', 'analog'] },
  'TTCF': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Plant-Based Foods', tags: ['plant_based', 'frozen_food', 'organic', 'consumer', 'healthy'] },
  'TWFG': { assetModel: 'asset_light', revenueModels: ['service_fee', 'transaction_fee'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Insurance Distribution', tags: ['insurance', 'distribution', 'P&C', 'personal_lines', 'agency'] },
  'TZOO': { assetModel: 'asset_light', revenueModels: ['advertising', 'transaction_fee'], deliveryModel: 'marketplace', customerModel: 'B2C', industrySegment: 'Travel Deals Platform', tags: ['travel', 'deals', 'hotel', 'vacation', 'online'] },
  'UCBI': { assetModel: 'asset_heavy', revenueModels: ['interest_income', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['community_bank', 'southeast', 'deposits', 'commercial_loans', 'mortgage'] },
  'UGP': { assetModel: 'asset_heavy', revenueModels: ['product_sales', 'distribution'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Fuel Distribution', tags: ['fuel', 'ethanol', 'sugar', 'distribution', 'brazil'] },
  'ULH': { assetModel: 'asset_heavy', revenueModels: ['service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Trucking & Logistics', tags: ['trucking', 'logistics', 'freight', 'intermodal', 'transportation'] },
  'UNVR': { assetModel: 'asset_light', revenueModels: ['distribution', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Chemical Distribution', tags: ['chemicals', 'distribution', 'specialty', 'industrial', 'solvents'] },
  'USHP': { assetModel: 'asset_light', revenueModels: ['service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Healthcare Staffing', tags: ['staffing', 'healthcare', 'nursing', 'travel_nurse', 'temporary'] },
  'UVSP': { assetModel: 'asset_heavy', revenueModels: ['interest_income', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['community_bank', 'pennsylvania', 'deposits', 'wealth_management', 'mortgage'] },
  'VEL': { assetModel: 'asset_heavy', revenueModels: ['interest_income'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Specialty Lending', tags: ['mortgage', 'non_QM', 'lending', 'investor_loans', 'real_estate'] },
  'VGFC': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Plant-Based Foods', tags: ['plant_based', 'vegan', 'food', 'consumer', 'alternative_protein'] },
  'VIRI': { assetModel: 'asset_light', revenueModels: ['product_sales', 'licensing'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Virology Biotech', tags: ['biotech', 'antiviral', 'infectious_disease', 'RNA', 'therapeutics'] },
  'VLDR': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'LiDAR Sensors', tags: ['lidar', 'sensors', 'autonomous', 'mapping', 'ADAS'] },
  'VNTR': { assetModel: 'asset_light', revenueModels: ['product_sales', 'licensing'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Industrial Biotech', tags: ['biotech', 'industrial', 'enzymes', 'synthetic_biology', 'materials'] },
  'VOCL': { assetModel: 'asset_light', revenueModels: ['subscription', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Voice AI', tags: ['voice', 'AI', 'speech', 'NLP', 'communication'] },
  'VOR': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Cell Therapy Biotech', tags: ['biotech', 'cell_therapy', 'gene_editing', 'hematology', 'oncology'] },
  'VPG': { assetModel: 'asset_heavy', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Precision Sensors', tags: ['sensors', 'precision', 'weighing', 'force', 'measurement'] },
  'VREX': { assetModel: 'asset_heavy', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Concrete Products', tags: ['concrete', 'precast', 'construction', 'infrastructure', 'building_materials'] },
  'VVX': { assetModel: 'asset_heavy', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Specialty Chemicals', tags: ['chemicals', 'specialty', 'laminates', 'composites', 'industrial'] },
  'VXRT': { assetModel: 'asset_light', revenueModels: ['product_sales', 'licensing'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Oral Vaccine Biotech', tags: ['biotech', 'vaccine', 'oral', 'infectious_disease', 'clinical_stage'] },
  'WABC': { assetModel: 'asset_heavy', revenueModels: ['interest_income', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['community_bank', 'california', 'deposits', 'commercial_loans', 'conservative'] },
  'WATT': { assetModel: 'asset_light', revenueModels: ['product_sales', 'licensing'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Wireless Charging', tags: ['wireless_charging', 'RF', 'power', 'IoT', 'technology'] },
  'WISA': { assetModel: 'asset_light', revenueModels: ['product_sales', 'licensing'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Wireless Audio', tags: ['wireless', 'audio', 'speakers', 'streaming', 'consumer_electronics'] },
  'WKHS': { assetModel: 'asset_heavy', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Electric Delivery Vehicles', tags: ['EV', 'electric', 'delivery', 'commercial_vehicles', 'last_mile'] },
  'WMK': { assetModel: 'asset_heavy', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Grocery Retail', tags: ['grocery', 'supermarket', 'retail', 'food', 'regional'] },
  'WTBA': { assetModel: 'asset_heavy', revenueModels: ['interest_income', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['community_bank', 'washington', 'deposits', 'mortgage', 'commercial_loans'] },
  'WVE': { assetModel: 'asset_light', revenueModels: ['product_sales', 'licensing'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'RNA Therapeutics', tags: ['biotech', 'RNA', 'oligonucleotide', 'genetic_medicine', 'clinical_stage'] },
  'XAIR': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Respiratory Biotech', tags: ['biotech', 'nitric_oxide', 'respiratory', 'antimicrobial', 'wound_care'] },
  'XBIT': { assetModel: 'asset_light', revenueModels: ['product_sales', 'licensing'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Gene Therapy Biotech', tags: ['biotech', 'gene_therapy', 'rare_disease', 'hemophilia', 'clinical_stage'] },
  'XELA': { assetModel: 'asset_light', revenueModels: ['service_fee', 'subscription'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Business Process Automation', tags: ['BPO', 'automation', 'document', 'healthcare', 'finance'] },
  'XENT': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'ENT Medical Devices', tags: ['medical_device', 'ENT', 'sinus', 'implant', 'minimally_invasive'] },
  'XFOR': { assetModel: 'asset_light', revenueModels: ['product_sales', 'licensing'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Oncology Biotech', tags: ['biotech', 'oncology', 'nuclear_medicine', 'radiopharmaceutical', 'clinical_stage'] },
  'XGN': { assetModel: 'asset_light', revenueModels: ['service_fee', 'subscription'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Cloud Software', tags: ['cloud', 'software', 'analytics', 'data', 'enterprise'] },
  'XMTR': { assetModel: 'asset_light', revenueModels: ['subscription', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Experience Management', tags: ['employee', 'engagement', 'HR_tech', 'analytics', 'SaaS'] },
  'XOMA': { assetModel: 'asset_light', revenueModels: ['licensing'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Biotech Royalties', tags: ['biotech', 'royalties', 'antibody', 'licensing', 'portfolio'] },
  'XPER': { assetModel: 'asset_light', revenueModels: ['licensing', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Digital Media Technology', tags: ['media_tech', 'IP', 'licensing', 'semiconductor', 'connected_car'] },
  'XTLB': { assetModel: 'asset_light', revenueModels: ['product_sales', 'licensing'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Immunology Biotech', tags: ['biotech', 'immunology', 'autoimmune', 'antibody', 'clinical_stage'] },
  'YGTY': { assetModel: 'asset_light', revenueModels: ['subscription', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Digital Identity', tags: ['identity', 'verification', 'fraud', 'digital', 'security'] },
  'YTEN': { assetModel: 'asset_heavy', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Specialty Steel', tags: ['steel', 'specialty', 'alloys', 'industrial', 'manufacturing'] },
  'RSVR': { assetModel: 'asset_light', revenueModels: ['subscription', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Oil & Gas Technology', tags: ['oilfield', 'technology', 'reservoir', 'analytics', 'SaaS'] },
  'RTLR': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B2C', industrySegment: 'E-commerce Retail', tags: ['retail', 'e-commerce', 'marketplace', 'consumer', 'online'] },
  'RUHN': { assetModel: 'platform', revenueModels: ['advertising', 'service_fee'], deliveryModel: 'marketplace', customerModel: 'B2B2C', industrySegment: 'Influencer Marketing', tags: ['KOL', 'influencer', 'China', 'e-commerce', 'social_media'] },
  'RZLT': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Biotech', tags: ['biotech', 'clinical_stage', 'oncology', 'rare_disease', 'pipeline'] },
  'SAND': { assetModel: 'asset_light', revenueModels: ['commodity_sales', 'licensing'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Gold Royalties & Streaming', tags: ['gold', 'royalty', 'streaming', 'precious_metals', 'mining'] },
  'SBFM': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Biotech', tags: ['biotech', 'clinical_stage', 'infectious_disease', 'pipeline', 'antibiotics'] },
  'SBNY': { assetModel: 'asset_heavy', revenueModels: ['interest_income', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Commercial Banking', tags: ['commercial_bank', 'crypto', 'fintech', 'digital_assets', 'NYC'] },
  'SBTX': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Biotech', tags: ['biotech', 'oncology', 'clinical_stage', 'immunotherapy', 'pipeline'] },
  'SCPH': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Specialty Pharma', tags: ['pharma', 'pain_management', 'specialty', 'acute_care', 'hospital'] },
  'SEER': { assetModel: 'asset_light', revenueModels: ['product_sales', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Life Sciences Tools', tags: ['genomics', 'proteomics', 'spatial_biology', 'research_tools', 'diagnostics'] },
  'SELB': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Biotech', tags: ['biotech', 'RNA', 'clinical_stage', 'genetic_medicine', 'pipeline'] },
  'SFIX': { assetModel: 'platform', revenueModels: ['product_sales', 'subscription'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Personalized Retail', tags: ['apparel', 'AI', 'styling', 'subscription', 'personalization'] },
  'SFRG': { assetModel: 'asset_heavy', revenueModels: ['product_sales'], deliveryModel: 'franchise', customerModel: 'B2C', industrySegment: 'Specialty Retail Food', tags: ['food', 'franchise', 'retail', 'sandwiches', 'restaurants'] },
  'SGML': { assetModel: 'asset_heavy', revenueModels: ['commodity_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Lithium Mining', tags: ['lithium', 'mining', 'EV', 'battery_materials', 'critical_minerals'] },
  'SHBI': { assetModel: 'asset_heavy', revenueModels: ['interest_income', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['community_bank', 'virginia', 'deposits', 'mortgages', 'commercial_loans'] },
  'SIGA': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2G', industrySegment: 'Biodefense Pharma', tags: ['biodefense', 'smallpox', 'antiviral', 'government', 'BARDA'] },
  'SILO': { assetModel: 'asset_heavy', revenueModels: ['rental'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Farmland REIT', tags: ['farmland', 'REIT', 'agriculture', 'real_estate', 'rental'] },
  'SIM': { assetModel: 'asset_light', revenueModels: ['service_fee', 'subscription'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'IT Staffing', tags: ['staffing', 'IT', 'consulting', 'workforce', 'technology'] },
  'SIVB': { assetModel: 'asset_heavy', revenueModels: ['interest_income', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Innovation Banking', tags: ['venture', 'tech_banking', 'startup', 'silicon_valley', 'PE_VC'] },
  'SKIL': { assetModel: 'asset_light', revenueModels: ['subscription', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Workforce Training', tags: ['training', 'upskilling', 'education', 'workforce', 'technology'] },
  'SKLZ': { assetModel: 'platform', revenueModels: ['transaction_fee'], deliveryModel: 'marketplace', customerModel: 'B2C', industrySegment: 'Mobile Gaming Platform', tags: ['gaming', 'mobile', 'esports', 'platform', 'competition'] },
  'SMBC': { assetModel: 'asset_heavy', revenueModels: ['interest_income', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['community_bank', 'missouri', 'deposits', 'mortgages', 'commercial_loans'] },
  'SMLR': { assetModel: 'asset_light', revenueModels: ['product_sales', 'consumables'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Medical Devices', tags: ['medical_device', 'insulin', 'diabetes', 'continuous_monitoring', 'wearable'] },
  'SONN': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Biotech', tags: ['biotech', 'clinical_stage', 'neurology', 'pain', 'pipeline'] },
  'SPHR': { assetModel: 'asset_heavy', revenueModels: ['product_sales', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B2C', industrySegment: 'Entertainment Venues', tags: ['entertainment', 'venues', 'live_events', 'hospitality', 'nightlife'] },
  'SPOK': { assetModel: 'asset_heavy', revenueModels: ['subscription', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Healthcare Communications', tags: ['paging', 'healthcare', 'communications', 'messaging', 'hospital'] },
  'SPRO': { assetModel: 'asset_light', revenueModels: ['subscription', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Sales Enablement SaaS', tags: ['sales', 'enablement', 'SaaS', 'content_management', 'analytics'] },
  'SPT': { assetModel: 'asset_light', revenueModels: ['subscription', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Loyalty & Engagement SaaS', tags: ['loyalty', 'engagement', 'SaaS', 'marketing', 'analytics'] },
  'SPWH': { assetModel: 'asset_heavy', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Outdoor Retail', tags: ['outdoor', 'sporting_goods', 'firearms', 'fishing', 'hunting'] },
  'SQNS': { assetModel: 'asset_light', revenueModels: ['product_sales', 'licensing'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'IoT Semiconductors', tags: ['IoT', 'semiconductor', '5G', 'LTE', 'wireless'] },
  'SRCE': { assetModel: 'asset_heavy', revenueModels: ['interest_income', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['community_bank', 'indiana', 'deposits', 'trust', 'commercial_loans'] },
  'SRDX': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Medical Devices', tags: ['medical_device', 'vascular', 'drug_delivery', 'polymer', 'coatings'] },
  'STBA': { assetModel: 'asset_heavy', revenueModels: ['interest_income', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['community_bank', 'pennsylvania', 'deposits', 'wealth_management', 'commercial_loans'] },
  'STRO': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Biotech', tags: ['biotech', 'oncology', 'antibody', 'clinical_stage', 'immuno_oncology'] },
  'STRS': { assetModel: 'asset_heavy', revenueModels: ['product_sales', 'rental'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Building Materials & Real Estate', tags: ['aggregates', 'real_estate', 'texas', 'construction', 'land'] },
  'STTK': { assetModel: 'asset_light', revenueModels: ['product_sales', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Synthetic Biology', tags: ['synthetic_biology', 'genomics', 'bioinformatics', 'research_tools', 'biotech'] },
  'SUNW': { assetModel: 'asset_light', revenueModels: ['project_based', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Solar Installation', tags: ['solar', 'residential', 'installation', 'renewable', 'energy'] },
  'SVA': { assetModel: 'asset_heavy', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2G', industrySegment: 'Vaccine Manufacturing', tags: ['vaccine', 'China', 'biologics', 'hepatitis', 'government'] },
  'SVRA': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Biotech', tags: ['biotech', 'clinical_stage', 'hematology', 'rare_disease', 'pipeline'] },
  'SWBI': { assetModel: 'asset_heavy', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Firearms Manufacturing', tags: ['firearms', 'handguns', 'rifles', 'defense', 'outdoor'] },
  'SWCH': { assetModel: 'asset_heavy', revenueModels: ['rental', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Data Center REIT', tags: ['data_center', 'colocation', 'cloud', 'hyperscale', 'Las_Vegas'] },
  'SXTC': { assetModel: 'asset_heavy', revenueModels: ['commodity_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Specialty Chemicals', tags: ['chemicals', 'China', 'fine_chemicals', 'pharmaceutical_intermediates', 'manufacturing'] },
  'SYBT': { assetModel: 'asset_heavy', revenueModels: ['interest_income', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['community_bank', 'kentucky', 'deposits', 'wealth_management', 'commercial_loans'] },
  'SYNL': { assetModel: 'asset_heavy', revenueModels: ['product_sales', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Specialty Manufacturing', tags: ['manufacturing', 'custom', 'metal_fabrication', 'industrial', 'diversified'] },
  'TCBK': { assetModel: 'asset_heavy', revenueModels: ['interest_income', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['community_bank', 'california', 'deposits', 'agriculture', 'commercial_loans'] },
  'TDUP': { assetModel: 'platform', revenueModels: ['transaction_fee', 'product_sales'], deliveryModel: 'marketplace', customerModel: 'B2C', industrySegment: 'Resale Marketplace', tags: ['resale', 'thrift', 'marketplace', 'sustainability', 'apparel'] },
  'TELA': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Medical Devices', tags: ['medical_device', 'surgical', 'hernia', 'tissue_reinforcement', 'biologics'] },
  'TFFP': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Specialty Pharma', tags: ['pharma', 'womens_health', 'specialty', 'fertility', 'endocrinology'] },
  'TFSL': { assetModel: 'asset_heavy', revenueModels: ['interest_income', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Savings & Loan', tags: ['thrift', 'savings', 'mortgages', 'deposits', 'ohio'] },
  'TIPT': { assetModel: 'asset_heavy', revenueModels: ['rental'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Diversified REIT', tags: ['REIT', 'office', 'hotel', 'diversified', 'real_estate'] },
  'TIRX': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Biotech', tags: ['biotech', 'respiratory', 'clinical_stage', 'inflammation', 'pipeline'] },
  'TLMD': { assetModel: 'platform', revenueModels: ['subscription', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B2C', industrySegment: 'Telehealth', tags: ['telehealth', 'telemedicine', 'Latin_America', 'digital_health', 'platform'] },
  'TLS': { assetModel: 'asset_light', revenueModels: ['product_sales', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Life Sciences Tools', tags: ['genomics', 'precision_medicine', 'clinical_testing', 'diagnostics', 'sequencing'] },
  'TLSA': { assetModel: 'asset_heavy', revenueModels: ['commodity_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Gold Mining', tags: ['gold', 'mining', 'Peru', 'precious_metals', 'exploration'] },
  'TNXP': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Biotech', tags: ['biotech', 'clinical_stage', 'CNS', 'neuroscience', 'pipeline'] },

  // ========== Batch: 55 Confirmed-Missing US Stocks (Jan 2026 - Set K) ==========
  'MSGM': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Motorsport Entertainment', tags: ['motorsport', 'entertainment', 'events', 'media', 'racing'] },
  'MTEX': { assetModel: 'asset_heavy', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Specialty Textiles', tags: ['textiles', 'automotive', 'industrial_fabrics', 'upholstery', 'manufacturing'] },
  'MVBF': { assetModel: 'asset_heavy', revenueModels: ['interest_income'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['community_bank', 'west_virginia', 'deposits', 'commercial_loans', 'fintech'] },
  'MVIS': { assetModel: 'asset_light', revenueModels: ['product_sales', 'licensing'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Lidar & AR Display', tags: ['lidar', 'AR', 'MEMS', 'autonomous_driving', 'micro_display'] },
  'NBHC': { assetModel: 'asset_heavy', revenueModels: ['interest_income'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['community_bank', 'colorado', 'deposits', 'commercial_loans', 'wealth_management'] },
  'NCBS': { assetModel: 'asset_heavy', revenueModels: ['interest_income'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['community_bank', 'ohio', 'deposits', 'mortgage', 'commercial_loans'] },
  'NCTY': { assetModel: 'platform', revenueModels: ['subscription', 'transaction_fee'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Online Gaming', tags: ['gaming', 'china', 'online', 'MMO', 'virtual_goods'] },
  'NEOS': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Specialty Pharmaceuticals', tags: ['specialty_pharma', 'ADHD', 'pediatric', 'extended_release', 'CNS'] },
  'NERV': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'CNS Biotech', tags: ['neuroscience', 'depression', 'CNS', 'clinical_stage', 'biotech'] },
  'NEWT': { assetModel: 'asset_light', revenueModels: ['interest_income', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Business Development Company', tags: ['BDC', 'fintech', 'small_business', 'lending', 'SBA'] },
  'NGMS': { assetModel: 'asset_light', revenueModels: ['product_sales', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2G', industrySegment: 'Defense IT & Analytics', tags: ['defense', 'analytics', 'intelligence', 'cybersecurity', 'government'] },
  'NGVC': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Natural & Organic Grocery', tags: ['organic', 'natural', 'grocery', 'health', 'specialty_retail'] },
  'NHTC': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Health & Wellness MLM', tags: ['wellness', 'supplements', 'MLM', 'direct_sales', 'personal_care'] },
  'NINE': { assetModel: 'asset_heavy', revenueModels: ['service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Oilfield Services', tags: ['completion', 'cementing', 'wireline', 'coiled_tubing', 'oilfield'] },
  'NMFC': { assetModel: 'asset_light', revenueModels: ['interest_income'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Business Development Company', tags: ['BDC', 'middle_market', 'private_credit', 'direct_lending', 'leveraged'] },
  'NNOX': { assetModel: 'asset_light', revenueModels: ['product_sales', 'usage_based'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Medical Imaging', tags: ['digital_xray', 'imaging', 'medical_device', 'AI', 'point_of_care'] },
  'NPTN': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Optical Components', tags: ['photonics', 'optical', 'InP', 'datacom', 'telecom'] },
  'NR': { assetModel: 'asset_heavy', revenueModels: ['product_sales', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Drilling Fluids & Mats', tags: ['drilling_fluids', 'composite_mats', 'oilfield', 'industrial', 'environmental'] },
  'NTCT': { assetModel: 'asset_light', revenueModels: ['product_sales', 'subscription'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Network Test & Security', tags: ['network_test', 'packet_broker', 'visibility', 'cybersecurity', 'telecom'] },
  'NTST': { assetModel: 'asset_heavy', revenueModels: ['rental'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Net Lease REIT', tags: ['REIT', 'net_lease', 'retail', 'single_tenant', 'triple_net'] },
  'NUAN': { assetModel: 'asset_light', revenueModels: ['subscription', 'licensing'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Conversational AI', tags: ['AI', 'speech_recognition', 'NLP', 'healthcare_IT', 'enterprise'] },
  'NURO': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Neurology Biotech', tags: ['neurology', 'neuropathy', 'clinical_stage', 'biotech', 'pain'] },
  'NVEC': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Spintronic Sensors', tags: ['spintronics', 'sensors', 'isolators', 'semiconductors', 'industrial'] },
  'NWBI': { assetModel: 'asset_heavy', revenueModels: ['interest_income'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['community_bank', 'pennsylvania', 'deposits', 'mortgage', 'commercial_loans'] },
  'OCFC': { assetModel: 'asset_heavy', revenueModels: ['interest_income'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['community_bank', 'new_jersey', 'deposits', 'commercial_loans', 'wealth_management'] },
  'OCFT': { assetModel: 'platform', revenueModels: ['transaction_fee', 'subscription'], deliveryModel: 'marketplace', customerModel: 'B2B', industrySegment: 'Digital Freight Platform', tags: ['freight', 'logistics', 'digital', 'marketplace', 'trucking'] },
  'OEC': { assetModel: 'asset_heavy', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Specialty Chemicals', tags: ['specialty_chemicals', 'polymer', 'automotive', 'rubber', 'performance_materials'] },
  'OMER': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Specialty Pharmaceuticals', tags: ['specialty_pharma', 'ophthalmology', 'complement', 'inflammation', 'rare_disease'] },
  'OMIC': { assetModel: 'asset_light', revenueModels: ['service_fee', 'product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Genomics Services', tags: ['genomics', 'RNA', 'transcriptomics', 'diagnostics', 'precision_medicine'] },
  'ONEW': { assetModel: 'asset_heavy', revenueModels: ['product_sales', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Marine Retail', tags: ['boats', 'marine', 'dealer', 'yachts', 'recreation'] },
  'OPRT': { assetModel: 'asset_light', revenueModels: ['interest_income'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Consumer Finance', tags: ['personal_loans', 'consumer_lending', 'AI_underwriting', 'fintech', 'subprime'] },
  'ORGO': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Regenerative Medicine', tags: ['wound_care', 'surgical', 'regenerative', 'biologics', 'tissue'] },
  'ORLA': { assetModel: 'asset_heavy', revenueModels: ['commodity_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Gold Mining', tags: ['gold', 'mining', 'oxide', 'heap_leach', 'mexico'] },
  'OSBC': { assetModel: 'asset_heavy', revenueModels: ['interest_income'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['community_bank', 'illinois', 'deposits', 'commercial_loans', 'trust'] },
  'PBCT': { assetModel: 'asset_heavy', revenueModels: ['interest_income'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Regional Banking', tags: ['regional_bank', 'new_england', 'deposits', 'commercial_loans', 'wealth_management'] },
  'PBH': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Consumer Healthcare', tags: ['OTC', 'consumer_health', 'brands', 'self_care', 'analgesics'] },
  'PDFS': { assetModel: 'asset_light', revenueModels: ['subscription', 'service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Semiconductor Analytics', tags: ['semiconductor', 'yield', 'analytics', 'design', 'characterization'] },
  'PFIS': { assetModel: 'asset_heavy', revenueModels: ['interest_income'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['community_bank', 'pennsylvania', 'deposits', 'trust', 'wealth_management'] },
  'PFS': { assetModel: 'asset_heavy', revenueModels: ['interest_income'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['community_bank', 'new_jersey', 'deposits', 'mortgage', 'commercial_loans'] },
  'PHAT': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Specialty Food & Beverage', tags: ['superfoods', 'health_food', 'plant_based', 'snacks', 'natural'] },
  'PKOH': { assetModel: 'asset_heavy', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Industrial Equipment', tags: ['material_handling', 'industrial', 'automation', 'steel_processing', 'manufacturing'] },
  'PMD': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Medical Diagnostics', tags: ['psychedelic', 'diagnostics', 'biomarker', 'mental_health', 'precision_medicine'] },
  'PNRG': { assetModel: 'asset_heavy', revenueModels: ['commodity_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Oil & Gas E&P', tags: ['oil', 'gas', 'upstream', 'exploration', 'production'] },
  'PRAH': { assetModel: 'asset_light', revenueModels: ['service_fee'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Contract Research Organization', tags: ['CRO', 'clinical_trials', 'pharma_services', 'data_analytics', 'regulatory'] },
  'PRKS': { assetModel: 'asset_heavy', revenueModels: ['interest_income'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['community_bank', 'united_fire', 'deposits', 'commercial_loans', 'insurance'] },
  'PRTK': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Specialty Pharmaceuticals', tags: ['specialty_pharma', 'oral_drug_delivery', 'GI', 'clinical_stage', 'formulation'] },
  'QLGN': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Oncology Biotech', tags: ['oncology', 'cell_therapy', 'QN_202', 'clinical_stage', 'biotech'] },
  'RBNC': { assetModel: 'asset_heavy', revenueModels: ['interest_income'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['community_bank', 'reliant', 'deposits', 'commercial_loans', 'mortgage'] },
  'RCII': { assetModel: 'asset_heavy', revenueModels: ['rental', 'product_sales'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Rent-to-Own Retail', tags: ['rent_to_own', 'furniture', 'electronics', 'appliances', 'consumer_finance'] },
  'RDUS': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Hospital Pharma', tags: ['hospital', 'injectable', 'generic', 'specialty_pharma', 'acute_care'] },
  'RERE': { assetModel: 'platform', revenueModels: ['transaction_fee', 'service_fee'], deliveryModel: 'marketplace', customerModel: 'B2C', industrySegment: 'Recommerce Platform', tags: ['used_goods', 'recommerce', 'china', 'marketplace', 'circular_economy'] },
  'RIVE': { assetModel: 'asset_heavy', revenueModels: ['interest_income'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['community_bank', 'riverview', 'deposits', 'commercial_loans', 'mortgage'] },
  'RNAC': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'RNA Therapeutics', tags: ['RNA', 'therapeutics', 'genetic_medicine', 'clinical_stage', 'rare_disease'] },
  'RNLX': { assetModel: 'asset_light', revenueModels: ['product_sales'], deliveryModel: 'self_operated', customerModel: 'B2B', industrySegment: 'Oncology Biotech', tags: ['oncology', 'Renalytix', 'kidney', 'AI_diagnostics', 'biotech'] },
  'RRBI': { assetModel: 'asset_heavy', revenueModels: ['interest_income'], deliveryModel: 'self_operated', customerModel: 'B2C', industrySegment: 'Community Banking', tags: ['community_bank', 'red_river', 'deposits', 'commercial_loans', 'agriculture'] },
};
