...
- **详见**: `.claude/skills/standard-analysis/SKILL.md`（Phase 3创建）

### Tier 3: 深度研究 (`/deep-dive [代码]`)
- **时长**: 多会话 | **字数**: ≥80,000×行业系数 | **输出**: 机构级MD报告
- **用途**: 重仓决策、全面深度研究
- **数据**: 全面数据获取+预测市场+五引擎分析
- **协议**: 4Phase阻断式，每Phase=1次会话
