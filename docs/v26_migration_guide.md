...
print(f"建议仓位: {result['temperature']['interpretation']['position_range']}")
```

#### 温度级别解读
| 温度级别 | 评分范围 | 建议操作 | 建议仓位 | 含义 |
|---------|---------|---------|----------|------|
| 🧊 极冷 | ≤-1.5 | 积极买入 | 80-100% | 严重低估，长期投资良机 |
| ❄️ 偏冷 | -1.5~-0.5 | 适度加仓 | 60-80% | 出现价值投资机会 |
| 😐 中性 | -0.5~+0.5 | 持有观望 | 40-60% | 各项指标基本均衡 |
| 🌡️ 偏热 | +0.5~+1.5 | 谨慎持有 | 20-40% | 估值偏高，存在回调风险 |
| 🔥 过热 | ≥+1.5 | 减仓止盈 | 0-20% | 多项指标显示严重高估 |
