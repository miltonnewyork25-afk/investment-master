...
| 分类 | AI能力 | 处理方式 | 示例 |
|------|--------|---------|------|
| **深挖区** | 强优势 | 投入主要篇幅，充分发挥 | 技术路线拆解、供应链映射、跨公司模式、可能性穷举 |
...
可能性宽度≥7分的公司（TSLA/PLTR等），在动态框架基础上额外使用发现系统的Part 2-7：

- Part 2: 按不确定性类型(A/B/C)分支的可能性映射
- Part 3-7: 开放问题、证据方向、转折点、价格含义、未知清单

4-6分的公司（GOOGL/META等）可选择性使用部分发现系统组件作为补充。

0-3分的公司（COST/TSM等）不使用发现系统，但仍遵循动态路由——估值在TSM是[呈现]（相对可靠），不需要发现系统的可能性映射。
