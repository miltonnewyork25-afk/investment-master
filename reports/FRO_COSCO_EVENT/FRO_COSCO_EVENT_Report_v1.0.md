...
**中远的资本结构** (基于FY2024数据推算):
- FY2024收入: CNY 232.3B (~$31.8B) → 但这是**集团口径**(含代管船等)
- FY2024净利润: CNY 40.4B (~$5.5B)
- 作为国企，中远海能的负债率通常控制在50-60%(vs FRO的D/E 1.22x)
- 国企有隐含的主权信用支持 → 融资成本低于FRO
- **利息保障倍数**: 推估>5x(国企通常维持保守杠杆)

[DM-COS-008: COSCO capital structure estimate]
