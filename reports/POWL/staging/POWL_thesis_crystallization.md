...
| 代号 | 条件 | 含义 | 预期触发时间 | 状态 |
|------|------|------|------------|------|
| Y1 | Q2-Q3 FY26 未再披露 DC 大订单 ($50M+) | 单季 mega 是一次性 | 2026H2 | 待观察 |
| Y2 | 大 hyperscaler 2026 CapEx guidance 下调 ≥20% | 行业需求动能减弱 | 2026H2-2027 | 待观察 |
| **Y3** | **内部人 disposed ratio <0.5 持续** | **管理层持续减持** | **已触发** | **✓ (0.04→0.26, Q1 $42M 历史新高, 见 P0.75 补全)** |
