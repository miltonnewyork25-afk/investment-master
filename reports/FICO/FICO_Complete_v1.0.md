...
- Forward P/E: ~35x (FY2026E EPS $41.53共识)
- EV/EBITDA: 41x
...
| DM-P2-011 | Forward P/E = 35x (FY2026E EPS $41.53) | FMP Estimates | ★★★★☆ |
...
## 11.8 护城河趋势仪表盘: 加强还是削弱?

前文§11.1-11.7分别解剖了护城河的五层结构、历史先例、侵蚀速度。本节将这些分散信号汇聚为一个**时间序列趋势仪表盘**，回答一个关键问题: FICO的护城河正在加强还是削弱?

### 五层护城河强度评分 (0-5分, 分析师主观评估)
...
```mermaid
graph LR
    subgraph "FICO护城河强度趋势 (2018→2030E)"
        A["2018<br>综合4.5<br>定价权待释放"] --> B["2020<br>综合4.6<br>Stage 2提价开始"]
        B --> C["2022<br>综合4.7<br>OPM突破40%<br>定价权全面兑现"]
        C --> D["2024<br>综合4.7<br>峰值平台期<br>FHFA+诉讼预警"]
        D --> E["2026E<br>综合4.5<br>L1/L2微降<br>VS获准但未迁移"]
        E --> F["2028E<br>综合4.0-4.3<br>取决于VS采纳速度"]
        F --> G["2030E<br>综合3.5-4.3<br>分歧最大区间"]
    end
...
**情景A — 护城河再加固 (概率20%)**:
- VS采纳失败(<5% by 2030), 诉讼全部驳回, FICO 10T成为新标准
- L1/L2回升至5.0, L3继续扩张(OPM→55%)
- 综合评分轨迹: 4.5→4.8→5.0
- 估值含义: 支撑52x+ P/E的长期特许权价值

**情景B — 缓慢侵蚀 (概率55%, 基准情景)**:
- VS逐步获得10-20%份额(2027-2032), 诉讼和解($200-500M), FICO通过提价+DLP对冲
- L1/L2从5.0降至4.0-4.5, L3维持(定价权部分抵消量损失), L4/L5缓慢下降
- 综合评分轨迹: 4.5→4.2→3.8
- 估值含义: PE从52x温和压缩至30-40x, 年化回报5-8%

**情景C — 加速崩塌 (概率25%)**:
- VS快速获得>30%份额(征信局全力推广), 诉讼集体认证+巨额赔偿, 国会立法干预
- L1从5.0降至3.0(制度基础动摇), L2/L5连锁崩溃
- 综合评分轨迹: 4.5→3.0→2.5
- 估值含义: PE压缩至15-20x, 股价$500-700区间
...
**魔鬼论点**:
1. 52x P/E看似高,但如果FY2026E EPS $41.53,Forward P/E为35x——较TTM有明显压缩
2. Forward 35x对于OPM 47%+FCF margin 39%的公司属于偏高但非极端(ServiceNow 50x+)
3. OPM还有10-15pp扩张空间→EPS可加速至25%+ CAGR
4. 回购持续减少股数→进一步放大EPS增长

**红队回应**:
- Forward P/E 35x的前提是FY2026E EPS $41.53(+54% YoY)。如果VantageScore开始侵蚀,这个共识可能下调
- ServiceNow的50x PE基于30%+收入增长;FICO的收入增长仅16%且可能放缓至10%
- 35x Forward P/E对于16%收入增速的公司仍然偏高(PEG=35/22=1.6)
- **结论**: Forward P/E 35x较TTM 52x有压缩,但仍高于同类公司中位数。且高度依赖FY2026E不被下调。**调整: 同时展示TTM和Forward PE,避免选择性使用数据**
...
| 偏差类型 | 表现 | 严重度 | 修正 |
|---------|------|--------|------|
| **锚定偏差** | 过度锚定52x TTM P/E(vs 35x Forward仍偏高但有压缩) | 中 | 已修正(RT-1) |
...
| DM-P4-005 | Forward P/E=35x(FY2026E) | FMP Estimates | ★★★★☆ |
...
- 但"偏中性"修正因为:
  1. Forward P/E 35x较TTM 52x有明显压缩,显示盈利增速可部分消化估值
  2. 护城河半衰期10-15年提供时间缓冲
  3. 红队上调+1.6%→距"中性关注"边界仅6pp
- **如果**: 股价降至$1,100-1,200(Forward PE 26-29x)→升级为"中性关注"
...
| DM-P0-004 | Forward P/E = 35x (FY2026E EPS $41.53) | FMP Estimates | ★★★★☆ |
...
| DM-P2-011 | Forward P/E = 35x (FY2026E) | FMP Estimates | ★★★★☆ |
