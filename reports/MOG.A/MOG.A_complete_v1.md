...
```mermaid
flowchart LR
    A[Backlog +30%] --> B[GAAP 净利润]
    B --> C[调整后 EPS $8.28]
    C --> D[市场按 PE×EPS 定价]
    D --> E[$313]
    B -.断裂点.-> F[Inventory +$190M 吸收]
    B -.断裂点.-> G[CapEx $145M 吸收]
    B -.断裂点.-> H[WC 其他 +$70M 吸收]
    F --> I[OCF $273M]
    G --> I
    H --> I
    I --> J[FCF $128M]
    J --> K[FCFE −$140M 后利息/税/债务]
    K --> L[股东实际拿到: 零]
    style B fill:#ffe,stroke:#333
    style L fill:#fdd,stroke:#900,stroke-width:2px
```
