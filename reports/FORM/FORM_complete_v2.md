...
2027-2028年进入下行的概率**45-55%** [DM-CYCLE-004]。Gartner预测Q3 2026 DRAM价格回调14% [DM-CYCLE-005]。价格回调不等于需求消失，但价格下行改变了Memory厂商的CapEx投资回报计算——如果每GB DRAM利润下降，扩产动力就减弱。

如果2027年进入下行周期，FORM的历史表现是：FY2019→2020收入-12%，FY2022→2023收入-13%。下行幅度适中但持续1-2年。结合F&L的持续萎缩（-15%过去4年），周期下行期FORM的双线失速风险是最被低估的尾部风险。
