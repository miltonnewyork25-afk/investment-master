...
> 质量指标: 249K字符 | 因果密度8.71/万字 | DM密度0.91/千字 | 228个DM锚点
...
本报告引用228个DM锚点，完整注册表见 `data/research/ADBE/dm_anchor_registry.json`。

## 方法论说明

- **AIAS v1.1**: AI Software Impact Assessment System，首创于本报告。5种威胁(S1-S5)+4种受益(B1-B4)×6条业务线，含FVF一线验证+演绎衰减系数+动态权重模拟。可迁移至CRM/NOW/ADSK。
...
*ADBE v2.0 Complete | 2026-03-18 | 249K字符 | 17章 | 228 DM锚点*
*因果推理密度: 8.71/万字 | DM密度: 0.91/千字*
