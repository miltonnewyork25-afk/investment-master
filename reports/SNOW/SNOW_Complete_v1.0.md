...
**关键读数**:
1. **Owner FCF FY30才接近零，FY31首次转正($276M, 2.6% margin)**——投资者4年内看不到"真实"正回报
2. **SBC绝对金额$1,530-1,632M区间几乎不降**——率降(34%→15%)完全被收入增长($4.7B→$10.6B)吸收。到FY31 SBC仍有$1,590M——SBC的绝对金额从不下降
3. **GAAP盈亏平衡~FY31(-0.7%)→FY32首次GAAP盈利**——比DDOG(IPO后5年)慢7年
4. **FCF持续增长但被SBC"吃掉"**: FCF从$689M→$1,866M(2.7x)，SBC从$1,602M→$1,590M(持平)→Owner FCF改善全部来自FCF增长而非SBC下降
...
**校准净效果极小(+$1.6)**——Bear→Base移动的差距不大。**确认: 偏差存在但不改变方向——下行风险仍大于上行**[DM-RT-062-EST]。
...
**SOTP揭示的关键洞察**: 97%价值来自核心数仓($39.9B)，Cortex AI仅贡献6%($2.5B)。**投资者在$154买入→97%赌注在"传统数仓业务"，而非"AI Data Cloud叙事"**。如果AI规模化成功(FY29 AI Revenue $800M+)→AI部分重估: $800M×30x=$24B→SOTP从$42.9B→$64B→$190/股(+24%)。**AI是估值的上行杠杆，不是当前估值的主要支撑**[DM-VAL-039-EST]。
