...
> **报告日期**: 2026-03-24 | **报告版本**: v1.1 | **框架版本**: v19.7 | **分析层级**: Tier 3
...
> **阅读提示**: 以下术语在报告中高频出现。建议先浏览此表再阅读正文。

| 术语 | 全称 | 一句话解释 |
|------|------|---------|
| **GDV** | Gross Dollar Volume | 通过MA网络的总交易金额——衡量网络规模($10.6T FY2025) |
| **VAS** | Value-Added Services | 增值服务(网络安全/数据分析/咨询/忠诚度)——MA从"支付管道"转型为"支付+数据平台"的核心,占收入40.6% |
| **CI** | Client Incentives | 客户回扣——MA向发卡行和大型商户支付的"获客成本",从毛收入中扣除。MA~16%远低于V~28%,是MA的结构性优势 |
| **Interchange** | 交换费 | 每笔刷卡时商户付给发卡行的手续费——MA设定费率但不直接收取,是支付生态的经济分配核心 |
| **A2A** | Account-to-Account | 账户间直接转账(FedNow/UPI/PIX)——绕过卡网络,是MA长期最大的替代威胁 |
| **Take Rate** | 净收费率 | 净收入÷GDV——衡量MA从每元交易中提取多少价值。MA 30.9bps比V 22.9bps高35% |
| **PEG** | Price/Earnings-to-Growth | PE÷增速——增速调整后的估值指标。MA 1.77 vs V 2.27,说明MA增速调整后更便宜 |
| **ROIC** | Return on Invested Capital | 投入资本回报率——衡量"每投入$1资本赚多少"。MA 48.6%远超V 28.4%(但含商誉差异) |
| **OPM** | Operating Profit Margin | 营业利润率——MA正常化57.5%(FY2025报告59.2%含费用重分类),V正常化66.4% |
| **Reverse DCF** | 逆向现金流折现 | 不算"公司值多少钱",反推"市场在$500中赌了什么假设"——本报告的分析起点 |
| **WACC** | Weighted Average Cost of Capital | 加权资本成本——折现率的核心。MA 9.01%(Beta 1.07),V 7.76%(Beta 0.79)。MA更高因为跨境+周期敏感 |
| **CCCA** | Credit Card Competition Act | 信用卡竞争法案——如果通过,将强制信用卡双网络路由,是MA最大的单一监管风险 |
| **KS** | Kill Switch | 论文失效触发器——如果触发,投资论文需要根本性修正。共12个,KS-4(CI转折点)距离最近 |
| **TS** | Tracking Signal | 追踪信号——需要季度监控的关键指标。共7个,TS-1(收入增速)和TS-3(CI差)最关键 |
| **PtW** | Playing to Win | 战略一致性评分——评估管理层战略是否连贯可执行。MA 37/50(接近"卓越"但差3分) |
| **CQI** | Company Quality Index | 公司品质指数——44因子加权评分。MA 91分(全球#8-12,比V约低4分) |
