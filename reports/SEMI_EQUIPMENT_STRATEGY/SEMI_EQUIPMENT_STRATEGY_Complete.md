...
> **SEMI_EQUIPMENT_STRATEGY Complete v2.0**
...
| **版本** | v2.0 — CEO备忘录补强 + 博弈论形式化 + Part V-VI扩展 |
...
| 对比方式 | AMAT P/E | 同行P/E | 差额 | 隐含折价 |
|---------|:---:|:---:|:---:|:---:|
| vs ASML | 37.9x | 51.7x | -13.8x | **-27%** |
| vs KLAC | 37.9x | 49.0x | -11.1x | **-23%** |
| vs LRCX | 37.9x | 50.9x | -13.0x | **-26%** |
| vs 三家平均 | 37.9x | 50.5x | -12.6x | **-25%** |
| **隐含折价市值** | — | — | — | **~$90-100B** |

**市场对你的通才模型打了约$90-100B的折价。** 但关键问题是：这个折价合理吗？

### 质量调整后——你其实不便宜

| 公司 | P/E | A-Score | 质量调整P/E (P/E÷A-Score) | 排名(低=更便宜/单位质量) |
|------|:---:|:---:|:---:|:---:|
| **ASML** | 51.7x | 8.12 | **6.37x** | #1 最便宜/单位质量 |
| **KLAC** | 49.0x | 7.66 | **6.40x** | #2 |
| **AMAT** | 37.9x | 5.42 | **6.99x** | #3 实际比KLAC贵 |
| **LRCX** | 50.9x | 7.02 | **7.25x** | #4 最贵/单位质量 |

**你的37.9x P/E看起来最便宜。但每单位护城河质量支付的价格(6.99x)实际上比KLAC(6.40x)更贵。** 市场不是在"低估"你——市场是在准确反映你的A-Score 5.42。

### 打破通才折价的三条路径

```mermaid
graph TD
    A["通才折价~$90-100B"] --> B["路径1: EPIC成功<br/>TSMC加入→网络效应<br/>= A-Score 5.42→6.5+<br/>折价收窄50%"]
    A --> C["路径2: GAA专家地位<br/>>50%份额确认<br/>= 在一个领域达到专家级<br/>折价收窄30%"]
    A --> D["路径3: 分部报告<br/>AI增长 vs ICAPS分离<br/>= 市场分别定价<br/>折价收窄20%"]
...
| 路径 | 难度 | 时间 | 折价收窄 | 市值影响 |
|------|:---:|:---:|:---:|:---:|
| **EPIC成功(含TSMC)** | 极高 | 2-3年 | 50% | +$45-50B |
| **GAA专家确认** | 高 | 1-2年 | 30% | +$27-30B |
| **分部报告改革** | **低** | **6个月** | 20% | **+$18-20B** |

**分部报告改革是最低成本、最快见效的路径。** 不需要改变任何运营——只需要改变信息呈现方式。当AI增长业务(+20-25%)从ICAPS(~0%)中分离出来，市场将有能力为两者分别定价。

### WFE -20%压力测试——AMAT是最脆弱的

| 指标 | ASML | KLAC | LRCX | **AMAT** |
|------|:---:|:---:|:---:|:---:|
| 收入下降 | -8~12% | -12~15% | -26~30% | **-18~22%** |
| FCF利润率 | 30~32% | 30~32% | 24~27% | **14~17%** |
| 能否维持回购? | 是 | 可能减速 | 是(减量) | **可能需暂停** |
| **EPIC覆盖?** | 不适用 | 不适用 | 不适用 | **FCF接近EPIC年度CapEx($2.3B)** |

**你是四家中唯一在WFE衰退时被迫在EPIC投资和股东回报之间二选一的公司。** 这是"广度战略+大型CapEx项目"组合的结构性脆弱性。

[参阅: AMAT v1.1 Ch9(EPIC Center), Ch16(竞争定位), Ch17(TEL威胁); SEMI_EQUIPMENT Ch11(B2单位经济), Ch14(压力测试)]

---

## 15.7 竞争情报简报——8条产品线的攻守态势

### 逐产品线竞争评估

| 产品线 | 份额 | 趋势 | 最大竞争者 | 你的战略角色 |
|--------|:---:|:---:|---------|---------|
| **PVD** | 85% | ↓ (-2~5pp/年) | NAURA | **堡垒(防御)** — 但成熟端不可挽回 |
| **CMP** | 65% | → 稳定 | Ebara | **堡垒(防御)** — 双寡头均衡 |
| **离子注入** | 60% | → 稳定 | Axcelis | **堡垒(防御)** — VIISta平台锁定 |
| **RTP/外延** | 55% | → 稳定 | — | **现金牛** — 低增长稳定利润 |
| **ECD** | 50% | → 稳定 | LRCX | **竞争区** — 与LRCX共存 |
| **CVD/ALD** | 21% | → 持平 | LRCX, TEL, ASM | **增长战场** — 但竞争激烈 |
| **刻蚀** | 20% | ↑ (Sym3突破) | LRCX(45%), TEL(27%) | **进攻机会** — Sym3 $1.2B |
| **检测** | 8% | ↓ | KLAC(63%) | **应放弃** — 差距不可逾越 |

```mermaid
graph LR
    subgraph "AMAT产品线战略地图"
        direction TB
        D1["防御(堡垒): PVD/CMP/离子<br/>= 33-38%收入, 45-50%利润"]
        D2["竞争(增长): CVD/ALD/刻蚀<br/>= 40%+收入, 但利润率低"]
        D3["放弃(退出): 检测 8%<br/>= 无法追赶KLAC 63%"]
    end
...
| 事件 | 时间窗口 | 对AMAT的影响 | 概率 |
|------|---------|-----------|:---:|
| Sym3 Magnum获第二个Tier-1刻蚀POR | 2026 | 刻蚀份额从20%→22-23% | 50% |
| NAURA PVD在14nm验证 | 2027 | PVD份额加速下降到75-80% | 35% |
| ASM International ALD继续主导GAA | 2026-2028 | AMAT在最关键沉积子市场被压制 | 60% |
| EPIC首个量产POR | 2027-2028 | **游戏改变者** — 通才折价收窄 | 25% |
| TSMC加入EPIC | 2026-2027 | **网络效应启动** — A-Score可能+1 | 30% |

---

## 15.8 Resolution: Dickerson的五步战略手册
