# Launch Brief: CMG
> 自动生成 by tier3_launch.sh v1.0 | 2026-03-04 11:12
...
- **同行业参考**: 
- **同行业平均**: 300K chars
- **★ 目标字符范围**: 400K - 440K chars (用户指定400KB+)
...
## 进化教训 (最近3份报告)
  - 酒店特许经营=消费品中最接近纯软件的商业模型; 收入口径突变(FY2024 loyalty reclassification)必须在Phase 0捕获否则贯穿全报告; 15个Agent并行执行+单会话组装=铁律J继续验证有效
  - Discovery System在$4T级公司首次应用——不确定性范围更宽($0.8T-$7.5T=9.4x), 传统估值框架失效, 条件评级+五情景映射是唯一诚实的输出格式; 体量210K<269K目标暴露PW≥7需≥350K的密度门控需求
  - null  # AI填入

## Phase -1 知识检索
- knowledge_context.md: 1657 chars
- 状态: ✓ 完成
