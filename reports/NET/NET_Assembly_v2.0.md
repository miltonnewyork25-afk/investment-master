...
**推断方法**: (a)335+ PoP全球分布 (b)员工地理分布(San Francisco总部+London/Singapore/Austin办公室) (c)客户案例地理分布 (d)管理层国际化评论

| 地区 | 收入占比(估) | PoP密度 | 增速(估) | 关键市场 | 锚点 |
|------|:---------:|:------:|:------:|---------|------|
| 北美 | ~55% | ~100个 | ~25% | 美国(硅谷/纽约), 加拿大 | [DM-GEO-001] |
| 欧洲(EMEA) | ~25% | ~80个 | ~30% | UK, 德国, 法国, 北欧 | [DM-GEO-002] |
| 亚太(APAC) | ~15% | ~100个 | ~40% | 日本, 新加坡, 澳大利亚, 印度 | [DM-GEO-003] |
| 其他(LatAm/MEA) | ~5% | ~55个 | ~35% | 巴西, 南非, UAE | [DM-GEO-004] |

**推断置信度**: 低(未经公司确认)。但55/25/15/5的比例与同行(ZS: 49%美洲/31%EMEA/20%APAC)大致一致, 考虑到NET的免费层在全球均匀分布。[DM-GEO-005]
...
**第一梯队(核心, ~80%收入)**: 北美+西欧。渗透率最高, 增速趋于稳健。企业客户(F500/G500)集中在这两个区域→$1M+客户增长的主要来源。[DM-BIZ-001][DM-BIZ-002]

**第二梯队(增长, ~15%收入)**: 日本+东南亚+澳大利亚。增速最快(估+35-45%), 受益于(a)数据主权需求推动本地PoP部署 (b)企业数字化加速 (c)NET在亚太的安全产品被接受度提升。但ARPU低于北美(企业付费能力差距)→收入贡献增速<客户数增速。[DM-GEO-003]

**第三梯队(机会, ~5%收入)**: 印度+拉美+中东/非洲。高增长潜力但需要长期投入——本地化(语言/支付/合规)+渠道建设+竞争(本地CDN如Alibaba Cloud/Tencent Cloud在亚太)。[DM-GEO-004]
