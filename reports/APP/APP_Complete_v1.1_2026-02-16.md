...
> **核心任务**: 从APP当前估值($132B市值, P/E 68.5x TTM, EV/Sales 24.3x)反推市场隐含了哪些关键假设, 逐一评估每面"承重墙"的脆弱性
...
DM-VAL-007: 当前$132B市值隐含FY2025→2028E收入CAGR约33%(从$5.48B到$12.9B), 且要求FY2028E后增长不低于15-20%以维持当前倍数 [计算: (12.9/5.48)^(1/3)-1=33%; 远期PE 32.9x需持续增长支撑]
...
5. **PDRM风险未被充分定价**: 当前P/E 68.5x和EV/Sales 24.3x意味着市场隐含了近乎完美的执行假设。PDRM的$795M(中位数)概率加权风险如果被市场定价, 按30x P/E折算将减少$24B市值(-10.5%)。如果按"最可能的坏组合"(A1+G2+R1, 年化-$1,370~2,500M)定价, 市值将减少$41-75B(-18~33%)。
...
| 锚点 | 数据 | 来源 |
|------|------|------|
| DM-VAL-007 | $132B市值下Fwd P/E 19.0x看似合理, 但依赖FY2027E共识不下修, TAM天花板$13.2B约束增速 | 计算 |
