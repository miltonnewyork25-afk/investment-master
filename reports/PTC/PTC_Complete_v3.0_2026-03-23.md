...
> 分析日期: 2026-03-23 | 框架版本: v19.6 | 21章 | 122K字符 | 234 DM锚点
...
### 三句话结论
1. PTC的护城河价值占EV的54-80%——40-45%的ARR受制度嵌入保护(A&D+医疗器械)，即使零增长也支撑$10.4B EV
2. 但PE折价28%(vs ADSK)是会计幻觉——EV/FCF(22.3x)和PEG(2.3x)与ADSK完全相同，"便宜"的感觉来自利润率结构差异而非真实折价
3. 有机增速剔除SaaS迁移提价后仅3.9%——迁移跑道剩余3-4年，之后ARR增速将从8.5%缓降至6%

### 估值结果

| 方法 | 公允价值 | vs $149.81 |
|------|---------|-----------|
| DCF概率加权(WACC 9.5%) | $118.2 | -21.1% |
| SOTP(15%集团折价) | $127.0 | -15.2% |
| 可比法(EV/FCF锚) | $148.5 | -0.9% |
| EPS路径(FY2028 PE 20x) | $153.2 | +2.3% |
| **加权公允(红队前)** | **$131.5** | **-12.2%** |
| **红队调整后** | **~$142** | **-5.2%** |
...
| 发现 | 影响 |
|------|------|
| 护城河"双层蛋糕": 底层(制度嵌入55-60%)几乎不可替代，表层(商业嵌入40-45%)可替代但成本高 | 下行有底，非崩溃型 |
| 回购效率η=0.51: 在$150回购是低效的(FCF yield 4.8% < WACC 9.5%)，但"最不坏的选择" | EPS增长71%来自回购，质量偏低 |
| WACC是决定性变量: 9.5%(工业股)→审慎 / 8.5%(SaaS)→中性。下行beta 2.0x支持9.5% | 评级取决于身份认定 |
| SaaS迁移S曲线: 已完成65%，剩余3-4年跑道，之后ARR增速降至6% | 不是"悬崖"是"斜坡" |
| 温水煮青蛙15%概率: 最现实负面场景=每季度微miss，5年累计-30% | 不触发任何单一KS信号 |
...
| 质量 | 65° | A-Score 6.5, FCF/NI 117%, ROIC>WACC |
| 增长 | 40° | 有机3.9%偏低，回购补到EPS CAGR 8% |
| 风险 | 45° | 护城河强但Siemens慢性蚕食+ServiceMax |
| 催化 | 35° | FY2026 EPS下降，短期缺正面催化 |

### 追踪清单

**卖出信号**: ARR<7%连续2Q | ServiceMax ARR同比降 | OPM<28% | PLM排名降至#3
**买入信号**: ARR>10%连续2Q | Onshape ARR>$150M | Fed累计降息≥150bp
