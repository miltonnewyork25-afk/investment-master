...
> ## 下架通知 (2026-04-24)
>
> **本版本 v4.0 因数据底座错误已下架**. 请阅读 **[MSCI_v4.1_Complete.md](./MSCI_v4.1_Complete.md)** 作为最新基线.
>
> **v4.0 主要错误** (v4.1 已全部修正):
> - Adjusted EBITDA margin **65.2% 错误** (官方 Q1 2026 实际 **59.3%**). 65.2% 对应的是 non-recurring revenue growth, 不是 margin
> - Earnings date 写 **2026-04-17 错误** (实际 **2026-04-21**)
> - Share count 用 **78-80M 错误** (实际 diluted **73.4M**, 估值桥每股影响需全部重算)
> - Rule of X **74.4 错误** (主口径应为 **72.6**, 用 organic Rev +13.3% + margin 59.3%)
> - Buyback V12 $139M 与 Q1 实际 $414.8M 冲突
> - S&C 增速 +10.2% 错误 (实际 total +8.6% / organic +3.7%)
> - Analytics Q1 基线 +5.3% 错误 (实际 Q1 +10.3%; +5.3% 是 Q2 指引)
> - Consensus 目标价 $652.7 过时 (应为 $683-693 区间, 11-17 家覆盖)
> - "利润层新稳态 63-64% 已兑现" **表述过强** (Q1 incremental 75% 是强信号, 但绝对 margin 59.3% 未突破街共识, 需 Q2-Q3 证明)
> - "资本配置 pivot 已发生" **表述过强** (Q1 回购仍是并购 10 倍, 应为"再平衡信号")
>
> **本文件作为研究教训档案保留**, 仅用于审计轨迹, 不作为投资判断依据. 所有结论 (公允价值 $590-605, 期望回报 0%, 买点 $540-570) 已在 v4.1 重算.
>
> **v4.1 修正后结论**: 评级维持中性关注; 公允 Base **$575-605** / Bear **$540-570** / Bull **$620-650** 三情景; Base 中位约 $590; 股价 $598 无安全边际.

---

# MSCI v4.0 追踪报告 — 三层复利机: Q1 2026 后的重估与分层 (已下架)

> **覆盖版本**: v4.0 (Q1 2026 earnings 后) — **已下架, 参见 v4.1**
> **基线版本**: v3.0 (2026-03-18, 股价 $560.41)
> **当前股价**: $598.01 (2026-04-23 收盘)
> **Q1 2026 earnings 发布**: ~~2026-04-17~~ **(错误, 实际 2026-04-21)**
> **评级**: 中性关注 (维持)
> **公允价值**: ~~$590-605 (中位 $598)~~ **(数据底座错误, 见 v4.1 Bear/Base/Bull)**
> **期望回报 (12 月)**: ~~0%~~ **(见 v4.1 修正后区间)**
