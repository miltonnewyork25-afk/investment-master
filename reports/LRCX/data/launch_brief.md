# Launch Brief: LRCX
> 自动生成 by tier3_launch.sh v1.0 | 2026-02-19 17:02
> **AI必须在Phase 0开始前完整阅读本文件**

## 复杂度评估
- **行业**: 半导体
- **同行业报告数**: 7 份
- **同行业参考**: AMAT(304K) AMD(341K) ASML(422K) INTC(209K) KLAC(254K) MU(178K) TSM(451K) 
- **同行业平均**: 308K chars
- **★ 目标字符范围**: 247K - 386K chars
...
## Phase -1 知识检索
- knowledge_context.md: 1673 chars
- 状态: ✓ 完成
...
4. [x] checkpoint.yaml 已自动创建 (target_chars: 308840)
