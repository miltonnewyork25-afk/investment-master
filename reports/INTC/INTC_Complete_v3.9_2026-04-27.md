...
注意 peer multiple 比 today PV 略高, 因为它没有反映 Intel 当前正在亏钱 (operating loss 比 peers 高). 所以我们采用 today PV $23-28 (v3.9 重锚后) 作为更准确的估值锚.
...
具体 SELL 判断: 当前 $82.57 vs 公允 $25.5 (v3.9 主锚) = -69% downside. Reset window 6-12 个月, 触发概率 40-50%. 期望回报 (SELL position 5 年): +40-55% (vs v3.7 估算 +50-65%, 弱化 -10pp 反映 agentic CPU partial offset).
...
**Q2 actual in-line guidance (Non-GAAP EPS $0.18-0.22)**: 维持 base case, 公允 $25.5 (v3.9 主锚) 不变. 行动建议不变.
...
1. **当前股价 $82.57 vs 公允区间** (v3.9 重锚). 今日 PV $23-28 (主锚 $25.5), 5y exit $30-40 (加权 $33.49). 今日 PV downside -69%, 5y exit downside -55%. 区分两个数字, 不要混淆.
...
A: -69% downside 是 directional 判断, 不是 actionable SELL recommendation. 4 个原因不写 high-conviction SELL: (i) Q1 2026 + agentic CPU narrative partial reverse 让 conviction 弱化 (从早期 80%/20% 降至 v3.9 的 55%/45%); (ii) 政府 puts 提供下行保护 (即使 strike $10-15 而非 $25-30, 仍存在); (iii) Lift size 难把握 (历史半导体周期股 SELL 通常 -30% 后 dead cat bounce +20-30%); (iv) 4 投资风格视角 (质量投资 / Special situations / Deep value / Long-short) 中只有 1/4 (Long-short) 主动 SELL with caveat, 其余 3/4 是 avoid 或 WATCH. 这种"4/4 不 BUY 但只有 1/4 SELL" 的分歧反映高争议, 不应该简化为 SELL.
