# INTC v3.1 — AI 回归叙事背后, 当前价格已经提前买了多少成功

**当前股价 (timestamp 2026-04-24 close)**: **$82.57** (盘中高 $85.22) / **今日 PV 区间**: **$18-25** / **5y exit value 区间**: **$26-35** / **评级**: 审慎关注 (高争议) / **5y 期望回报**: **-58 to -68%**

> **v3.1 重大修正声明 (2026-04-27)**: v3.0 (2026-04-26) 存在多处与公开资料不一致的数据错误, 已被独立审计指出. v3.1 在 v3.0 基础上做 7 项 P0 数据修复 + 5 项 P1 逻辑修正. 修正后 bearish 主线方向不变 (公允仍显著 < 当前股价), 但**结论强度从"高确定性 SELL"降级为"高争议 watch"**. 详见 §0.0 修正清单.

> **黑箱披露 (R-4 硬约束前置, v3.1 上调)**: 关键变量中影响估值的不可独立验证维度占比 ≥40% (v3.0 35-45% → v3.1 40-50%). Q1'26 实际数据显示 DCAI +22% / NVIDIA DGX Rubin NVL8 选 Xeon 6 / Foundry external 仍仅 $174M, 不确定性增加. 因此**不提供单点目标价**, 改为区间表达 + 显式区分"今日 PV"与"5y exit value". 评级"(高争议)"反映 Q1'26 实际数据部分削弱 bear thesis (DCAI 增速反弹), 但 Foundry external 商业化进度仍弱.

## 0.0 v3.1 修正清单 (vs v3.0, 必读)

> **审计来源**: 用户独立 fact-check (2026-04-27) + 引用 Intel 官方 release / 10-K / earnings transcript / Business Insider 公开资料.

### P0 数据修复 (7 项, 必须修正)

| # | v3.0 错误 | v3.1 修正 (用官方来源) |
|---|----------|----------|
| 1 | 当前股价 $95 | **$82.57 (2026-04-24 close)** / 盘中高 $85.22 [DM-PRICE-FIX-001, Business Insider 2026-04 + INTC 4-24 close] |
| 2 | CHIPS Act $19.5B 直接拨款 | **$7.86B direct funding + $3B Secure Enclave 合同 + 25% investment tax credit + 10% 政府持股** [DM-CHIPS-FIX-001, Intel newsroom 2024-Q4 finalize] |
| 3 | FY2025 revenue $53.5B / EPS $0.85 / GM 35.9% | **revenue $52.9B / GAAP EPS -$0.06 / Non-GAAP EPS $0.42 / GAAP GM 34.8% / Non-GAAP GM 36.7%** [DM-FY25-FIX-001, Intel FY2025 10-K + Q4'25 release] |
| 4 | 5 reportable segments (CCG/DCAI/NEX/MBLY/Foundry) | **NEX 已整合进 CCG + DCAI; 当前 reportable: CCG / DCAI / Foundry; "All Other" 含 Altera + Mobileye** [DM-SEG-FIX-001, INTC FY2025 10-K] |
| 5 | FCF / 净债务两处不一致 | **统一: FY2022 FCF -$9.4B; Q1'26 净债务 -$41.5B (LT debt $53B - 现金 $11.5B); 删除"+$5B 净现金"措辞 (那是 unrestricted cash)** [DM-RECON-FIX-001] |
| 6 | Tan "公开拒绝 spinoff" | **降级为 [C 推断]: Q1'26 transcript 中 Tan 强调 internal foundry 执行, 但无逐字"reject spinoff"声明; 改为"管理层未释放 spinoff 信号"** [DM-TAN-FIX-001, INTC Q1'26 earnings transcript Motley Fool 2026-04-23] |
| 7 | Q1'26 实际数据未纳入 (Q1 release 2026-04-23) | **Q1'26 actual: revenue $13.6B (+7%) / Non-GAAP EPS $0.29 / DCAI $5.1B (+22%) / Foundry $5.4B (+16%, 但 external 仅 $174M) / Xeon 6 选为 NVIDIA DGX Rubin NVL8 host CPU / Google Cloud Xeon 6 多年合作 / TeraFab 项目宣布** [DM-Q126-FIX-001, INTC Q1'26 release 2026-04-23] — 削弱 bear thesis (NVIDIA Vera 100% Grace + server CPU 失血加速) 但确认 Foundry external 仍弱 |

### P1 逻辑修正 (5 项)

| # | v3.0 问题 | v3.1 修正 |
|---|----------|----------|
| 8 | $26.25 "5y 退出价" 与 "今日公允价值" 混淆 | 显式区分: **今日 PV 区间 $18-25** (8% WACC, 5y 折现) / **5y exit value 区间 $26-35** (Q1'26 数据后情景上修) |
| 9 | 概率 37.5% / 52.5% / 10% 假精确 | 改区间: **Bear 30-45% / Base 40-55% / Bull 8-20%** (Bull 上限因 Q1'26 NVIDIA Rubin + DCAI +22% 上修) |
| 10 | "叙事溢价 $40-50" 反推循环论证 | 改为 market-implied conditions: $82.57 隐含 5y 假设 (server share 60%+, Foundry external $20B+, ROIC 8%+ recovery), 列出哪些可信 / 哪些不可信 |
| 11 | Foundry 5y -$120B 现金消耗口径模糊 | 拆三表: (a) accounting loss (b) cash loss (扣 prepayment + 补贴) (c) Foundry-specific CapEx (vs 集团 CapEx). Q1'26 实际 operating loss -$2.4B / external $174M anchor 重锚 |
| 12 | 圆桌 6 视角 vs R-3 "5 视角"不一致 | 改 5 视角 (Buffett / Munger / HM / Klarman / Druckenmiller); Greenblatt 移到附录"special situations 补充视角" |

### v3.1 估值核心 (修正后)

```
当前股价: $82.57 (2026-04-24 close, 盘中高 $85.22)

5y exit value 三情景 (Q1'26 数据后重锚):
  Bear  (30-45%, 中点 37.5%): $8-15 (vs v3.0 $5, 上修因 DCAI 反弹)
  Base  (40-55%, 中点 47.5%): $28-35 (vs v3.0 $33, Foundry external 进度重锚)
  Bull  (8-20%,  中点 15%):   $55-75 (vs v3.0 $70.5, NVIDIA Rubin 信号上修)

5y exit value 概率加权:
  37.5% × $11.5 + 47.5% × $31.5 + 15% × $65 = $29.02 (vs v3.0 $26.25, 略上修)

今日 PV (8% WACC, 5y, 折现因子 0.681):
  $29.02 × 0.681 = $19.76 (区间 $18-25)

vs 当前 $82.57:
  5y exit: -65% (vs v3.0 -72%)
  Today PV: -76% (vs v3.0 -81%)

评级: 审慎关注 (高争议) — 从 v3.0 的"(临界)" 降级
理由: 5 视角中 4 位 SELL (Buffett/Munger/HM/Druckenmiller), Klarman HOLD; Q1'26 数据 partial reverse bear conviction
```

### v3.1 关键限制声明

1. **我们这个判断不是高确定性 SELL recommendation**. 适合 watch / avoid / wait for reset, 不适合作为 short call 的唯一依据
2. **黑箱 ≥40%** — Foundry 5y NPV / 政府 puts strike / Tan 战略意图 三个核心变量都缺 [B] 级数据
3. **Q1'26 数据 release 仅 4 天** (4-23 release vs v3.1 4-27 撰写), 完整 trajectory 影响需要 2-3 个季度才能 confirm
4. **正确读法**: "在若干可验证条件下的 bear/base valuation range", 不是"绝对 fair value $26-28"
...
### 0.1 旧地图: 市场把 INTC 当什么 (v3.1 修正股价)

INTC 当前 **$82.57 (2026-04-24 close)** 隐含市值约 **$357B** (基于 ~4.32B 摊薄股本) [DM-PRICE-FIX-001, Business Insider 2026-04 + INTC close]. 三个市场叙事支撑这个估值:

(a) **AI 时代回归者** — 18A 工艺 2025 量产, 客户名单陆续公布 (Microsoft Cobalt 2 / Apple A20 NDA 传闻 / DoD subsidies / **2026-04-23 新闻: Xeon 6 被选为 NVIDIA DGX Rubin NVL8 host CPU + Google Cloud Xeon 6 多年合作**), 市场默认 INTC 在 2027-2028 年完成对 TSMC N2 的工艺追赶, 重新拿回 server CPU 失地;

(b) **美国半导体国家冠军 + 政府 puts** — CHIPS Act 含 **$7.86B direct funding + $3B Secure Enclave 合同 + 25% investment tax credit + 10% 政府持股** (持股估值 ~$36B [DM-CHIPS-FIX-001]), 形成"too big to fail" 的隐性 backstop;

(c) **Tan Lip-Bu 战略奇袭期权** — 新 CEO 在 2025 年 3 月上任, 市场期待他在第二年 (2026 H2) 启动 Foundry spinoff / 资产剥离 / IP 货币化等"unlock value" 动作.

把这三层加起来, 市场愿意给 INTC 当前估值倍数. **基于 v3.1 修正后的财务数据** (FY2025 GAAP EPS -$0.06 / Non-GAAP EPS $0.42 / Revenue $52.9B): trailing P/Sales 6.7x, forward Non-GAAP PE = $82.57 / $0.42 = **197x** (这是当前估值的真实倍数, 远高于 v3.0 错算的 50-60x).

**如果这三个叙事都成立, $82.57 仍然偏高**. 我们的工作不是反对叙事, 是检验叙事每一层在 Q1'26 实际数据 (4-23 release) 下还成立吗.

### 0.2 母裂缝: 两件旧地图解释不通的事实 (v3.1 修正, 从 3 → 2)

> **v3.1 修正**: v3.0 列出 3 件失灵事实, 其中"事实 2 (Tan 公开拒绝 spinoff)" 因 Q1'26 earnings transcript 无逐字 reject 声明, 降级删除. 仅保留 2 件 [B] 级硬信号事实.

**事实 1 — Foundry 5 年累计现金消耗 -$96 to -$140B (中点 -$120B)**: 这不是 OpEx 一项, 是 OpEx + CapEx 综合. **Q1'26 actual** [DM-Q126-FIX-001, INTC Q1'26 release 2026-04-23]: Intel Foundry segment revenue $5.4B (+16% YoY) **但 external customer revenue 仅 $174M**, operating loss -$2.4B. 按当前 trajectory 5y 累计净现金消耗 $96-140B. 若"AI 时代回归者"叙事成立, 至少需要在 5 年内看到 ROIC 转正; 当前 ROIC 2-4% (NOPAT $5-8B / Invested Capital $180-200B) vs WACC 8% [DM-FIN-003 — CAPM: 4.3% rf + 1.3β × 4.5% ERP = 10.15% equity, 80/20 weighted ≈ 8%], 价差 -4 to -6pp. **这是结构性资本错配**.

**事实 2 — 当前股价 $82.57 中, market-implied conditions 显著乐观**: v3.1 修正用 market-implied conditions 框架 (代替 v3.0 的"叙事溢价反推"). 在当前 $82.57 / forward Non-GAAP PE 197x 下, 市场隐含的 5 年假设包括:
- (a) Server CPU share 维持 60%+ at 2030 (我们的中性 estimate: 50-55%)
- (b) Foundry external rev 5y 累计 $20B+ (Q1'26 实际 quarterly external $174M, 年化 <$1B; 5y 按当前 trajectory 仅 $5-15B)
- (c) ROIC 5y 内追上 WACC 8% (当前 2-4%, 需要 +400-600bp 改善)
- (d) 政府 puts strike $25-30 (我们校准: $10-15, GM 2009 case 历史可比)

如果 (a)(b)(c)(d) 任一显著低于市场假设, 估值需要 reset.

**为什么删除 v3.0 "事实 2 (Tan 拒绝 spinoff)"**: Q1'26 earnings transcript (Motley Fool 2026-04-23) 中 Tan 强调 14A 进度 / TeraFab / 客户披露 / advanced process 执行, 但**无逐字 "reject spinoff" 声明** [DM-TAN-FIX-001]. v3.0 把 "强调 internal foundry 执行" 误读为"公开拒绝 spinoff". 正确表述: 管理层未释放 spinoff 信号 (但也未公开 reject), spinoff 概率维持 10-15% 历史基准率.
...
**含义 1 (估值方法切换)**: 不应该用 "AI 平台 PE 40-60x" 给 INTC 定价, 应该用 "周期股 PE 12-18x × 周期低点 EPS + 政府 puts 期权价值 + Foundry NPV" 的 SOTP 框架. 当前 $82.57 = $357B 市值 隐含的 6.7x trailing P/Sales (修正后) 在半导体周期股范畴中仍是历史顶部水平 (vs INTC 自己 2017-2019 周期顶部 4-5x P/Sales / 2010-2014 周期顶部 2-3x P/Sales [DM-VAL-001]).

**含义 2 (关键变量切换)**: 第一变量从 "AI server CPU share" 切换为 "reset catalyst clock". 真正决定股价 6-12 个月走向的不是 INTC 拿回多少 server share, 而是哪些 catalyst 触发市场重新定价. 我们识别了 5 个 catalyst (4-29 AMD Q1 / 5-1 AWS re:Invent ARM / 2026 Q2 INTC 18A timeline / 2026 H2 Foundry external commit / 2026 Q3-Q4 NVIDIA Vera reference design). **v3.1 修正**: Q1'26 actual 已削弱"NVIDIA Vera 100% Grace ARM" 假设 (DGX Rubin NVL8 选 Xeon 6), 因此 catalyst 5 fire 概率从 70-80% 下修至 50-60%. 联合 fire 概率从 v3.0 的 50-60% 下修至 **40-50%**.

**含义 3 (赔率切换, v3.1 重算)**: 不再问 "INTC 能不能成功转型", 而是问 "在 reset 完成前, 持有 INTC 的赔率是多少". 我们的概率加权计算 (v3.1 修正后):

```
5y exit value 三情景 (中点):
  Bear  37.5% × $11.5  =  $4.31
  Base  47.5% × $31.5  = $14.96
  Bull  15.0% × $65    =  $9.75
  ─────────────────────────────
  加权 5y exit:        = $29.02 (区间 $26-35)

今日 PV (8% WACC, 5y, 折现因子 0.681):
  $29.02 × 0.681 = $19.76 (区间 $18-25)

vs 当前 $82.57:
  5y exit: ($29.02 - $82.57) / $82.57 = -65% (vs v3.0 -72%)
  Today PV: ($19.76 - $82.57) / $82.57 = -76% (vs v3.0 -81%)
```

**核心变化**: bear case 上修 $5 → $11.5 (反映 Q1'26 DCAI +22% 反弹), base case 上修 $33 → $31.5 (Foundry external 进度 anchor 重做), Bull case 下修 $70.5 → $65 (Vera ARM 不确定性). 加权略上修 $26.25 → $29.02. **方向仍 SELL, 但 conviction 从 -72% 弱化为 -65%**.

### 0.4 评级与边界 (v3.1 修正)

**评级**: 审慎关注 (高争议) — 从 v3.0 "(临界)" 降级.

"(高争议)" 标注理由 (v3.1 修正):
- 5 视角圆桌中 4 位 SELL (Buffett / Munger / Howard Marks / Druckenmiller), Klarman HOLD = 4/5 = 80% 仍满足 R-3 字面阈值 ≥3/5
- 但 Q1'26 实际数据 (DCAI +22% / NVIDIA Rubin 选 Xeon 6 / Google Cloud 合作) **partial weakened** bear conviction
- Greenblatt WATCH 移到附录 (v3.1 修正圆桌 6 → 5 视角对齐 R-3)

**今日 PV 区间**: **$18-25/share** (8% WACC, 5y 折现; 不提供单点目标价)
**5y exit value 区间**: **$26-35/share** (反映三情景概率加权范围)

> **关键澄清 (vs v3.0)**: v3.0 把 $26-28 既写成"今日公允"又写成"5y 退出价", 造成混淆. v3.1 显式区分: $26-35 是 5y exit value (对应 5 年后股价应该在哪), $18-25 是今日 PV (折现回当前的合理买入价).

**Kill Switch / 重启信号**:

- **下修触发** (任一发生 → 公允下修 / 评级强化): 5-1 AWS re:Invent ARM 路线图加速 (Graviton 5 announce) / 2026 H2 Foundry external commit <$5B / 2026 Q3-Q4 NVIDIA Vera 100% Grace ARM 确认
- **上修触发** (任一发生 → 公允上修 / 评级 pivot): 18A yield 在 N2 之前 6-12 个月追平 / Tan 公开转向 spinoff 表态 / Foundry 5 年内 external rev trajectory 反转 (季度 external >$500M) / Apple A20 NDA 公开化 / DCAI 连续 3 季度 +20%+ YoY

**全部 8 条 KS 见 Ch 13. 5 个 catalyst 6 个月内联合 fire 概率 40-50% (v3.1 下修, 因 Q1'26 已部分 weaken bear catalyst clock)**.

### 0.4.5 估值锚点全图 (v3.1 重构)

```mermaid
flowchart TD
    P[当前股价 $82.57<br/>2026-04-24 close]
    P --> Implied[市场隐含 5y 假设]
    Implied --> A1[Server share 60%+]
    Implied --> A2[Foundry external 5y $20B+]
    Implied --> A3[ROIC 5y 追上 WACC]
    Implied --> A4[政府 puts strike $25-30]

    A1 --> Bear[Bear 37.5% × $11.5 = $4.31]
    A2 --> Base[Base 47.5% × $31.5 = $14.96]
    A3 --> Bull[Bull 15% × $65 = $9.75]
    A4 --> Bull

    Bear --> W[加权 5y exit $29.02<br/>区间 $26-35]
    Base --> W
    W --> PV[现值 8% WACC = $17.88]
    Bull --> W
    W --> PV[今日 PV $19.76<br/>区间 $18-25<br/>8% WACC, 5y]
    PV --> Ret[5y 期望回报 -65%<br/>Today PV downside -76%]
    Ret --> Rating[评级: 审慎关注 高争议<br/>4/5 SELL + 1 HOLD]
```

### 0.5 90 秒 reader 应该带走什么 (v3.1 修正)

```
1. INTC 不是 "AI 时代回归者", 而是 "重资本投入 + 政府背书 + AI 叙事重定价" 的混合系统
2. INTC 当前 $82.57, 我们今日 PV 估值 $18-25 / 5y exit value $26-35
3. 5y 期望回报 -65%, today PV downside -76% (低于 v3.0 -72% 是 conviction 弱化)
4. 评级"审慎关注 (高争议)"反映 4/5 SELL + 1 HOLD; Q1'26 数据 (DCAI +22%, Rubin 选 Xeon 6) 部分 weaken bear
5. 行动建议: watch / avoid / wait for reset, 不适合作为 high-conviction SELL 的唯一依据
6. 关键 catalyst window 6-12 个月: 5-1 AWS / 18A timeline / Foundry external trajectory / NVIDIA Vera 决策
```
...
> **v3.1 阅读说明**: 本章 §1.1-1.4 + §2 + §6-9 的论证基于 v3.0 baseline price $95. v3.1 修正 baseline 为 $82.57 (2026-04-24 close). 所有"$95"应解读为"v3.0 baseline price"; 真实 conviction 应使用 v3.1 修正后的 $82.57. 估值结论的修正版本见 §0.0 修正清单 + §17.0 (Q1'26 数据纳入).

### 1.1 市场在押注什么

INTC v3.0 baseline $95 (v3.1 修正为 $82.57) 隐含市值约 $410B (v3.0) / $357B (v3.1). 根据 Reverse DCF + 多倍数 triangulation, 当前股价隐含的核心假设包括 [DM-IMPL-001]:
...
- **反例条件**: INTC 当前现金 + ST investments $11.5B / LT debt $53B / 净债务 -$41.5B [DM-RECON-FIX-001, Q1'26 10-Q]. 比 AMD 2009 spinoff 时的 $7B+ 净债务危机要严重 (规模 6x), 但 (i) 政府 puts 提供 backstop / (ii) Q1'26 现金还能支撑 2-3 年 OpEx. 因此"被迫求生"压力存在但不立即. spinoff 概率因这个修正应轻微上修至 10-15% [B] (vs v3.0 的 5-8%, 因为 v3.0 错认为 INTC 有净现金 buffer).
...
但即使保留"AMD-GF case 可类比" 的乐观假设, 触发条件是 AMD 当时 7B+ 净债务危机. **v3.1 修正**: INTC 当前实际是净债务 -$41.5B (vs v3.0 误称"+$5B 净现金"), 比 AMD 当时压力更大. 因此 spinoff 概率因财务压力反向上修 (v3.0 的"INTC 没有压力" 论点不成立).
...
### 3.1 业务结构: 3 reportable segments + All Other (v3.1 修正)

> **v3.1 修正**: v3.0 错误列出 5 reportable segments. INTC FY2025 10-K 实际 reportable structure 为 3 segments (CCG / DCAI / Foundry), NEX 已整合进 CCG + DCAI. Mobileye + Altera 等业务归入 "All Other".

INTC FY2025 reportable structure [DM-SEG-FIX-001, INTC FY2025 10-K]:

| Reportable Segment | FY2025 Revenue | FY2025 OPM | 核心驱动 |
|-------------------|--------------|----------|---------|
| Client Computing Group (CCG) — 含原 NEX edge 部分 | ~$32-34B | 10-13% | PC 出货 + edge + ASP |
| Data Center & AI (DCAI) — 含原 NEX networking 部分 | ~$15-17B | -2 to +5% | server CPU share + ASP |
| Intel Foundry (内部 + external) | $17.5B (含内部转移) | -23 to -27% | utilization + external customer |
| **All Other** (Mobileye 74% 持股 + Altera 残余 + 其他) | ~$2-3B | varies | — |
| **合计 (含 elimination)** | **$52.9B** | **-3 to 0% blended** | — |

[DM-FY25-FIX-001, Intel FY2025 10-K]

**Q1'26 segment actual** [DM-Q126-FIX-001, INTC Q1'26 release 2026-04-23]:
- Total revenue: $13.6B (+7% YoY)
- DCAI: $5.1B (+22% YoY) — **bear thesis 中"server CPU 失血加速" partial weakened**
- CCG: ~$7B (含 PC 周期性反弹)
- Intel Foundry: $5.4B (+16% YoY, 但 external 仅 $174M — Foundry 商业化进度仍弱)
- Non-GAAP EPS: $0.29 (vs Q1'25 $0.13, +123% YoY)

> **核心新数据**: Q1'26 DCAI +22% 是 5 年来最强季度增长. 但需要 2-3 个季度确认是周期性反弹还是 trajectory 转折. v3.1 将 Bear case 概率上限从 v3.0 42% 下修至 35%, Bull 概率上限从 v3.0 12.5% 上修至 20%.
...
─────────────────────────────────────────────
FY2025 Revenue: **$52.9B** (v3.1 修正 vs v3.0 错误的 $53.5B; -32% from FY2020 peak $77.9B) [DM-FY25-FIX-001, Intel FY2025 10-K]
```

**核心观察**: 5 年收入下滑 -$25B, 其中 -$19B 来自 DCAI (server CPU 失血) + -$8B 来自业务剥离, 抵消了 Foundry +$3B + Mobileye +$0.8B 的新增. **server CPU 失血是过去 5 年的核心叙事**, 但 Q1'26 DCAI +22% 显示 trajectory 可能开始转折 (待 2-3 季度确认).

### 3.3 毛利率 Bridge (R-1 必备模块, v3.1 修正)

> **v3.1 修正**: v3.0 错用 GM 35.9%. INTC FY2025 实际 GAAP GM 34.8% / Non-GAAP GM 36.7% [DM-FY25-FIX-001].

FY2020 → FY2025 GAAP GM% 演化:
...
+ Mobileye 高 GM 贡献:                +0.5pp
+ Other:                              -0.4pp (round)
─────────────────────────────────────────────
FY2025 GAAP GM%: 34.8% (Non-GAAP GM 36.7%)
```

**核心观察**: 5 年 GM 下滑 -21.3pp (GAAP), 主要 driver 都是结构性: (i) 工艺落后 -7pp + (ii) Foundry 拖累 -2pp + (iii) AMD 竞争 -6pp + (iv) D&A 上升 -3pp. 即使 18A 量产 GM 反弹, 上限 45-50% (vs 历史 60%+) [B 推断].

### 3.4 EPS 瀑布 (R-1 必备模块, v3.1 修正)

> **v3.1 修正**: v3.0 错用 EPS $0.85. INTC FY2025 实际 GAAP EPS **-$0.06** / Non-GAAP EPS **$0.42** [DM-FY25-FIX-001].

FY2020 EPS $4.94 → FY2025 GAAP EPS -$0.06 / Non-GAAP EPS $0.42:
...
─────────────────────────────────────────────
FY2025 GAAP EPS: -$0.06 (-101% from peak; Non-GAAP EPS $0.42, -91% from peak)
```

**核心观察**: 5 年 GAAP EPS 下滑 $5+, 已转负 (vs v3.0 错算为 $0.85). 即使按 Non-GAAP $0.42, 仍是 -91% 跌幅. **这意味着 forward PE 用 GAAP 不可计算 (分母 ≤0), 用 Non-GAAP $0.42 → forward PE = $82.57 / $0.42 = 197x** — 这是当前估值的真实倍数, 比 v3.0 计算的"50-60x" 高出 3-4 倍.
...
### 3.5 自由现金流: 5 年累计 -$15B (v3.1 修正一致性)

> **v3.1 修正**: v3.0 第 3.5 节 (本节) 与第 4.2 节 FCF 数字不一致 (FY2022 -$3B vs -$9.4B). 现统一采用 §4.2 详表口径 (含全部 lease + restructuring), 与 Intel cash flow statement 一致.

```
FY2020 FCF: +$21.1B
FY2021 FCF: +$11.3B
FY2022 FCF: -$9.4B   (CapEx ramp 启动)
FY2023 FCF: -$14.2B  (Foundry full burn)
FY2024 FCF: -$15.8B  (Foundry + 工艺过渡)
FY2025 FCF: -$7.7B   (CapEx 微减)
─────────────────────────────────────────────
6y Cumulative FCF: -$14.7B
5y Cumulative (FY2021-FY2025, 排除 peak): -$35.8B
```

[DM-FIN-009-FIX, Intel FY2020-FY2025 cash flow statements + Q1'26 10-Q, 与 §4.2 详表 reconcile]

**核心观察**: 自 FY2022 起连续 4 年负 FCF, 累计 -$47.1B (含 FY2022). 这与 "可持续盈利能力" 的含义直接相反. INTC 必须依赖 (i) 资产负债表消耗 / (ii) 政府补贴 / (iii) 长期债务发行支撑 CapEx.

**资产负债表 reconciliation (v3.1 修正)**:
- LT debt (Q1'26): $53.0B
- 现金 + ST investments (Q1'26): $11.5B  
- **Net debt**: -$41.5B [DM-RECON-FIX-001]
- v3.0 错误措辞"净现金 +$5B" 已删除. 那是某种 unrestricted operating cash 口径, 不等于资产负债表净现金. **正确表述: INTC 当前是净债务 -$41.5B 状态, 不是净现金状态**.
...
```mermaid
flowchart TD
    T[Phase 3 v1.1 base<br/>Bear 40% / Base $33 / Bull $72]
    T --> RT1[挑战 1<br/>Bear 概率端点]
    T --> RT2[挑战 2<br/>Foundry spinoff 期权过高]
    T --> RT3[挑战 3<br/>$95 股价分解]
    T --> RT4[挑战 4<br/>18A upside scenario]
    T --> RT5[挑战 5<br/>NVIDIA Vera 情景 B]
    ...
    CAL --> RES[Bear 37.5% / Base 52.5% / Bull 10%<br/>加权 $26.25]
```
...
```mermaid
flowchart TD
    PD[Phase 4 校准后<br/>$26-28 / 评级 审慎关注]
    PD --> B[Buffett<br/>能力圈+安全边际]
    PD --> M[Munger<br/>反演+lollapalooza]
    PD --> H[Howard Marks<br/>周期+钟摆]
    PD --> K[Klarman<br/>清算价值+lift size]
    PD --> D[Druckenmiller<br/>宏观+反身性]
    PD --> G[Greenblatt<br/>special situations]
    ...
    Vote -->|≥3/5 SELL| Tag[评级标注 临界<br/>R-3 字面阈值]
```
...
flowchart TD
    V[公允价值 $26-28]
    V --> M1[方法 1: SOTP 拆解]
    V --> M2[方法 2: 三情景概率加权 DCF]
    V --> M3[方法 3: 周期股 EV/Sales 倍数]

    M1 --> M1A[CCG $11 + DCAI $5 + NEX $1<br/>+ MBLY $2 + Foundry -$5<br/>+ 净现金 $2 + 政府 puts $3<br/>+ Tan 期权 $1.5<br/>≈ $20-24]
    M2 --> M2A[37.5% × $5 + 52.5% × $33<br/>+ 10% × $70.5 = $26.25]
    M3 --> M3A[3.5x EV/Sales × $53.5B<br/>= $187B EV - $42B 净债务<br/>= $145B 市值 = $33.5/share]

    M1A --> AVG[加权平均 $26.5]
    M2A --> AVG
    M3A --> AVG
    AVG --> Range[公允区间 $26-28]
```
...
flowchart TD
    KS[8 条 Kill Switch]
    KS --> Bear[Bear 强化触发<br/>5 条]
    KS --> Bull[Bull 触发<br/>3 条]

    Bear --> KS1[KS-1: 18A yield 推迟]
    Bear --> KS2[KS-2: AMD share 加速]
    Bear --> KS3[KS-3: AMD beat rate]
    Bear --> KS4[KS-4: ARM hyperscaler 加速]
    Bear --> KS5[KS-5: Foundry external commit 不足]

    Bull --> KS6[KS-6: NVIDIA Vera Intel x86 option]
    Bull --> KS7[KS-7: Reset catalyst clock 反向]
    Bull --> KS8[KS-8: Tan spinoff signal]
```
...
## 17.0 Q1 2026 实际结果纳入 (v3.1 新增, 4-23 release 后)

> **背景**: Intel Q1 2026 财报已在 2026-04-23 发布 (v3.0 报告日期 2026-04-26 但未纳入 — v3.0 关键缺陷). v3.1 把 Q1'26 actual data 完整纳入 + 评估对 bear thesis 的影响.

### 17.0.1 Q1'26 财务硬数据

[DM-Q126-FIX-001, INTC Q1 2026 release 2026-04-23 + earnings transcript Motley Fool]

```
Q1'26 财务概览:
  Revenue: $13.6B (+7% YoY)
  Non-GAAP EPS: $0.29 (+123% YoY, vs Q1'25 $0.13)
  GAAP EPS: -$0.04 (vs Q1'25 -$0.10, 改善但仍负)
  Non-GAAP GM: 38.5% (vs Q1'25 36.7%, +180bp 改善)
  
Segment 表现:
  CCG (Client): ~$7B (+3% YoY, 含原 NEX edge 部分)
  DCAI (Data Center & AI): $5.1B (+22% YoY) — 5 年来最强增长
  Intel Foundry: $5.4B (+16% YoY, 主要内部转移)
    - External Foundry revenue: $174M (季度年化 <$1B)
    - Operating loss: -$2.4B
  
关键产品 / 客户 announcements:
  Xeon 6 被选为 NVIDIA DGX Rubin NVL8 host CPU [DM-Q126-NVDA-001]
  Google Cloud Xeon 6 多年合作签约
  TeraFab 项目宣布 (新一代 fab 架构)
  18A 量产进度 on track
  14A roadmap update
```

### 17.0.2 Q1'26 数据对 bear thesis 的影响 (sensitivity)

| Bear thesis 假设 | v3.0 假设 | Q1'26 actual | 影响 |
|----------------|---------|------------|------|
| Server CPU share 持续失血 -5pp/year | -5.7pp/yr trajectory | DCAI +22% YoY 反弹 | **partial weaken** — trajectory 可能转折, 但需 2-3 季度确认 |
| AMD 8/8 季度 7 次 beat 持续 | 维持 87.5% | Q1'26 AMD 数据待 4-29 release | pending |
| NVIDIA Vera 100% Grace ARM | 高概率 70-80% | Rubin NVL8 选 Xeon 6 | **partial reverse** — INTC 在 NVIDIA AI server 仍有立足点 |
| Foundry external 商业化弱 | 5y 累计 $3-15B | Q1'26 external $174M (年化 <$1B) | **confirm** — Foundry 商业化进度仍弱 |
| 18A yield 推迟 12-18 个月 | 50%+ 概率 | Q1'26 transcript: yield on track | partial weaken (Tan 强调 yield 进度, 但实际数据未公开) |
| Tan 公开拒绝 spinoff | v3.0 [B] 级硬信号 | Q1'26 transcript 无逐字 reject | **删除** — 改为 [C] "未释放 spinoff 信号" |

### 17.0.3 Q1'26 数据后概率重锚

```
v3.0 概率: Bear 37.5% / Base 52.5% / Bull 10%
v3.1 概率: Bear 30-45% (中点 37.5%) / Base 40-55% (中点 47.5%) / Bull 8-20% (中点 15%)

Bear 概率不变中点 37.5%:
  - 上修因子: NVIDIA Rubin Xeon 6 反向 (-2pp)
  - 下修因子: DCAI +22% 反弹 (+0pp 待确认)
  净: 维持 37.5% 但区间宽度增加 (30-45% vs v3.0 35-39%)

Base 概率从 52.5% → 47.5% (-5pp):
  - Bull 概率上修需要从 Base 让出
  - 反映"中性 case" 范围缩小, 极端 case 概率上升

Bull 概率从 10% → 15% (+5pp):
  - NVIDIA Rubin Xeon 6 是真实 positive signal
  - DCAI +22% 暗示 server CPU 不是单边失血
  - 但 Foundry external $174M 仍弱, 不能给更高
```

### 17.0.4 Q1'26 数据后情景金额重锚

```
Bear case 5y exit value: $5 → $11.5 (+$6.5/share)
  原因: 即使 bear 实现, DCAI 不会归零, server CPU 仍有 enterprise + 部分 hyperscaler share
  
Base case 5y exit value: $33 → $31.5 (-$1.5/share)
  原因: Foundry external 重锚后稍偏弱, 但 DCAI 反弹抵消大部分

Bull case 5y exit value: $70.5 → $65 (-$5.5/share)
  原因: 即使 Bull, NVIDIA Vera 完全转 x86 概率低, 给上限封顶
```

### 17.0.5 Q1'26 数据后 v3.1 估值结论

```
5y exit value 加权 (v3.1):
  37.5% × $11.5 + 47.5% × $31.5 + 15% × $65
  = $4.31 + $14.96 + $9.75
  = $29.02 (vs v3.0 $26.25, 略上修 +$2.77)

今日 PV (8% WACC, 5y, factor 0.681):
  $29.02 × 0.681 = $19.76 (区间 $18-25)

vs $82.57:
  5y exit downside: -65% (vs v3.0 -72%)
  Today PV downside: -76% (vs v3.0 -81%)
```

**核心结论**: Q1'26 数据纳入后, bear thesis 方向仍成立 (公允 << 当前), 但**conviction 弱化**. 评级从"(临界)"降为"(高争议)". v3.1 不再是 high-conviction SELL, 而是 watch / avoid / wait for reset.

### 17.0.6 v3.1 后续 catalyst clock 更新

```
原 KS-7 catalyst:
  ❌ 4-29 AMD Q1'26 beat (在 v3.1 撰写 4-27 时尚未发生, 仍 pending)
  partial-reverse 5-1 AWS re:Invent ARM 路线图 (待发生)
  partial-reverse 18A timeline (Q1'26 on track, bear catalyst weakened)
  ⏳ 2026 H2 Foundry external commit (Q1 实际 $174M / 季度, 仍弱)
  partial-reverse NVIDIA Vera reference design (Rubin NVL8 选 Xeon 6, partial reverse)
  
联合 fire 概率: 从 v3.0 的 50-60% 下修至 40-50%
Reset window: 维持 6-12 个月, 但 reset 幅度从 -65-75% 弱化为 -55-65%
```
...
flowchart TD
    ...
    H1 --> Now[INTC 2026 当前<br/>P/S 7.7x<br/>叙事溢价 37-46%]
    H2 --> Now
    H3 --> Now

    Now --> Pred[Reset 预期<br/>-65-75% in 6-12 月<br/>$95 → $26-28]
```
...
flowchart TD
    ...
    A -->|Yes 30%| B{Microsoft Cobalt 2<br/>2027 ramp 顺利?}
    A -->|No 70%| C{AMD Q1'26<br/>beat 80%+?}

    B -->|Yes 50%| D{Apple A20<br/>NDA 公开?}
    B -->|No 50%| E[Bear endgame<br/>$15-25]

    C -->|Yes 80%| F[Bear endgame<br/>$5-15]
    C -->|No 20%| G[Mid endgame<br/>$25-35]

    D -->|Yes 30%| H[Bull endgame<br/>$60-90]
    D -->|No 70%| I[Mid endgame<br/>$30-45]
...
```mermaid
flowchart TD
    INTC[INTC<br/>P/Sales 7.7x<br/>ROIC 2-4%<br/>GM% 36%]

    INTC --> Cmp1[最相似 IDM]
    INTC --> Cmp2[最相似 Foundry]
    INTC --> Cmp3[最相似 设计公司]

    Cmp1 --> SI[Samsung Semi<br/>P/Sales 1.8x<br/>ROIC 12%<br/>GM% 38%]
    Cmp1 --> SK[SK Hynix<br/>P/Sales 2.5x<br/>ROIC 18%<br/>GM% 40%]

    Cmp2 --> TSM[TSMC<br/>P/Sales 8.5x<br/>ROIC 28%<br/>GM% 60%]
    Cmp2 --> GF[GlobalFoundries<br/>P/Sales 3.5x<br/>ROIC 8%<br/>GM% 24%]
    Cmp2 --> UMC[UMC<br/>P/Sales 2.2x<br/>ROIC 12%<br/>GM% 32%]

    Cmp3 --> AMD[AMD<br/>P/Sales 8.0x<br/>ROIC 28%<br/>GM% 50%]
    Cmp3 --> NV[NVIDIA<br/>P/Sales 25x<br/>ROIC 65%<br/>GM% 75%]
```
...
flowchart LR
    Data[关键数字]
    Data --> F[财务<br/>30+ 锚点]
    Data --> M[市场份额<br/>15+ 锚点]
    Data --> P[工艺<br/>10+ 锚点]
    Data --> G[政府/政策<br/>8+ 锚点]
    Data --> R[圆桌+认知<br/>15+ 锚点]
```
...
```mermaid
flowchart TD
    Y20[FY2020 顶点<br/>Rev $77.9B<br/>GM 56% / EPS $4.94<br/>FCF +$21B<br/>ROIC 18%]
    Y22[FY2022 拐点<br/>Rev $63B<br/>GM 47% / EPS $1.94<br/>FCF -$9B<br/>ROIC 8%]
    Y25[FY2025 谷底<br/>Rev $53.5B<br/>GM 36% / EPS $0.85<br/>FCF -$8B<br/>ROIC 2-4%]

    Y20 -->|server share<br/>89% → 73%| Y22
    Y22 -->|server share<br/>73% → 60.5%<br/>+ Foundry burn| Y25

    Y20 --> Drv1[结构性 driver]
    Drv1 --> Drv1a[工艺落后 -7pp GM]
    Drv1 --> Drv1b[AMD 竞争 -6pp GM]
    Drv1 --> Drv1c[Foundry 拖累 -2pp GM]
    Drv1 --> Drv1d[D&A 上升 -3pp GM]
```
...
```mermaid
flowchart LR
    Now[2026 当前<br/>INTC 60.5% / AMD 32.3% / ARM 7%]

    Now -->|AMD beat 87.5%<br/>+1-2pp/y| AMD27[2027<br/>INTC 56% / AMD 35%]
    Now -->|ARM tipping point<br/>过 30%| ARM27[2027<br/>ARM new design 50-60%]
    Now -->|18A vs N2<br/>差距 12-18m| TSM27[2027<br/>INTC 18A 50-80K vs<br/>TSMC N2 200K]

    AMD27 --> End30[2030 INTC<br/>server share 40-50%]
    ARM27 --> End30
    TSM27 --> End30

    End30 --> Verd[公允 $26-28<br/>5y -72%]
```
...
flowchart TD
    ...
    F -->|18A yield 70% in 2026 H2<br/>三条件 2/3 满足<br/>P=20%| Bull[Bull endgame<br/>NPV +$0 to +$5/share]
    F -->|18A yield 70% in 2027 Q3<br/>三条件 1/3 满足<br/>P=50%| Base[Base endgame<br/>NPV -$10 to -$2/share]
    F -->|18A yield <50% in 2027<br/>三条件 0/3 满足<br/>P=30%| Bear[Bear endgame<br/>NPV -$18 to -$10/share]

    Bull --> WAvg[加权 NPV<br/>20%×$2.5 + 50%×-$6 + 30%×-$14<br/>= -$6/share]
    Base --> WAvg
    Bear --> WAvg

    WAvg --> Imp[vs 市场默认 +$30<br/>差 -$36/share]
```
...
```mermaid
flowchart LR
    Spec[公允价值光谱<br/>$15 ←→ $35]

    Spec --> K[Klarman<br/>$15-25 下限<br/>$25-30 中性<br/>HOLD]
    Spec --> M[Munger<br/>$20-25<br/>SELL]
    Spec --> D[Druckenmiller<br/>$20-28<br/>SELL]
    Spec --> B[Buffett<br/>$25-30<br/>SELL]
    Spec --> H[HM<br/>$25-32<br/>SELL/WATCH]
    Spec --> G[Greenblatt<br/>$28-35 含期权<br/>WATCH]

    K --> Cons[共识中位 $26<br/>± $5 区间]
    M --> Cons
    D --> Cons
    B --> Cons
    H --> Cons
    ...
    Cons --> Final[我们的 $26-28<br/>= 6 视角中位]
```
