# Launch Brief: INTC
> 自动生成 by tier3_launch.sh v1.0 | 2026-02-25 10:24
> **AI必须在Phase 0开始前完整阅读本文件**

## 复杂度评估
- **行业**: 半导体
- **同行业报告数**: 7 份
- **同行业参考**: AMAT(304K) AMD(341K) ASML(422K) KLAC(254K) LRCX(470K) MU(178K) TSM(451K) 
- **同行业平均**: 346K chars
- **★ 目标字符范围**: 276K - 432K chars
...
## Phase -1 知识检索
- knowledge_context.md: 1635 chars
- 状态: ✓ 完成
...
4. [x] checkpoint.yaml 已自动创建 (target_chars: 346132)
