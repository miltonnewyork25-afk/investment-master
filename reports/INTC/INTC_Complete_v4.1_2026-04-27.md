# Intel v4.1: Agentic AI 给了 Xeon 新叙事, 但 $82.57 仍买入太多成功
...
**SOTP 一表汇总** (按 4.32B 摊薄股本, **v4.1 重锚反映 DCAI 受 agentic CPU bull case 上修**):
...
四种 peer multiple 计算 (**v4.1 重锚反映 agentic CPU partial premium**):
...
INTC 自己历史周期中位 P/Sales 3.5x (v4.1 上修上沿至 4.5x 反映 agentic CPU bull case). 应用 4.5x: $52.9B × 4.5 = $238B EV - $41.5B = $196B equity → **$45/share** (上沿). v4.1 实际采用 3.5-4.5x 区间, 中点 4.0x = $172B EV - $41.5B = $130B equity → **$30/share**.
...
注意 peer multiple 比 today PV 略高, 因为它没有反映 Intel 当前正在亏钱 (operating loss 比 peers 高). 所以我们采用 today PV $23-28 (v4.0 重锚后) 作为更准确的估值锚, peer multiple $20-38 作为上沿 sanity check.
