...
## Ch8: Python DCF验证 (铁律3)

### 8.1 验证需求

P2的DCF是手算——需要Python脚本独立验证，确保:
1. 贴现因子计算正确
2. Terminal value没有计算错误
3. 敏感性矩阵数学正确
4. FCF增速假设与收入/margin假设一致

### 8.2 Python脚本需求(Phase 2产出)

```python
# 核心参数
base_fcf = 1396  # FY2026 FCF $M
normalized_fcf = 1900  # 正常化WC后
wacc = 0.105
terminal_growth = 0.03
growth_rates = [0.25, 0.25, 0.25, 0.15, 0.15, 0.15, 0.15]  # 7年
shares = 862  # M
net_debt = 1831  # $M

# 敏感性
wacc_range = [0.095, 0.100, 0.105, 0.110, 0.115]
g_range = [0.025, 0.030, 0.035]
```
