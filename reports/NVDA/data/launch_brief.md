# Launch Brief: NVDA
> 自动生成 by tier3_launch.sh v1.0 | 2026-03-02 11:38
> **AI必须在Phase 0开始前完整阅读本文件**

## 复杂度评估
- **行业**: 半导体
- **同行业报告数**: 8 份
- **同行业参考**: AMAT(304K) AMD(341K) ASML(422K) INTC(269K) KLAC(254K) LRCX(470K) MU(178K) TSM(451K) 
- **同行业平均**: 336K chars
- **★ 目标字符范围**: 269K - 420K chars
...
## Phase -1 知识检索
- knowledge_context.md: 1577 chars
- 状态: ✓ 完成
...
4. [x] checkpoint.yaml 已自动创建 (target_chars: 336602)
