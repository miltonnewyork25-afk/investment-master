...
|------|------|------|------|------|-----|
| **P/E TTM** | 36.4x [DM-PEER-001] | 48.3x | 42.5x | 48.1x | 27.5x |
...
AMAT P/E TTM 36.4x [DM-PEER-001]，同业均值（LRCX+KLAC+ASML）P/E 46.3x。AMAT的折价幅度：

**P/E折价** = (36.4 - 46.3) / 46.3 = **-21.4%**
...
如果市场修正40%的"过度折价"（即P/E从36.4x提升至~40x），隐含股价约$346-365——接近当前股价水平。这意味着**当前股价可能已经部分反映了通才折价的修正预期**，但尚未完全Price In GAA+先进封装的长期价值。
