# Launch Brief: VRT
> 自动生成 by tier3_launch.sh v1.0 | 2026-02-20 19:43
> **AI必须在Phase 0开始前完整阅读本文件**

## 复杂度评估
- **行业**: 数据中心基础设施/半导体产业链
- **Worktree**: 半导体
- **同行业报告数**: 8 份 (AMAT/AMD/ASML/INTC/KLAC/LRCX/MU/TSM)
- **同行业平均**: 340K chars
- **★ 目标字符范围**: 450K - 520K chars (含供应链上下游分析+中国对标)
- **硬底线**: 350K chars (低于此为质量失败)
- **新增维度**: 上游供应链垄断性分析 + 下游客户CapEx传导 + 中国供应链机会映射
...
## 进化教训 (最近3份报告)
  - 方法伪独立是系统性问题(5方法实际2独立)+多层组装引入冗余
  - 多Agent组装需数值锚定协议(P5_A vs P5_C期望回报18pp冲突→43处修复)
  - v1.1补强(+9K chars, 5处修正)将前瞻视角从缺失提升至体系化; DM锚点仍需Phase-level集成改进

## Phase -1 知识检索
- knowledge_context.md: 1609 chars
- 状态: ✓ 完成
