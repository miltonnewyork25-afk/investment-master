...
> **价格**: $96.76 | **市值**: $110.2B | **评级**: 审慎关注 | **期望回报**: -23.9%
...
> **价格**: $96.76 | **市值**: $110.2B | **评级**: 审慎关注

---

## 一句话判断

**SBUX拥有全球最强的咖啡品牌和35.5M会员数字生态,CEO Niccol的转型方向正确且Q1 FY2026已现初步验证(交易量+4%)——但$97的价格隐含了OPM恢复+利率下行+增长持续的联合成立(概率约15%),概率加权估值$73.6暗示当前溢价约24%。**
...
| OPM \ WACC | 5.0% | 5.5% | 6.3% |
|:----------:|:----:|:----:|:----:|
| 13% | **$95** ◀ | $74 | $52 |
| 14% | $106 | $83 | $60 |
| 15% | $116 | **$92** ◀ | $67 |

**$97需要: OPM≥13% + WACC≤5.0%**(Fed降息至~3%)——这两个条件必须同时成立。
...
**风险回报**: 上行概率30%(空间+4~40%) vs 下行概率70%(空间-19~-100%)。
...
这个评级表达的是: 在当前价格水平,基于可获得的事实和合理假设,风险回报结构不利。这**不是**对SBUX公司质量的否定——SBUX拥有全球最强的咖啡品牌、35.5M会员生态和一位方向正确的CEO。这是对$97这个**价格**的判断。

### 什么会改变评级?

| 触发条件 | 新评级方向 |
|---------|:---------:|
| Q2 comp≥+5% + OPM开始恢复 | → 中性关注 |
| Fed降息至3% + WACC→5% | → 中性关注 |
| 美国特许化宣布 | → 关注 |
| Q2 comp≤0% + OPM恶化 | → 维持审慎关注 |
| 信用评级下调 | → 强化审慎关注 |
...
**"审慎关注"表达的是**: 基于当前可获得的事实和合理的分析假设，SBUX的市场定价隐含了一组较为激进的信念——这些信念需要多个条件同时成立(OPM恢复+利率下行+增长维持+无信用事件)。

**"审慎关注"不意味着**:
- ❌ "SBUX是一家坏公司"——SBUX拥有全球最强的咖啡品牌和35.5M会员生态
- ❌ "Niccol会失败"——方向正确，Q1'26有积极信号
- ❌ "不应该持有"——这不是交易建议
- ❌ "必然下跌"——如果Fed降息+OPM恢复同时实现，$97可能合理

**"审慎关注"意味着**:
- ✅ 在当前价格水平，风险回报结构不利(75%概率下行 vs 25%上行)
- ✅ 市场定价激进，5个隐含假设的联合概率约15%
- ✅ Q2 FY2026(5月5日)是最重要的数据检查点——该季度comp数据可能显著改变概率分布
- ✅ 利率路径是单一最大的估值驱动变量——Fed政策变化可能改变评级
...
| 特许化美国宣布 | 路径B启动 | → 关注 |
| Q2 comp ≤0% + OPM继续恶化 | 转型失败 | → 维持审慎关注 |
| 评级下调至BBB | 信用事件 | → 强化审慎关注 |
| 分红削减 | 财务恶化确认 | → 强化审慎关注 |
...
```mermaid
graph TD
    CURRENT["当前: 审慎关注<br>$96.76 | 期望-37%"]
    CURRENT -->|"Q2 comp≥5%<br>+ Fed降息"| UPGRADE["→ 中性关注"]
    CURRENT -->|"特许化宣布"| UPGRADE2["→ 关注"]
    CURRENT -->|"Q2 comp≤0%"| MAINTAIN["→ 维持审慎关注"]
    CURRENT -->|"评级下调/分红削减"| DOWN["→ 强化审慎关注"]

    style CURRENT fill:#e65100,color:#fff
    style UPGRADE fill:#ff9800,color:#fff
    style UPGRADE2 fill:#66bb6a,color:#fff
```
...
| # | 发现 | 含义 |
|---|------|------|
| F18-1 | 温度计-0.15(微凉)vs市场定价"暖春" | 温差=溢价的另一种表达 |
| F18-2 | A-Score 5.86/10(品牌强/财务弱/估值差) | 好公司≠好投资 |
| F18-3 | **初判: 审慎关注** (期望回报-37.3%) | 等待Phase 4挑战 |
| F18-4 | Q2 FY2026是最大的评级触发器 | 5月5日密切关注 |
| F18-5 | 利率是唯一能让$97合理化的单变量 | Fed路径>公司执行力 |

[DM-P3-D12](C: Ch18发现汇总)
...
> **免责声明**: 本报告仅供研究参考,不构成投资建议。报告中的评级("审慎关注")表达的是对当前价格水平下风险回报结构的分析判断,不是交易指令。投资者应基于自身风险偏好和研究做出独立决策。
