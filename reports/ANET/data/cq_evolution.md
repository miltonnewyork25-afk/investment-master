...
|:--:|:----:|:--:|:--:|:--:|:--:|:--:|:-----:|---------|
| CQ1 | 45% | 47% | 47% | 48% | -- | -- | +3pp | P3: 护城河复合3.83/5确认差异化, AI冲击L3层防御性, 但Agent A半衰期7.5年提醒衰减 |
| CQ2 | 50% | 50% | 50% | 52% | -- | -- | +2pp | P3: 五引擎周期3/5+H100 83.5%≥$2.50, AI冲击DC净正+1.0, 但DIO 230天异常 |
| CQ3 | 55% | 48% | 45% | 43% | -- | -- | -12pp | P3: PPDA背离3客户无流失-35pp(55%vs90%隐含), 五引擎内部人零买入强化集中风险 |
| CQ4 | 50% | 55% | 57% | 60% | -- | -- | +10pp | P3: 转换成本4.5/5最强维度, $2-5M脚本重写成本量化, 护城河互锁EOS→CloudVision→DR |
| CQ5 | 40% | 38% | 36% | 33% | -- | -- | -7pp | P3: AI冲击仅+0.625/5 vs市场隐含+3-4, PE/AI比2.5x(NVDA 0.6x), PPDA 4/4单向+PMSI 58 vs PE 52x |
| CQ6 | 55% | 57% | 57% | 56% | -- | -- | +1pp | P3: 护城河半衰期5-10年(白盒), 但AI加速开源网络采纳, 1.6T转型2027是关键窗口 |
