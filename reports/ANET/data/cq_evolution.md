...
|:--:|:----:|:--:|:--:|:--:|:--:|:--:|:-----:|---------|
| CQ1 | 45% | 47% | 47% | 48% | 43% | -- | -2pp | P4: Spectrum-X份额已超越ANET(-5pp), RT-1承重墙Revenue CAGR脆弱度5/5, RT-3钢人论证A级 |
| CQ2 | 50% | 50% | 50% | 52% | 57% | -- | +7pp | P4: Enterprise Campus锁定被低估(+5pp), IT认证成本+10K企业客户流失率<2%/年, NVIDIA对企业无竞争力 |
| CQ3 | 55% | 48% | 45% | 43% | 38% | -- | -17pp | P4: NVIDIA已超ANET份额(-5pp), RT-3客户内部化钢人论证, MSFT内部化路径5年内可能 |
| CQ4 | 50% | 55% | 57% | 60% | 60% | -- | +10pp | P4: MSFT Q2'26 $29.9B CapEx实证(0pp), 周期持续性无新挑战证据 |
| CQ5 | 40% | 38% | 36% | 33% | 33% | -- | -7pp | P4: CEO/CTO 70%+抛售vs MFS +2829%建仓相互平衡(0pp), RT-2确认偏差纠正概率Bull 25→20% |
| CQ6 | 55% | 57% | 57% | 56% | 50% | -- | -5pp | P4: MSFT内部化路径量化(-6pp), RT-1护城河承重墙7.5年半衰期, RT-6时间框架10年DCF vs 5年有效性 |
