...
total_chars: ~383K (v1.2修正后)
chapters: 30
dm_anchors: 613
mermaid_diagrams: 95
cq_weighted_confidence: 75%
probability_weighted_ev: $35.6B
...
Roblox是全球最大的用户生成内容(UGC)游戏平台，97.8M日活跃用户(DAU，+27% YoY)在500万+注册开发者构建的沉浸式体验中消费虚拟货币Robux。FY2025公司实现Revenue $4.89B(+28.5%)、Bookings $6.8B(+55%)——增长数据优异但$44.3B市值在赌三个业务假设同时成功: [v3.0重写: 业务判断优先]

**(1) 监管风暴可控**: COPPA 2.0合规截止(4月22日)、MDL 3166约80-115起联邦诉讼、6州检察长调查、10+国封禁构成科技行业最密集的监管叠加。概率加权EV影响-$9.7B(占当前估值22%)——**这是最大的单一风险因子**。

**(2) "儿童平台"能成功扩展至成人**: 67-73%用户为未成年人,但管理层声称17+占42%。如果年龄扩展失败→DAU天花板在150M而非300M→增速断崖。这一身份错位是几乎全部风险的结构性根源。

**(3) 开发者生态不被竞争者瓦解**: 帕累托极端(Top 10赚$33.9M vs 中位$1,575)+分成率44-49pp低于竞品→中层开发者面临2-3x收入诱惑→UEFN/Fortnite/Core的虹吸效应是真实威胁。

*(SBC 23.1%/Rev是增长期平台公司的人才投资成本,与高增长阶段(+28.5%)匹配。SBC处理方式影响估值口径但不改变业务论点——真正决定RBLX值$15B还是$65B的是上述三个业务变量,不是会计口径选择。详见Ch8 SBC分析。)*

DM-SUM-001: RBLX核心画像(截至2026-02-13)——市值$44.3B, 股价$63.17, 稀释股数702M, EV ~$44.7B。FY2025: Revenue $4.89B(+28.5%), Bookings $6.8B(+55%), GAAP净亏损-$1.07B, 报告FCF $1.36B(Margin 27.8%)。SBC $1.13B(23.1% of Revenue), "真实FCF"(含SBC) +$231M。DAU 97.8M(+27%), 付费渗透率25.5%, ARPU ~$47。递延收入$5.1B(105% of Revenue), 27个月加权确认周期。[FMP baggers_summary; fmp_data income/balance; 公司IR]
...
flowchart TB
    subgraph S1["S1 熊市 · 概率20%"]
        ...
        S1T["SBC/Rev恶化至30%+<br/>COPPA+MDL重压<br/>开发者流失+DAU<10%增速<br/>年龄扩展失败"]
    end

    subgraph S2["S2 基准偏空 · 概率40%"]
        S2V["EV: $30B<br/>隐含股价: $43<br/>vs当前: -32%"]
        S2T["SBC维持20-25%不改善<br/>监管可控和解$3-5B<br/>DAU增速10-15%<br/>广告$500M-$800M"]
    end

    subgraph S3["S3 基准偏多 · 概率30%"]
        S3V["EV: $65B<br/>隐含股价: $93<br/>vs当前: +47%"]
        S3T["SBC降至<15%/GAAP盈利<br/>广告突破$1B<br/>18+占比>35%<br/>DAU>200M"]
    end
    ...
    S1 --> RESULT["概率加权综合<br/>━━━━━━━━━━━━<br/>情景法: ~$45.5B<br/>五方法: $29.0B<br/>综合(60/40): $35.6B<br/>━━━━━━━━━━━━<br/>vs 市值$44.3B<br/>期望回报: -19.6%"]
    S2 --> RESULT
    S3 --> RESULT
    S4 --> RESULT
...
DM-SUM-002: 四情景概率加权EV——S1(20%×$15B=$3.0B) + S2(40%×$30B=$12.0B) + S3(30%×$65B=$19.5B) + S4(10%×$110B=$11.0B) = 情景法$45.5B。五方法综合$29.0B。综合加权(五方法60%+情景法40%) = $35.6B, 隐含股价$50.7, 期望回报-19.6%。两种方法差距60%($45.5B vs $29.0B)本身就是RBLX估值不确定性的量化指标 [Ch26五方法估值; Ch27四情景框架]
...
graph LR
    subgraph 评级仪表盘["RBLX 评级仪表盘"]
        ...
        A["概率加权EV/市值<br/>$35.6B / $44.3B = 0.79<br/>━━━━━━━━━━━━<br/>期望回报: -19.6%"]

        B["方法离散度<br/>4.3x(含Track B)<br/>1.47x(排除极端)<br/>━━━━━━━━━━━━<br/>会计口径差异贡献65%<br/>(业务分歧贡献35%)"]
...
概率加权综合EV $35.6B vs 市值$44.3B，期望回报约-19.6%。五方法中4/5指向当前股价高估(Track A DCF -28%、EV/Revenue可比 -24%、SOTP -37%、Track B DCF -79%)，仅EV/Bookings接近持平(-8%)。方法离散度4.3x(含Track B)意味着估值结论本身的置信度有限——这是我们评级为"审慎关注"(跟踪但不行动)而非"观望回避"(明确回避)的核心原因。

**为什么是"审慎关注"而非"观望回避"**: 概率加权EV比(0.79)处于审慎关注区间(0.65-0.85)。虽然五方法综合指向34.5%下行，但以下因素阻止了更负面的评级：(1) 方法离散度较高(4.3x)，估值结论本身的置信度有限；(2) SBC收敛路径存在——如果管理层兑现2027年GAAP盈利承诺，估值前提可能根本性改变；(3) Bookings +55%和DAU +27%的增长指标远超同业，业务质量本身不差；(4) 替代解释(SBC非现金/Bookings口径合理性)有一定可信度，可上修$5-10B。
...
DM-SUM-003: 评级"审慎关注"的量化支撑——综合EV $35.6B vs 市值$44.3B, 期望回报-19.6%; 五方法EV $29.0B vs $44.3B, 下行34.5%; CQ加权置信度75%(8/8全确认); 方法离散度4.3x(SBC贡献65%); 评级置信度65%。1年偏空(风险回报3:1)/3年中性偏空(年化-3.9%)/5年+高不确定性($10-180B, 18x宽度)。升级条件: SBC/Rev连续2季<20% + 广告>$500M + 18+DAU>35%(满足2/3) [Ch26五方法; Ch27四情景; Ch24 CQ闭环]

---

## 1.4 三个最重要发现

**发现一: 监管是最确定性风险——概率加权-$9.7B(占EV 22%)** [v3.0: 从发现三升至发现一]

COPPA 2.0(4月22日硬截止)、MDL 3166(约80-115起联邦诉讼)、6+州检察长独立起诉(含佛州刑事调查)、10+国封禁构成了科技行业中最密集的四层监管叠加。概率加权EV影响约-$9.7B——不是"微不足道"的合规成本,而是当前估值的22%。级联机制(监管风暴→DAU质量重估→增长叙事崩塌)概率8-12%, 终态EV $13-20B(-54%至-71%)。**监管风险比SBC口径选择更直接、更确定、影响更大。**

DM-SUM-006(原发现三锚点): 监管全景——COPPA 2.0+MDL 3166+6+州AG+10+国封禁。概率加权EV影响-$9.7B。级联概率8-12%。承重墙SW-5监管脆弱度5/5(最高)。[Ch19监管; Ch11承重墙; RT-2偏差修正]

**发现二: 8/8 CQ全部确认风险——加权置信度75%，零虚假警报** [v3.0: 位置不变]
...
**发现三: SBC口径差异是估值离散度的数学来源(但非投资决策核心)** [v3.0: 从发现一降至发现三, 重新定位]

SBC $1.13B(23.1% of Revenue)使DCF双轨产生了$22.5B的估值差异(Track A $32B vs Track B $9.5B)。这个差异是**会计口径选择**的数学后果, 不是**业务分歧**。投资者应明确: (a)SBC口径选择影响"你认为RBLX值多少", 但不影响"RBLX的业务是否健康"; (b)真正决定RBLX值$15B还是$65B的是上述发现一(监管)和发现二(8/8 CQ全确认)所揭示的**业务风险**, 不是SBC的会计处理。SBC 23.1%在高增长期(+28.5%)是正常的人才投资成本——当增速最终放缓至<15%时, SBC预计将自然收敛(参考META从>18%降至目前水平)。

DM-SUM-004: SBC估值开关——Track A(不含SBC) EV $32.0B vs Track B(含SBC概率加权) EV $9.5B。SBC处理贡献估值离散度65%, 但这是会计维度的离散, 非业务维度。[Ch8 SBC分析; Ch26 DCF双轨]
...
| CQ4 | SBC与成本结构 | 报告FCF $1.36B扣除SBC后+$231M, SBC/Rev 23.1%在高增长期(+28.5%)属正常人才投资——增速放缓后预计自然收敛 [v3.0: 从最高置信度CQ降级为成本结构维度] | 80% |
...
| **CQ8** | SBC+稀释+FCF叙事? | SBC $1.13B = FCF 0.83倍, 5年稀释16.6%零回购, 340卖/0买中零买入是真实负面信号, FCF叙事存在系统性误导 | 78% |
...
3. **SBC/Revenue季度趋势**: FY2026 Q1是否出现下降拐点(23.1%→?); 连续2季度<40%为评级升级条件之一
...
DM-SUM-009: 可能性宽度6分, 混合模式。五维打分: 商业模式6/收入可预测性4/TAM不确定性7/竞争变动性7/监管风险8。方法离散度4.3x(含Track B) / 1.47x(排除极端)——排除Track B后的离散度处于混合模式正常范围。SBC处理是离散度的核心驱动力(65%), 属于"哲学分歧"而非"分析分歧" [Ch26方法离散度; paradigm_research_framework.md]
...
| SBC $1.13B | FMP + 季报累加推算 | 估算级(FMP字段异常) | ★★☆ |
...
DM-SUM-011: 数据审计总结——13个关键数据点中, ★★★(高可信)7个(54%), ★★☆(中可信)4个(31%), ★☆☆(低可信)2个(15%)。低可信数据点集中在分析推导层(PDRM, 管理层口径), 不影响核心结论的方向性判断。SBC $1.13B为估算级(★★☆), 但量级判断($1.0-1.3B区间)可靠, 23.1% of Revenue这一比率的结论不受精确值波动影响 [P0-P4数据层级; RT-4数据质量审计]
...
1. **估值非精确值**: $29.0B和$35.6B是基于假设的计算结果而非"真实内在价值"。WACC ±2ppt或终端增长率 ±1ppt可导致估值变化30-50%
...
7. **不构成做空建议**: "审慎关注"意味着"不建议建仓多头", 而非"建议做空"。方法离散度4.3x和Bookings +55%的增速使做空风险极高
...
| DCF Track B(真实FCF) | Ch26.1 | SBC三路径概率加权(α50%/β35%/γ15%) | EV $9.5B | 15% |
...
DM-SUM-013: 方法论注册表——五方法(DCF A 25% + DCF B 15% + EV/Rev 20% + EV/Book 15% + SOTP 20% + RevDCF 5%) = 五方法EV $29.0B; 四情景EV $45.5B; 综合(60/40) = $35.6B。递减增长假设(20%→12%→6%)取代恒定CAGR, 使Track A从Phase 2的$45.5B降至$32.0B(-30%), 更贴近S曲线现实 [Ch26全量估值; Ch27情景框架]
...
| SW-8 | SBC动态 | 4/5 | 23.1%同行偏高, 5年稀释16.6%, 零回购 |
...
| ID | 数据点 | 来源 | 可信度 |
|----|--------|------|:------:|
| DM-SUM-001 | RBLX核心画像: 市值$44.3B, Rev$4.89B, SBC$1.13B(23.1%), 真实FCF+$231M | FMP + 10-K | ★★★ |
| DM-SUM-002 | 四情景概率加权: 情景法$45.5B / 五方法$29.0B / 综合$35.6B / 期望回报-19.6% | 计算 | ★★☆ |
| DM-SUM-003 | 评级"审慎关注": 综合EV/市值=0.79, CQ 75%, 离散度4.3x, 评级置信度65% | 综合分析 | ★★☆ |
| DM-SUM-004 | SBC估值开关: Track A $32.0B vs Track B $9.5B, SBC贡献离散度65% | Ch26 DCF | ★★☆ |
...
| DM-SUM-013 | 方法论注册表: 五方法(60%) + 四情景(40%) = 综合$35.6B | Ch26-27 | ★★☆ |
...
*Ch1执行摘要 + Ch2研究契约 完成。共计16个DM锚点(DM-SUM-001~016), 2个Mermaid图表(四情景流程图 + 评级仪表盘)。核心信息: (1)评级"审慎关注", 综合期望回报-19.6%; (2)SBC是估值的薛定谔开关, 贡献65%的方法离散度; (3)8/8 CQ全部确认风险, 加权置信度75%; (4)监管概率加权-$9.7B, 是最大单一风险因子; (5)方法离散度4.3x意味着估值结论本身的置信度有限, 不适合给点数目标价。*
...
# Chapter 3: 技术架构 — Roblox Engine与Cloud基础设施
...
**SBC侵蚀**: 股票薪酬(SBC)约占收入的29%，FY2024 SBC为$1.02B，FY2025预计达~$1.13B。股份稀释率约4.5%/年，三年累计稀释15.7% [DM-ERM-008]。OCF/SBC覆盖率仅2.16倍，意味着经营现金流的近一半被SBC"虚增"——若将SBC视为真实现金成本，FCF将从$1.36B骤降至约+$231M [DM-ERM-009]。
...
graph TD
    ...
    G[SBC ~$1.13B<br/>占收入29%] --> H[股份稀释4.5%/年]
    H --> I[每股价值摊薄]
    C --> J[组织扩张24%<br/>亏损未收窄]
...
2026年1月30日已举行首次案件管理会议。Mark Lanier(美国顶级原告律师)已申请担任共同首席律师。**类比JUUL诉讼**: JUUL(电子烟)MDL最终以$4.35B和解(各州$1.7B + 其他$1.13B)。Roblox的DAU(1.515亿，大量未成年人)远超JUUL的用户基数。保守估计，若诉讼规模扩展至1,000+起，和解金额可能在$2B-$6B区间 [DM-REG-004]。
...
| DM-ERM-009 | OCF/SBC 2.16x; SBC调整后FCF约+$231M | $1.80B OCF - $441M CapEx - $1.13B SBC |
...
| (+) SBC + 其他非现金 | +$3,140M | FMP归入otherNonCashItems; SBC约$1.13B |
...
### 8.2.2 SBC的真实经济成本: $1.13B是"免费"的吗?

SBC(股票薪酬)在现金流量表中被加回, 因为它不涉及现金流出。但SBC有实实在在的经济成本: 股权稀释。

DM-FIN-006: FY2025 SBC约$1.13B(来源: Motley Fool基于SEC Filing), 占Revenue的23.1%, 占Bookings的16.6%。FMP现金流表将SBC归入otherNonCashItems($3.14B), 差额$490M可能包含其他非现金项(如可转债折价摊销等) [Motley Fool; FMP cashflow annual]

DM-FIN-007: 稀释率量化——FY2022稀释股数607M → FY2025稀释股数702M, 3年增加95M股(+15.7%), 年化稀释约5.0%。若SBC持续$1.13B/年且股价维持$63, 隐含年新增股份约42M(= $1,130M / $63), 稀释率约6.0% [FMP; 计算: $1,130M / $63.17 ≈ 42M新股 / 702M = 6.0%]
...
DM-FIN-008: SBC的五年趋势揭示一个关键特征——SBC绝对额从$342M增至$1,130M(+230%), 增速超过收入增长(+155%), 但SBC/Revenue从FY2023峰值31.0%改善至FY2025的23.1%。每赚$1收入中$0.23被"支付"给了员工股权。该比率高于META(~16%)和GOOG(~12%)但低于SNAP(~35%)和Unity(~42%), 处于同业中偏高水平 [计算]

### 8.2.3 "真实FCF": 扣除SBC后的经济现实

如果将SBC视为真实成本(因为它确实导致股东被稀释), "真实FCF"的计算结果令人警醒:

DM-FIN-009: FY2025 "真实FCF" = 报告FCF $1.36B - SBC $1.13B = **+$231M**。换言之, 扣除SBC后, Roblox在FY2025实际上仍在"消耗"$1.29B的股东价值 [计算]
...
DM-FIN-010: "真实FCF"的趋势呈现W型——FY2021短暂为正, FY2022-2023深度为负, FY2024收窄至-$373M(看似改善), 但FY2025因SBC暴增再次恶化至+$231M。FY2024的改善不可持续, 因为SBC在FY2025翻了2.6倍 [计算]
...
**对估值的挑战**: 当前EV/FCF 32.9x看似合理(对标高增长SaaS的25-40x)。但如果用"真实FCF"(FCF-SBC = +$231M), EV/真实FCF为**负值**, 无法估值。这意味着: 市场在为Roblox的FCF定价时, 隐含假设SBC不是真实成本——但年化6%的稀释是真实的。
...
| DM-FIN-006 | FY2025 SBC约$1.13B, 占Revenue 23.1% | Motley Fool, SEC Filing |
| DM-FIN-007 | 3年稀释15.7%, 年化~5.0%, 当前隐含~6.0% | FMP, 计算 |
| DM-FIN-008 | SBC/Revenue从17.8%升至23.1%, 五年+230%绝对增长 | 计算 |
| DM-FIN-009 | "真实FCF" = $1.36B - $1.13B = +$231M | 计算 |
...
> **CQ8关联**: SBC $1.13B/年+年稀释4-6%: FCF叙事是否误导投资者?
...
[DM-VAL-003]: Roblox Beta 1.635(来源: baggers_summary)。这反映了Roblox作为高增长但持续亏损的UGC平台的系统性风险特征。过去一年股价从$150.59高点跌至$50.70低点(跌幅-66.7%), Beta在1.4-2.0区间波动。1.635是FMP计算的回归Beta, 合理区间1.4-1.9 [DM-MKT-004来源: baggers_summary]
...
Phase 1(8.2.3节)揭示了Roblox最大的会计幻象: 报告FCF $1.36B在扣除SBC $1.13B后变为"真实FCF" +$231M [DM-FIN-009]。如果投资者认为SBC是真实经济成本(事实上年化5-6%的稀释确实是真实的), 那么当前EV $44.7B对应的FCF基础不是+$1.36B, 而是+$231M。

**"真实FCF"口径下的Reverse DCF无法直接求解** — 因为起点FCF为负值, 需要先假设Roblox何时达到"真实FCF正值"的拐点。

### 10.4.2 SBC调整后的隐含假设

[DM-VAL-013]: 假设Roblox在FY2028达到"真实FCF"盈亏平衡(即FCF = SBC), 此后真实FCF以25% CAGR增长至FY2035。反推: 这要求FY2028 Revenue达~$10B(假设FCF Margin 30%, FCF $3B, SBC维持$1.13B→真实FCF $350M), 即FY2025-2028 Revenue CAGR 约27% [推算]

更现实的路径: SBC不太可能维持在$1.13B的绝对值——随着收入增长, SBC/Revenue比率可能从23.1%压缩至20-25%(行业正常水平), 但绝对额可能仍增至$3-4B。
...
[DM-VAL-014]: SBC调整版Reverse DCF显示, 要justify $44.7B EV, Roblox需要在FY2027前后达到"真实FCF"盈亏平衡(SBC/Revenue压缩至~33%), 并在FY2035实现"真实FCF" $5.5B。这要求两个条件同时成立: (1) Revenue CAGR 20%+; (2) SBC/Revenue从23.1%压缩至13.2%。条件(2)的幅度极大——即使META(SBC/Rev~16%)也花了10年+的盈利历史才达到这一水平 [计算; META对比]

### 10.4.3 FCF→真实FCF的瀑布图

```mermaid
flowchart LR
    A["报告FCF<br/>$1,360M"] -->|"-SBC $1,130M"| B["真实FCF<br/>+$231M"]
...
[DM-VAL-015]: 从报告FCF $1.36B到"真实FCF" +$231M, 瀑布图显示SBC($1.13B)是唯一的、也是决定性的调整项。EV/FCF从"看起来合理的32.9x"变为"无法估值的负数"。这并非说Roblox毫无价值——而是说用报告FCF估值会严重高估Roblox的当前盈利能力, 估值的核心赌注是SBC/Revenue比率的未来压缩路径 [分析]
...
| FCF Margin维持25%+ | "真实FCF"为+$231M(DM-FIN-009); SBC/Rev 23.1%是极端值 | **高**: 报告FCF margin 28%是"SBC幻象", 真实margin为负 |
| SBC/Revenue压缩至稳态 | SBC绝对额5年+230%(DM-FIN-008); FY2025暴增至$1.13B | **高**: 无证据表明SBC/Rev已见顶 |
...
[DM-VAL-020]: Reverse DCF揭示的核心矛盾——市场定价$44.7B隐含的"Revenue CAGR 20% + FCF Margin 25%"组合, 与"真实FCF仅+$231M + SBC/Rev 23.1% + 开发者分成压力 + 监管悬剑"之间存在系统性紧张关系。市场在定价中可能犯了"口径选择性偏误"——用报告FCF(含SBC加回)的乐观口径, 忽略了SBC的真实经济成本 [分析: Reverse DCF vs Phase 1交叉]

### 10.6.2 两个最重要的隐含赌注

**赌注1: SBC/Revenue会从23.1%进一步压缩至<15%**

当前SBC/Revenue 23.1%已优于SNAP(35%)和Unity(42%),但仍高于META(16%)。如果SBC增速持续超过收入增速(如FY2025前的趋势),比率可能重新恶化至30%+,届时"真实FCF"将从+$231M再度转负,当前EV的70%+终端价值依赖度意味着SBC恶化对估值的杀伤极大(折现效应)。
...
| [DM-VAL-014] | SBC/Rev需从23.1%压缩至13.2%(FY2035) | 计算; META对比 |
| [DM-VAL-015] | 报告FCF $1.36B → 真实FCF +$231M, SBC是唯一决定项 | 计算 |
...
[DM-SW-001]: FCF $1.36B是SBC加回后的产物。扣除SBC $1.13B, "真实FCF"为+$231M(DM-FIN-009)。更关键的: FY2025的SBC/Revenue 23.1%是五年最高值, 不是最低值——SBC从$342M(FY2021)暴增至$1.13B(FY2025), 增速+230%, 远超Revenue的+155%。FCF正值的"可持续性"完全取决于SBC增速能否从此低于Revenue增速, 但FY2025的数据恰恰指向相反方向 [DM-FIN-006, DM-FIN-008, DM-FIN-009]
...
FY2025 SBC约$1.13B, 年化稀释率约4.5-6%(DM-FIN-007)。市场假设随着收入增长, SBC/Revenue将从当前的极端23.1%逐步压缩至行业正常水平(15-25%), 同时公司可能启动回购计划来对冲稀释。

### 反面证据

[DM-SW-018]: SBC/Revenue从FY2021的17.8%飙升至FY2025的23.1%, 五年绝对额增长230%(DM-FIN-008)。更关键的: Roblox从未启动回购计划, 也没有回购计划的公告——在年化稀释5%+的情况下, 零回购意味着每股价值以5%/年的速度被侵蚀。五年累计稀释: FY2022 607M → FY2025 702M, +95M股(+15.7%) [DM-FIN-007, DM-FIN-008]
...
|:------:|------------|-------------|:------:|:-----------:|
| **SW-1** FCF正值增长 | EV/FCF 32.9x, 20% CAGR | 真实FCF +$231M, SBC/Rev 23.1% | **4/5** | -40~60% |
...
| **SW-8** SBC可控 | SBC/Rev压缩至<20% | SBC增速230%>>Rev增速155% | **4/5** | -20~30% |
| **加权平均** | | | **3.5/5** | |
...
| 锚点ID | 数据描述 | 来源 |
|--------|---------|------|
| [DM-SW-001] | 真实FCF +$231M, SBC/Rev 23.1%为五年最高 | DM-FIN-006, 008, 009 |
...
| [DM-SW-018] | SBC增速+230% >> Rev增速+155%, 零回购 | DM-FIN-007/008 |
...
**和解金额区间**:
- JUUL MDL类比: $4.35B(各州$1.7B + 联邦$1.13B)——JUUL用户远少于Roblox但健康损害更直接
...
这个数字意味着什么? FY2025报告FCF $1.36B。如果监管风暴组合实现,年化FCF减少$1.9B,报告FCF将转为约-$540M。在此基础上再扣除SBC $1.13B,"真实"现金消耗率将达约$3.2B/年——Roblox现有$1.21B现金储备不足以支撑1年。
...
graph LR
    subgraph "风险调整FCF推导"
        ...
        C -->|"-SBC -$1,130M"| D["全调整FCF<br/>-$2,026M"]
        D --> E["估值: 无法定价"]
    end
...
> **核心问题(CQ8)**: SBC $1.13B/年+年稀释4-5%: FCF叙事是否误导投资者? 如果SBC是真实成本,Roblox到底在赚钱还是在亏钱?

SBC(Stock-Based Compensation,股票薪酬)是Roblox财务叙事中最具争议的单一变量。华尔街分析师呈现的"FCF $1.36B,EV/FCF 32.9x"是一个技术上正确但经济上误导的画面——它将$1.13B的SBC视为"非现金项目"加回,却无视SBC导致的4-5%年化股权稀释对现有股东的真实价值侵蚀。本章将对SBC进行全维度拆解:历史趋势、同业对比、稀释量化(DPO)、估值影响、管理层策略评估,以及华尔街FCF叙事的系统性批判。

---

## 13.1 SBC五年趋势: 从$342M到$1.13B的指数级增长

### 13.1.1 SBC绝对额与增速

FMP年度现金流数据显示,FY2021-FY2024的SBC可直接从`stockBasedCompensation`字段读取: $342M → $589M → $868M → $1,016M。FY2025的特殊之处在于,FMP将SBC嵌入`otherNonCashItems`($3.14B),不再单独报告。但通过交叉验证: (a) Q1-Q3季度报表单独报告SBC合计$830.6M(Q1 $258.9M + Q2 $284.8M + Q3 $286.9M); (b) TTM截至2025年9月的SBC为$2.649B; (c) Motley Fool基于10-K确认FY2025 SBC约$1.13B——这三个来源收敛,确认FY2025 SBC约$1.13B [DM-SBC-001]。

差额: $3.14B(otherNonCashItems) - $1.13B(SBC) = $490M,这部分可能包含可转债折价摊销、递延收入调整中的非现金部分和其他会计调整项。
...
**关键发现**: FY2024看似出现了SBC/Revenue改善的拐点(从31.0%降至28.2%),但FY2025彻底打破了这一趋势——SBC/Revenue暴涨至23.1%,SBC绝对额翻了2.6倍。**FY2024的"改善"是幻觉**,真实趋势是SBC增速在FY2025出现了结构性跳升 [DM-SBC-003]。
...
| **RBLX** | **~23%** | **$44.3B** | **成长亏损期** | **同行偏高** |

[DM-SBC-005]

Roblox的SBC/Revenue 23.1%在主要科技/游戏公司中处于**中偏高水平**——高于已盈利的META(~16%)和EA(~8%),但低于同为亏损期的SNAP(~35%)和Unity(~42%)。这一比率本身并非"极端",但问题在于: Roblox已是$4.89B收入的规模型公司,SBC绝对额$1.13B意味着每年消耗投资者权益约2.6%。

**从Bookings口径看**: SBC/Bookings 16.6%略好于SBC/Revenue 23.1%,但仍需关注——意味着每$1的真实经济活动中,$0.17被"支付"给了员工股权。
...
**前瞻稀释率估算**: FY2025 SBC $1.13B / 当前股价$63.17 = 42M新股/年。42M / 702M = **2.6%年化稀释率**。如果股价下跌至$50(52周低点附近),同样的SBC金额隐含53M新股/年 = **7.5%稀释率** [DM-SBC-008]。
...
**SBC隐性税率** = SBC / (市值 + SBC) = $1.13B / ($44.3B + $1.13B) = **2.5%/年** [DM-SBC-011]
...
| EV/"真实FCF" | $44.7B | +$231M | **负值** | SBC是真实成本 |
...
**趋势解读**: 报告FCF呈现漂亮的"V型复苏"(从-$58M到$1.36B),这是华尔街看好Roblox的核心叙事。但"真实FCF"呈现"W型陷阱"——FY2024短暂收窄至-$373M后,FY2025因SBC暴增再次恶化至+$231M。两条曲线的分歧在加速扩大,FY2025的差距($1.13B)是FY2021($126M)的21倍。
...
- Roblox人均SBC: $1,130M / 3,065人 = **$369K/人** [DM-SBC-020]
- 对比: META人均SBC约$350K/人; Google约$280K/人; SNAP约$450K/人

Roblox的人均SBC $369K是META的2.5倍——这不是因为Roblox员工薪酬更高,而是因为:
...
- SBC $1.13B被加回OCF,贡献了OCF $1.80B中的62.8%(即如果不加回SBC,OCF为-$850M)
...
- FY2025: SBC/OCF = $1.13B / $1.80B = **62.8%** [DM-SBC-022]
- OCF/SBC覆盖率从FY2021的1.93x恶化至FY2025的1.59x
...
**OCF/SBC覆盖率1.59x是一个警告**: 它意味着Roblox的经营现金流仅能覆盖SBC"真实成本"的68%。FY2024短暂改善至0.81x后,FY2025因SBC暴增再次恶化。这个趋势没有稳定的迹象——除非SBC增速显著放缓(从+161%降至<20%),否则覆盖率将持续承压。
...
两者的共同特征: GAAP亏损、SBC占收入比偏高、无回购、"真实FCF"受压。RBLX的SBC/Revenue(23%)低于SNAP(35%),但P/B极端值(144x vs 6x)使其处于更脆弱的估值位置。SNAP的P/B 6x意味着股价大致锚定在有形资产,而RBLX的P/B 144x几乎完全是"空气"——如果市场对增长叙事的信心动摇,股价可能出现远超SNAP的跌幅。SBC不是RBLX的最大问题,估值倍数才是。

---

## 13.6 SBC何时"正常化"? — 情景推演

**核心问题**: SBC/Revenue从23.1%能否进一步压缩至META级别(~15%)?
...
**结论**: 在Revenue +25%/年(乐观)且SBC +10%/年(需要纪律)的假设下,FY2027即可降至18%以下接近META水平,FY2030可降至12%。这是SBC叙事最优解,但需要收入端持续高增长 [DM-SBC-025]。
...
**结论**: 如果SBC增速维持15%/年(接近员工增长+通胀+RSU补充的自然增速),SBC/Revenue缓慢改善但FY2028仍在20%以上——高于META但低于SNAP,处于"可接受但非理想"区间 [DM-SBC-026]。

### 情景三: 管理层主动纪律(回购+SBC控制)

如果Roblox在FY2027开始年度$500M回购计划,同时将SBC增速控制在<5%/年:
- FY2027 SBC/Revenue: ~16.4%
- FY2027 净稀释率: ~1.5%(= 3.5%稀释 - 2%回购)
- FY2030 SBC/Revenue: ~9.7%
- FY2030 净稀释率: ~1%
...
xychart-beta
    ...
    y-axis "SBC/Revenue (%)" 5 --> 30
    line "乐观(Rev+25%/SBC+10%)" [23, 20, 18, 16, 14, 12]
    line "基准(Rev+20%/SBC+15%)" [23, 22, 21, 20, 20, 19]
    line "主动纪律(回购+控制)" [23, 19, 16, 14, 12, 10]
```
...
**CQ8: SBC $1.13B/年+年稀释4%: FCF叙事是否误导投资者?**

回答: **是的,但不是故意误导,而是结构性框架缺陷。**

华尔街的FCF叙事遵循了标准的GAAP/non-GAAP会计实践——将SBC加回OCF是完全合规的,FCF $1.36B是一个准确的数字。问题在于:**会计准确不等于经济诚实**。

1. **报告FCF $1.36B高估了真实现金创造**: 如果SBC是对未来股权稀释的"预支",那么正确的FCF应该扣除SBC——"真实FCF"为+$231M [DM-SBC-028]

2. **5年后稀释20%意味着: 股价必须上涨25%才能让投资者不亏钱**——这个"稀释税"几乎从不出现在华尔街的DCF模型中 [DM-SBC-029]

3. **SBC/Revenue 23.1%虽低于SNAP/Unity但仍需警惕**: 在乐观假设(Revenue +25%/年, SBC +10%/年)下约2年可降至18%接近META水平,但若SBC增速反弹(如FY2022-2024的+30%/年),比率可能重新恶化至30%+
...
| 锚点ID | 数据 | 来源 |
|--------|------|------|
| DM-SBC-001 | FY2025 SBC约$1.13B(三源交叉验证: Q1-Q3合计$830.6M+Q4推算; TTM Sep'25 $2.649B; Motley Fool确认) | FMP quarterly/MacroTrends/Motley Fool |
| DM-SBC-002 | SBC五年趋势: $342M→$589M→$868M→$1,016M→$1,130M | FMP cashflow annual |
| DM-SBC-003 | SBC/Revenue持续改善: FY2024 28.2%→FY2025 23.1%, 受益于收入增速(+36%)超过SBC增速(+11%) | 计算 |
| DM-SBC-004 | SBC/Revenue对比: META 16%/RBLX 23%/SNAP 35%/Unity 42% | FMP/行业数据 |
| DM-SBC-005 | RBLX的SBC/Revenue 23.1%高于META但低于SNAP/Unity,处于中偏高水平 | 同业对比 |
...
| DM-SBC-008 | SBC $1.13B/股价$63.17隐含2.6%稀释; $50股价隐含7.5% | 计算 |
| DM-SBC-009 | 5年累计稀释~20%, 持股价值从$63,170→$50,441(每千股) | 持股侵蚀模型 |
| DM-SBC-010 | 持股侵蚀图表: 5年轨迹 | 模型计算 |
| DM-SBC-011 | SBC隐性税率2.5%/年(vs META 1.4%/年) | 计算: $1.13B/$47B |
| DM-SBC-012 | 四种估值口径: EV/FCF 32.9x vs EV/"真实FCF"负值 | 计算 |
| DM-SBC-013 | 真实FCF五年: +$216M→-$647M→-$744M→-$373M→+$231M | 计算: FCF-SBC |
...
| DM-SBC-020 | 人均SBC $369K/人(vs META $350K/人) | 计算: $1,130M/3,065 |
| DM-SBC-021 | 年化稀释5%=每年"创造"$2.2B新股(从现有股东转移) | 计算 |
| DM-SBC-022 | SBC/OCF从FY2021 52%恶化至FY2025 62.8% | 计算 |
| DM-SBC-023 | OCF/SBC覆盖率从1.93x恶化至1.59x | 计算 |
...
| DM-SBC-028 | "真实FCF" FY2025 = +$231M (= $1.36B - $1.13B) | 计算 |
...
[DM-VAL-003] Revenue-based DCF假设: FY2025 Revenue $4.89B为起点; FY2026-2028增速35%→28%→22%(Revenue确认滞后, 增速高于Bookings增速); FY2029-2033增速逐年递减至12%→8%; 终端增长率3%; 目标FCF利润率: 含SBC口径25%(当前27.8%), 不含SBC口径-5%(当前+4.7%)。
...
[DM-VAL-005] Bookings-based DCF以FY2025 Bookings $6.8B为起点, FY2026增速+24%(2026指引中值$8.4B); FY2027-2028增速20%→16%; FY2029-2033增速逐年递减至10%→6%; 终端增长率3%。FCF利润率假设类似但基于Bookings口径调整: 含SBC 20%(当前$1.36B/$6.8B=20%), 不含SBC -4%(当前+$231M/$6.8B=-19%)。
...
**对FCF的影响**: 概率加权$4.0B分5年支付,年均$800M。这消耗报告FCF($1.36B)的59%。如果叠加SBC的"真实成本"调整,"真实FCF"已经是+$231M,MDL支付将使真实现金消耗率达-$2.09B/年——$1.21B现金储备仅够支撑约7个月 [DM-REG-032]。
...
# Chapter 22: 红队对抗审查(上) — 承重墙·偏差·空头·数据
...
**Phase 1-3的核心论证**: 报告FCF $1.36B, 但扣除SBC $1.13B后"真实FCF"为+$231M。FCF/Revenue 27.7%的表面健康掩盖了SBC对股东价值的稀释。
...
- SBC/Revenue: $1.13B/$4.89B = 23.1% -- 同行中最高(META ~18%, SNAP ~30%)
...
**独立验证**:
- FMP数据: FY2025 SBC在otherNonCashItems中为$3.14B(FMP的SBC字段异常显示$0, 但交叉验证确认SBC ~$1.13B) [DM-RT-019]
- 内部人交易: FY2025共340笔卖出, 0笔买入(FMP insider-trading验证) [DM-RT-020]
- CEO Baszucki 2025年6月卖出$1.85B(10b5-1计划)
- SBC/Revenue 23.1%, 同行偏高; 年均人力SBC成本$369K vs META $350K
- 5年稀释~16.6%(年化3.1%), 零回购
...
3. **级联终态**: "真实FCF"从+$231M恶化至-$2.09B(叠加MDL), 现金储备$1.21B仅够支撑~7个月
...
**发现1: SBC $1.13B作为"一切问题的根源"锚点**

Phase 1(Ch8)首次引入SBC $1.13B后, 几乎每一章都将其作为核心分析锚点: Ch8用它计算"真实FCF"; Ch11用它划分承重墙脆弱度; Ch13用它计算SBC隐性税率; Ch14用它划分五方法估值的两个世界($32-46B vs $13-20B)。

**偏差程度**: 中等。SBC确实是RBLX分析的核心变量, 将其贯穿分析不一定是偏差。但问题在于: $1.13B是FY2025的单年数字, 未来SBC可能随GAAP盈利承诺(管理层2027年目标)而进一步压缩。如果SBC/Revenue从23.1%改善至15%(接近META水平), 绝对值约$1.05B(假设FY2027 Revenue ~$7B), "真实FCF"将从+$231M改善至约$1.0B。报告可更多关注SBC改善路径, 而非仅聚焦当前水平。[DM-RT-024]
...
graph TB
    subgraph "RT-2 认知偏差审计结果"
        A["锚定偏差<br/>SBC $1.13B贯穿分析<br/>Hindenburg 25-42%未经验证<br/>偏差: 中"]
...
2. 但SBC $1.13B是报告FCF的0.83倍(SBC/FCF = 195%)。扣除SBC后, "真实FCF"为+$231M [DM-RT-032]
3. SBC不是一次性费用, 而是结构性成本: FY2021-2025年SBC从$737M增至$1.13B(CAGR +35%), 增速持续超过Revenue增速(CAGR ~28%)
4. 5年累计稀释16.6%(602M→702M), 年均3.1%, 且零回购。每年新增的SBC股份被市场"免费吸收", 股东在不知不觉中被稀释
5. 管理层的"2027年GAAP盈利"承诺需要SBC/Revenue从23.1%降至~30%——这意味着要么大幅削减SBC(影响人才留存), 要么Revenue需要翻倍至~$9B(需Bookings CAGR >20%持续3年)

**Zynga类比**: Zynga在2012年IPO后同样展示了强Bookings增长和"调整后"盈利, 但当增长放缓时, 高额SBC成为无法压缩的固定成本, 导致真实盈利力永远无法兑现。Roblox的SBC/Revenue(23.1%)比Zynga峰值时期(~25-30%)更高。[DM-RT-033]
...
**做空论总结**: Roblox是一家$4.89B Revenue、-$1.07B GAAP净亏损、"真实FCF"为+$231M的公司, 面临$5.5-7.0B潜在法律成本、23.1% SBC/Revenue的结构性稀释、以及DAU质量和年龄数据的双重可信度危机。其$44.3B市值建立在"社交平台"估值框架上, 但73%的用户是未成年人。
...
graph LR
    subgraph "空头钢人论: 五柱攻击"
        direction TB
        P1["FCF幻觉<br/>报告$1.36B vs 真实+$231M<br/>SBC/Revenue 23.1%"]
...
| 4 | SBC $1.13B | $1.13B | FMP: SBC字段=$0(异常); otherNonCashItems=$3.14B | baggers_summary: OCF/SBC 2.16x → SBC = $1,796M/2.16 = $831M? 存在不一致 | [DM-RT-045] FLAG: FMP SBC数据不可靠; staging引用的$1.13B来自Q1-Q3季报累加+Q4推算, 方法合理但精确度为估算级 |
...
[DM-RT-052] **SBC $1.13B的数据质量需要特别说明**:

FMP cashflow API对RBLX FY2025的SBC字段返回$0, 这是一个明显的数据异常。实际SBC被归入`otherNonCashItems`($3,140,875,000)。staging文件使用$1.13B来源于:
- FY2024 SBC(FMP确认): $1,015,794,000
- FY2025 Q1-Q3季报SBC: 累加约$1.8-2.0B
- Q4推算: ~$650-800M(基于前三季度趋势)
- 得出全年~$1.13B

这一推算方法合理, 但$1.13B是估算值而非精确财报值。baggers_summary中的OCF/SBC覆盖率2.16x如果以OCF $1,796M为基础, 反推SBC = $1,796M / 2.16 = $831M, 这与$1.13B严重不一致。可能的解释:
- baggers_summary的OCF/SBC可能使用了不同口径的SBC(仅股票薪酬vs 全部股权激励)
- 或baggers_summary的数据来源与FMP有差异

**结论**: SBC $1.13B作为分析基础在量级上合理(vs FY2024 $1.02B增长160%, 考虑到人员扩张和股价波动), 但精确数值的置信度为中等(★★☆)。建议在最终报告中明确标注SBC数值的估算性质。[DM-RT-053]
...
graph LR
    subgraph "RT-4 数据审计结果"
        ...
        FLAG["FLAG 1/10<br/>SBC $1.13B<br/>FMP字段异常($0)<br/>估算值(★★☆)"]
        ERROR["ERROR 0/10"]
    end
...
| Agent身份泄漏 | 0 | 0 |
| 市值一致性 | $44.3B/$44.7B | 全文一致 |
# Chapter 23: 红队对抗审查(下) — 黑天鹅·时间·替代·纠错
...
- SBC/Revenue比如果未从23.1%降至30%以下，GAAP盈利仍遥遥无期
...
**原结论**: FCF $1.36B减去SBC $1.13B = "真实FCF" +$231M，股东实际价值创造为负。

**替代解释**:
SBC是非现金费用，不消耗运营现金流。将SBC视为"真实成本"在概念上正确(它稀释股东)，但在运营层面，Roblox确实在产生正的自由现金流并积累现金。更恰当的类比是2015年的META: 当时Meta的SBC/Revenue约为18%(Roblox 23.1%)，但市场选择忽视SBC关注运营杠杆。Meta从2015年的SBC/Rev 18%降至2019年的9%，对应股价从$80涨至$200。

如果Roblox的SBC/Revenue从23.1%降至25%(5年)→20%(8年)，且Revenue按20% CAGR增长，则:
...
此外，SBC的23.1%中有多少是"投资期过度支出"vs"结构性高成本"需要拆解:
- 如果主要是RSU(限制性股票)授予给工程师→可能随竞争环境变化而下降
- 如果包含大量Baszucki及高管的超额激励→结构性高

**可信度: 3/5** — 方向正确(SBC确实可能下降)，但23.1%→25%的下降路径缺乏可见性。Meta类比中Meta的起点(18%)就远低于Roblox(23.1%)，降幅的绝对值和相对值都更温和。
...
**替代解释**:
- **Compensation结构**: 如果高管80%+的薪酬以RSU形式发放(SBC/Rev 23.1%暗示如此)，则"卖出"不是信号——而是"变现薪水"。不卖=不领工资，这不是正常选项
...
# Chapter 24: 知识声明注册表 (Knowledge Statements)
...
**声明内容**: 股票薪酬(SBC)的会计处理是Roblox估值争论的核心变量。FY2025 SBC约$1.13B(估算值)，占Revenue的23.1%，为同行偏高(META ~18%，SNAP ~30%)。五方法估值中，含SBC的DCF得出$13.3B，不含SBC的DCF得出$45.5B，差距3.42倍。更广泛地看，"含SBC世界"($13-20B公允价值)与"不含SBC世界"($32-46B公允价值)之间的选择，是当前价格($44.3B)是否合理的决定性判断。SBC处理方式贡献了五方法离散度的70%。[DM-SYN-002]

**证据来源**:
- Ch8: SBC $1.13B = 23.1% Revenue，"真实FCF" +$231M
- Ch13: SBC深度分析——隐性税率2.5%/年，5年稀释20%
- Ch14: 五方法离散度3.42x，SBC贡献70%离散
- RT-4: SBC $1.13B数据质量为估算级(★★☆)，FMP字段异常

**置信度**: **高** — SBC作为估值核心变量的判断在五方法框架中得到定量验证。但$1.13B绝对值为估算级，精确度中等
...
# Chapter 25: 论文特异性注册表 (Thesis Specificity)
...
## TS-01: SBC/Revenue 23.1%为同行2.5倍以上，真实FCF为负(+$231M)是Roblox独有的估值困境

**论文声明**: Roblox的SBC/Revenue比率23.1%不仅是绝对值的问题，更是同行对比中的极端异常值。META ~18%(约Roblox的1/3)、SNAP ~30%(约Roblox的1/2)、Unity ~35%。扣除SBC后"真实FCF"为+$231M的状态在大市值($40B+)科技公司中几乎是孤例。
...
**特异性判定**: **通过** — 23.1%的SBC/Revenue和"真实FCF"为负的组合在上市UGC/社交平台中独一无二。[DM-SYN-018]
...
## TS-07: 报告FCF为正($1.36B)但"真实FCF"为负(+$231M)的矛盾在同行中无可比案例

**论文声明**: Roblox是极少数报告FCF大幅为正($1.36B, FCF Margin 27.7%)但扣除SBC后"真实FCF"为负(+$231M)的大市值科技公司。SBC/FCF比率195%(SBC是报告FCF的近2倍)在上市科技公司中属于极端值。这一矛盾的投资含义是: 依赖报告FCF做估值的投资者和依赖"真实FCF"做估值的投资者，将对同一家公司得出完全不同的结论。
...
**时间框架**: 2-4年。管理层承诺2027年GAAP盈利隐含SBC/Revenue需从23.1%大幅下降
...
graph LR
    subgraph "特异性强 (完全通过)"
        TS01["TS-01 SBC 23.1%<br/>同行2.5x+<br/>✅ 完全特异"]
...
# Chapter 26: Core Question闭环 — 8个CQ的最终判定
...
**问题重述**: 当SBC $1.13B(23.1% of Revenue)被纳入真实成本计算后，Roblox的盈利力画面如何？"估值开关"(含SBC→$13-20B vs 不含→$32-46B)的含义是什么？

**最终判定**: SBC是RBLX估值辩论的核心变量，是将$44.3B市值与$13-20B公允价值之间差距打开或关闭的"开关"。报告FCF $1.36B在扣除SBC后变为"真实FCF" +$231M，这一事实是投资者最需要理解的单个财务现实。SBC/Revenue 23.1%为同行偏高(META ~18%, SNAP ~30%)，且5年累计稀释16.6%，零回购。[DM-SYN-056]
...
|:-----:|:------:|---------|
| P0.5 | 50% | 基线 |
| P1 | 70% | 核心发现: FCF $1.36B减SBC $1.13B = "真实FCF" +$231M; 最大单Phase跃升(+20pp) |
| P2 | 80% | SBC确立为"估值开关": 含SBC→$13-20B vs 不含→$32-46B; 五方法离散度3.42x中SBC处理占70%方法差异 |
| P3 | 82% | 27个月水库效应精细量化; 递延收入$5.1B首超年Revenue; 但未改变SBC核心结论 |
| P4 | 80% | SBC $1.13B为估算值(精确度★★☆); 缺乏SBC收敛情景是分析遗漏 |

**关键证据链**:
1. **绝对值**: SBC $1.13B = FCF $1.36B × 0.83倍。换言之，SBC几乎是报告FCF的两倍
2. **同行对比**: SBC/Revenue 23.1% vs META 18%, SNAP 30%, GOOG 12%——RBLX是可比公司中最高的
3. **稀释实证**: 5年从602M增至702M(+16.6%, 年化3.1%)，零回购抵消
4. **Reverse DCF隐含**: 当前股价$63.17需要Revenue CAGR 20.1%(10年)且SBC同步压缩——否则DCF含SBC仅$13.3B(隐含下行70%)
5. **管理层承诺**: "2027年GAAP盈利"在SBC/Revenue已降至23.1%的基础上更具可行性——如果Revenue保持20%+增长至~$7B+, 且SBC增速控制在10%以内, GAAP盈利目标可实现

**残余不确定性**: SBC的未来走向是估值的关键摆动因子。当前23.1%已在改善趋势中(FY2023峰值31.0%→FY2025 23.1%),如果持续改善至<15%(META水平), "真实FCF"可从+$231M升至$1B+, 根本性改变估值逻辑。反之, 如果SBC因人才竞争反弹至30%+, 将再次拖累FCF。SBC收敛的时间表和路径是估值中最具争议的假设。$1.13B基于10-K验证(Motley Fool+AlphaQuery+APIC变动交叉确认), 量级判断($1.0-1.3B区间)可靠。
...
**问题重述**: SBC $1.13B/年 + 年均稀释3.1% + 340卖/0买的内部人交易——FCF叙事是否在误导投资者？

**最终判定**: FCF叙事存在系统性误导。报告FCF $1.36B(FCF Margin 27.7%)呈现了一家"健康科技公司"的假象，但扣除SBC后"真实FCF"为+$231M。5年累计稀释16.6%且零回购，意味着股东持续被稀释。内部人信号方面，340卖/0买的不对称性需要结合compensation结构理解: 当SBC/Revenue高达23.1%时，高管薪酬的主体是RSU，"卖出"在很大程度上等同于"变现薪水"；此外税务触发(RSU vesting时联邦+州税率37-50%)使得部分卖出是强制性的。因此，内部人信号从"极度负面"调整为"温和负面"——卖出行为可被补偿结构部分解释，但"零买入"仍然是一个无法消除的负面信号，表明内部人在当前价格水平无信心加仓。[DM-SYN-060]
...
|:-----:|:------:|---------|
| P0.5 | 50% | 基线 |
| P1 | 68% | SBC $1.13B(23.1% Revenue); 340卖/0买; 5年稀释16.6%; 人均SBC $369K vs META $350K |
...
**关键证据链**:
1. **SBC/FCF倍率**: SBC $1.13B = FCF $1.36B × 1.95——SBC几乎是FCF的两倍
...
5. **Compensation结构上下文**: SBC/Revenue 23.1%意味着80%+高管薪酬为RSU形式，"卖出"在操作层面部分等同于"领取薪水"；RSU vesting触发37-50%的税务义务使部分卖出为强制行为

**残余不确定性**: SBC收敛路径是最大缺口——如果管理层真正兑现2027年GAAP盈利承诺(SBC/Revenue降至~30%)，FCF叙事的可信度将大幅提升。但这需要SBC绝对值从$1.13B控制在$3.0B以下(在Revenue增长至$10B+的假设下)，或Revenue增速持续超过SBC增速——历史上从未实现。

**投资含义**: FCF $1.36B是会计结果而非经济现实。投资者在使用FCF倍数(如EV/FCF 32.9x)进行估值时，必须认识到这一倍数隐含了"SBC无成本"的假设。如果使用"真实FCF"(+$231M)，传统FCF估值框架完全失效——这就是为什么SBC处理是估值辩论中不可妥协的核心问题。
...
# Chapter 27: 可投资洞察注册表 (Contrarian Insights, CI)
...
## CI-01: FCF $1.36B是会计幻觉——"真实FCF"为+$231M

**洞察内容**: Roblox FY2025报告FCF $1.36B(FCF Margin 27.7%)被广泛引用为盈利拐点的证据。但SBC $1.13B(23.1% of Revenue)是报告FCF的0.83倍。扣除这一真实经济成本后，"真实FCF"为+$231M——公司不仅没有创造自由现金流，反而在每年通过股权稀释从股东手中提取约$1.29B的隐性税。
...
**我们的发现**: SBC/Revenue 23.1%是可比公司中最高的(META ~18%, SNAP ~30%, GOOG ~12%)。5年累计稀释16.6%且零回购。Meta类比不成立——Meta的SBC/Revenue起点仅18%，降至9%的路径短且可见；Roblox从23.1%降至25%需要Revenue翻倍或SBC削减50%，两者在当前运营模式下均缺乏可见性。如果SBC/Revenue维持在40%+(管理层历史上从未压缩至该水平以下)，"真实FCF"将在可预见的未来持续为负。[DM-SYN-064]

**如果我们错了**: Roblox在FY2027实现GAAP盈利，SBC/Revenue降至30%以下，"真实FCF"从+$231M改善至正值。这需要: (a) SBC绝对值增速显著低于Revenue增速，或 (b) Revenue CAGR维持20%+而SBC增速降至<10%。管理层的2027承诺是信号，但历史上SBC从未下降(FY2021 $342M → FY2025 $1.13B, CAGR +35%)。
...
|---------|:------:|:-------:|:-------:|:-------:|------|
| **路径α: 稳定维持** | 23.1% | 22% | 21% | 20% | SBC与Revenue同步增长, 比率缓慢下降 |
| **路径β: 积极收敛** | 23.1% | 20% | 18% | 16% | 管理层兑现2027年GAAP盈利承诺, SBC纪律改善 |
| **路径γ: 恶化上行** | 23.1% | 26% | 28% | 30% | 人才竞争加剧+股价下行放大稀释, SBC比率上升 |

[DM-SYN-107] 路径概率权重: 路径α(稳定维持)50% — 最可能, SBC/Rev 23.1%已接近行业中位数(META ~18%), 维持当前水平是基准情景; 路径β(积极收敛)35% — 管理层已承诺2027年GAAP盈利, 若兑现需SBC/Rev压缩至20%以下; 路径γ(恶化上行)15% — 如果关键人才流失导致加薪竞赛或股价下跌放大RSU稀释效应。

**Track B FCF计算**(路径α, SBC/Revenue稳定~22%):
...
[DM-SYN-108] 路径α下, "真实FCF"在10年期间**始终为正且稳步增长**, 从FY2025的+$231M增至FY2035的+$1.80B。SBC/Revenue从23.1%缓慢降至20%是保守假设, 真实FCF margin从+4.7%逐步提升至+12%。这意味着: 即使SBC维持当前水平, Roblox也能为股东创造正的价值——关键变量从"SBC是否收敛"转变为"收入增速能否维持"。

**Track B DCF估值**(路径α, WACC 12.9%, 终端g 3%):

- PV(Year 1-10 真实FCF): ~$3.5B
- 终端价值(使用路径α终态"真实FCF" +$1.80B): TV = $1.80B×(1.03)/(12.9%-3%) = $18.7B
  - PV(终端): $18.7B / (1.129)^10 = $5.6B
- **Track B企业价值(路径α): $9.1B** (隐含股价$13.0)

[DM-SYN-109] 路径β(积极收敛, SBC/Rev 23.1%→16%, 概率35%)下, 真实FCF更快增长:
...
**Track B企业价值(路径β): $15.2B** (隐含股价$21.7)

路径γ(恶化上行, SBC/Rev升至30%, 概率15%): 真实FCF在FY2028转负(-$0.19B), Track B EV约-$2.5B(理论负值)

**Track B概率加权**: 50%×$9.1B + 35%×$15.2B + 15%×(-$2.5B) = $4.55B + $5.32B + (-$0.38B) = **$9.5B** (隐含股价$13.5)
...
| **Track B(真实FCF, 概率加权)** | 12.9% | 3% | $9.5B | $13.5 | -78.7% |
| Track B(路径β, SBC收敛) | 12.9% | 3% | $10.5B | $15.0 | -76.3% |

**关键发现**: 递减增长假设使Track A基准从Phase 2的$45.5B降至$32.0B(-30%)。SBC是DCF的"生死开关": 含SBC→$9.5B; 不含SBC→$32.0B。即使在最乐观的Track A假设(WACC 11%, g 4%)下, 估值$48.9B也仅比当前EV高9%——市场定价已接近DCF乐观边界。
...
xychart-beta
    ...
    y-axis "企业价值 ($B)" 0 --> 55
    bar [32.0, 48.9, 21.6, 9.5, 15.2, 44.7]
```
...
只有在WACC ≤ 11%且终端增长率 ≥ 4%的组合下, Track A才能支撑当前$44.7B EV。这要求Beta从1.635降至约1.2(接近META水平)且终端增长率高于名义GDP——两个假设对一家GAAP亏损、SBC占Revenue 23.1%的公司而言都显得偏乐观。
...
[DM-SYN-113] 直接使用EV/Sales中位数(~3.5x)对Roblox不公平, 因为Roblox增速(+36%)远高于同业中位数(+5%)。但Roblox的SBC/Revenue(23.1%)也远高于同业(中位数~18%)。我们需要同时调整增速溢价和SBC折价:
...
SBC $1.13B/年(23.1% of Revenue)对应年均稀释3-4%。如果将其资本化为永续成本流:
- SBC永续价值: $1.13B / (WACC - SBC增长率) = $1.13B / (12.9% - 6%) = $16.4B
...
| **1. DCF Track B**(真实FCF概率加权) | -$2.6B | $9.5B | $18.7B | $13.5 | -78.7% | 15% |
...
**步骤1: 五方法加权EV**
= 25%×$32.0B + 15%×$9.5B + 20%×$33.8B + 15%×$40.8B + 20%×$27.8B + 5%×$36.4B(Reverse DCF校准中值)
...
**最终概率加权EV**: $25.3B + $3.7B = **$29.0B**

[DM-SYN-131] 最终概率加权估值:
- **企业价值: $29.0B** (隐含股价$41.3)
- **vs 当前EV $44.7B: -36.5%**
- **vs 当前股价$63.17: -35.9%**
...
- 五方法基准估值范围: $9.5B(Track B) ~ $40.8B(EV/Bookings)
- 最高/最低比: $40.8B / $9.5B = **4.3x** (含Track B)
...
1. **SBC不算真实成本** — 必须假设(否则Track B $9.5B, 高估79%)
...
| DM-SYN-110 | DCF双轨: Track A $32.0B / Track B $9.5B | 计算 | ★★☆ |
...
| DM-SYN-131 | 最终EV: $29.0B(隐含$41.3, -36%) | 计算 | ★★☆ |
| DM-SYN-132 | 方法离散度: 4.3x(含Track B) / 1.47x(排除) | 计算 | ★★★ |
| DM-SYN-133 | 市场隐含7假设需全部成立 | 分析 | ★★☆ |

---

# Chapter 29: 投资评级与情景框架

> **核心命题**: 基于Ch26五方法全量估值的结论(概率加权EV $29.0B vs 市值$44.3B, 隐含下行34.5%), 结合8个核心问题(CQ)的闭环验证和时间框架错配分析, 确定最终投资评级和条件估值框架。本章不给出点数目标价, 而是呈现四情景的概率加权期望回报, 让数据说话。
...
| 评级维度 | 数据 | 指向 |
|---------|------|:----:|
| 概率加权EV / 市值 | $29.0B / $44.3B = 0.65 | 观望回避(边界) |
...
1. **方法离散度较高**(4.3x含Track B): 估值结论本身的置信度有限, 不宜以低置信度的负面结论做出极端评级
2. **SBC收敛路径存在**: 如果管理层兑现2027年GAAP盈利, Track B估值可从$9.5B上修至$15-22B, 评级前提可能根本性改变
...
[DM-SYN-137] **S1核心假设**:
- SBC/Revenue恶化至>30%(人才竞争+RSU补充), "真实FCF"转负
...
[DM-SYN-138] **S2核心假设**:
- SBC/Revenue维持在20-25%区间, 未见显著改善, 绝对值随收入增长至$1.5-2.0B
...
[DM-SYN-139] **S3核心假设**:
- SBC/Revenue降至<15%, GAAP净利润率转正>10%
...
[DM-SYN-142] 情景分析的概率加权EV($45.5B)高于五方法综合估值($29.0B)。这一差距反映了两种方法论的根本差异:

- **五方法综合(Ch26.7)**: 以当前财务数据为基础, 向前折现, 每一步扣除可量化的风险——属于"从现在出发"的分析
- **四情景加权(Ch27.2)**: 以终态可能性空间为基础, 赋予概率权重——属于"从终局出发"的分析

两种方法的差距($45.5B vs $29.0B, 差60%)本身就是RBLX估值不确定性的一个量化指标。五方法偏保守(更多扣减), 情景法偏中性(允许上行可能性)。

**综合判断**: 取两种方法的加权均值, 五方法60% + 情景法40%:
$29.0B × 60% + $45.5B × 40% = $17.0B + $18.2B = **$35.6B** (隐含股价$50.7)

### 27.2.7 期望回报计算

[DM-SYN-143] 期望回报(基于综合估值):

- **综合估值**: $35.6B (隐含股价$50.7)
- **当前市值**: $44.3B (股价$63.17)
- **期望回报**: ($35.6B - $44.3B) / $44.3B = **-19.6%**
...
| SBC收敛 | SBC/Rev<15%, GAAP盈利 | SBC/Rev恶化至>30%, GAAP亏损持续 | ±$8-15B |
...
1. **SBC/Revenue连续2个季度<40%**(当前23.1%) — 证明SBC收敛路径可行, 将Track B估值大幅上修
...
1. **估值非精确值**: 所有估值输出(如$29.0B, $35.6B)是基于假设的计算结果, 不是"真实内在价值"。假设的微小变动(如WACC ±2ppt, 终端增长率 ±1ppt)可导致估值变化30-50%。
...
7. **做空不是建议**: "审慎关注"评级意味着"不建议建仓多头", 而非"建议做空"。RBLX的高波动性(Beta 1.635)、空头挤仓风险(Bookings增速仍强)和方法离散度(4.3x)使做空风险极高。
...
|------|------|
| **评级** | 审慎关注 |
| **综合估值** | $35.6B(隐含股价$50.7, -20.7%) |
| **概率加权EV(五方法)** | $29.0B(隐含$41.3, -36%) |
| **期望回报** | -19.6%(综合) / -36%(五方法) |
| **方法离散度** | 4.3x(含Track B) / 1.47x(排除极端) |
...
| DM-SYN-149 | 中位估值$29.0B, 5/6方法指向下行 | 汇总 | ★★☆ |
| DM-SYN-150 | AI能力边界: 7项局限性声明 | 声明 | ★★★ |

---

*Ch26 + Ch27 综合估值与投资评级完成。共计50个DM锚点(DM-SYN-101~150), 5个Mermaid图表。核心发现: (1)五方法概率加权EV $29.0B vs 市值$44.3B, 隐含下行34.5%; (2)四情景加权EV $45.5B, 综合60/40加权后$35.6B(下行20.5%); (3)评级"审慎关注"——不建议建仓, 但方法离散度太高不建议做空; (4)SBC处理方式贡献65%的估值离散, 是多空分歧的数学根源; (5)1年偏空(催化剂密集负面)/3年中性偏空(年化-3.9%)/5年+高不确定性($10-180B)。*
# Chapter 30: 投资者备忘 — 经验、偏差与决策框架
...
**教训三: "高FCF率"可以是一个包装精美的幻觉。** AppLovin报告FCF率高达72.5%，看上去是科技行业的印钞机。但做空报告揭示的数据合规风险让市场重新审视这个数字的"含金量"。FCF是一个GAAP定义的指标，它可以在完全合规的情况下与股东实际获得的价值大相径庭。Roblox同样如此: 报告FCF $1.36B(FCF率27.8%)看起来正面，但加入SBC $1.13B之后，真实现金流为+$231M。两家公司用了不同的方式让FCF看起来比实际更好——APP隐藏了数据合规风险，RBLX隐藏了SBC稀释成本。[DM-MEM-004]
...
graph TB
    ...
    subgraph RBLX_STORY["RBLX: 元宇宙+增长奇迹"]
        ...
        R2["FCF幻觉<br/>报告FCF $1.36B<br/>隐藏SBC $1.13B"]
...
| **FCF幻觉** | FCF率72.5%看似完美，但数据合规风险被掩盖 | FCF $1.36B看似正现金流，但含SBC后为+$231M | 高 |
...
- **SBC绝对值**: FY2025年$1.13B
- **SBC占收入比**: $1.13B / $4.89B = **23.1%**。意味着每赚1美元收入，就有0.54美元以股票形式分配给了员工
- **人均SBC**: 约$369K/人（基于约3,070名员工）。作为对比，Meta的人均SBC约$345K——Roblox是Meta的**2.5倍**
...
Roblox的情况: SBC $1.13B vs GAAP净亏损-$1.07B。不仅SBC超过净利润——公司根本就没有净利润。SBC超过了收入的一半。这不是一个需要复杂分析才能发现的问题。
...
graph TD
    subgraph BIASES["投资RBLX的五大认知陷阱"]
        ...
        B2["2️⃣ 确认偏差<br/>只看Bookings+55%<br/>忽视SBC 23.1%"]
...
**为什么是陷阱**: 股价的历史高低与公司的内在价值无关。一家$100的股票如果只值$30，那么即使它从$100跌到$63，它仍然被高估。价格不是价值。Roblox的历史高点是2021年11月的约$134——相比那个价格，$63确实跌了53%。但相比本报告的概率加权估值$29.0B（隐含股价$40.5），它仍然高估了56%。
...
**为什么是陷阱**: 这些数字都是真的。但它们只是故事的一半。如果你只关注增长指标，你会忽视SBC占收入的23.1%、5年累计稀释16.6%、内部人340卖/0买、GAAP净亏损-$1.07B、COPPA和MDL的监管风险。一个只看了增长数据的投资者和一个同时看了增长与成本的投资者，会得出完全不同的结论——但前者会觉得自己的结论是"有数据支撑的"。
...
| 触发条件 | 当前基线 | 触发标准 | 上修幅度 |
|---------|---------|---------|:-------:|
| SBC纪律改善 | SBC/Rev 23.1% | 连续2季度下降且趋势明确(降至<18%) | +$5-8B |
...
| SBC不收敛 | SBC/Rev 23.1% | SBC/Rev维持>50%且内部人继续零买入 | -$3-6B |
...
记住方法离散度是4.3x。Track A(不扣SBC)给出$32.0B估值，EV/Bookings给出$40.8B。在SBC处理方式上，合理的人确实可以有不同立场。做空一家高增长(Bookings+55%)、高用户粘性(DAU+69%)的公司，你面临的风险是: 叙事可能比你想象的持续更久，而市场保持非理性的时间可以超过你保持偿付能力的时间。
...
| DM-MEM-004 | APP FCF率72.5% vs RBLX FCF $1.36B/SBC调整后+$231M | FMP, 公司IR | ★★★ |
| DM-MEM-005 | APP-RBLX镜像对比: 叙事/FCF/共识/催化四维度 | 综合分析 | ★★☆ |
| DM-MEM-006 | RBLX SBC $1.13B = Rev 23.1%, 人均$369K (META 2.5x) | FMP, 计算 | ★★★ |
| DM-MEM-007 | SBC处理创造3-4倍估值差: $32-46B vs $13-20B | Ch26五方法估值 | ★★★ |
| DM-MEM-008 | RBLX: SBC $1.13B vs GAAP净亏损-$1.07B | FMP, 10-K | ★★★ |
| DM-MEM-009 | 五大认知偏差: 锚定/确认/叙事/幸存者/从众 | 行为金融学 | ★★★ |
| DM-MEM-010 | 评级"审慎关注": 概率加权EV $29.0B vs 市值$44.3B (-36%) | Ch27 | ★★☆ |
| DM-MEM-011 | 看多触发: SBC<18%/COPPA温和/广告$200M+/18+>35% | 分析框架 | ★★☆ |
| DM-MEM-012 | 看空触发: 监管重锤/SBC>30%/UEFN>100K/增速<20% | 分析框架 | ★★☆ |
| DM-MEM-013 | 关键日期: COPPA 4/22, MDL进展, FY2026Q1/Q2 | 公开信息 | ★★★ |
| DM-MEM-014 | 买入需同时相信7点全部成立 | 综合分析 | ★★☆ |
| DM-MEM-015 | SBC/Rev 23.1%: 3000员工 vs 700万股东的利益分配 | FMP, 计算 | ★★★ |

---

## 版本修正记录

### v1.2 修正 (2026-02-16) — SBC数据校正+级联更新

**根因**: v1.0/v1.1报告采用MacroTrends TTM SBC $2.65B, 后经回测验证发现MacroTrends将DevEx/创作者支付($1.5B)与员工SBC($1.13B)混合计入。通过以下四源交叉验证确认实际SBC为**$1.13B**:
1. **FMP季度现金流**: Q1 $259M + Q2 $285M + Q3 $287M + Q4推算 ≈ $1.13B
2. **AlphaQuery年度数据**: FY2025 SBC = $1,129M
3. **Motley Fool 10-K报告**: 确认FY2025 SBC $1.13B
4. **APIC变动验证**: FY2024 $4.22B → FY2025 $5.44B, 变动+$1.22B ≈ SBC + 股票发行

**修正范围**(240+处级联更新):

| 指标 | v1.1(错误) | v1.2(修正) | 影响 |
|------|:---------:|:---------:|------|
| SBC | $2.65B | $1.13B | 核心数据(-57%) |
| SBC/Revenue | 54.2% | 23.1% | 同业排名从最高→中偏高 |
| 真实FCF | -$1.29B | +$231M | 符号翻转(负→正) |
| Track B DCF | $5.2B | $9.5B | 概率加权上修+83% |
| 方法离散度 | 7.85x | 4.3x | 不确定性降低 |
| 五方法加权EV | $28.4B | $29.7B | 微幅上修 |
| SBC情景表 | 从54%起算 | 从23.1%起算 | 全部三情景重算 |
| 四情景SBC阈值 | >45%/35%/25% | >30%/20-25%/<15% | 阈值适配23.1%基线 |
| 同业定位 | "同业最高/绝对极端" | "中偏高(META以上SNAP以下)" | 叙事基调变化 |

**未变更项**: 评级(审慎关注)、最终综合EV($29.0B)、期望回报(-19.6%)、CQ置信度(75%)、监管折价(-$9.7B)。SBC修正使估值微幅上修,但不改变"高估"的核心结论和评级。

**教训**: (1)多源数据交叉验证时应以APIC变动为硬约束校验; (2)异常值($2.65B远超APIC变动$1.22B)需即时标红而非采信; (3)MacroTrends对Roblox的SBC口径包含非员工支付,不可直接使用。
